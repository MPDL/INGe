...
public class ItemValidatingBean implements ItemValidating {
   ...
   * {@inheritDoc}
   */
  public final String validateItemXml(final String itemXml)
   ...
   * {@inheritDoc}
   */
  public final String validateItemXml(final String itemXml, final String validationPoint)
      throws ValidationSchemaNotFoundException, TechnicalException {
   ...
   * {@inheritDoc}
   */
  private String validateItemXml(final String itemXml, final String validationPoint,
   ...
   * {@inheritDoc}
   */
  private String validateItemXmlBySchema(final String itemXml, final String validationPoint,
