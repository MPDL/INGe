...
/**
 * This is a implementation of {@link ValidationSchemaSource}. It provides validation belonging to
 * the content-model created by the the TestEnvConfiguration. Only used for JUnit testing.
 * 
    ...
    if (!isFileNameNull) {
      try {
        InputStreamReader isr =
            new InputStreamReader(ResourceUtil.getResourceAsStream(fileName,
                TestEnvValidationSchemaSource.class.getClassLoader()));
