...
public interface ItemValidatingWebService {
   ...
   * point.
   * 
   * @param itemXml The item as xml according to the xml schema. (like "submit_item", etcetera). As
   *        validation point "default" will be used.
   ...
   * @throws Exception Another exception.
   */
  String validateItemXml(final String itemXml, final String validationPoint) throws Exception;
   ...
   * @throws Exception Another exception.
   */
  String validateItemXmlBySchema(final String itemXml, final String validationPoint,
