...
package de.mpg.mpdl.inge.validation.valueobjects;
...
public class ValidationReportVO extends ValueObject {
  ...
  private java.util.List<ValidationReportItemVO> items =
      new java.util.ArrayList<ValidationReportItemVO>();
  ...
  /**
   * Helper method for JiBX transformations. This method helps JiBX to determine if a "items" XML
  ...
  /**
   * Returns whether the item is valid or not. If at least one restrictive rule wasn't validated,
   * false is returned.
   * 
