...
public class TransformContainerTest extends XmlTransformingTestBase {
  ...
  /**
   * Test method for
   * {@link de.mpg.mpdl.inge.xmltransforming.XmlTransforming#transformToContainer(java.lang.String)}
   * .
   * 
   * @throws Exception
   */
  ...
  /**
   * Test method for
   * {@link de.mpg.mpdl.inge.xmltransforming.xmltransforming.XmlTransformingBean#transformToContainer(java.lang.String)}
   * .
   * 
   * @throws Exception
   */
  ...
  /**
   * Test method for checking the correct transformation of an container-list[XML] to a
   * List<ContainerVO>.
   * 
   * @throws Exception
   */
