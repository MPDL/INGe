...
public class TransformSearchResultUserGroupList extends XmlTransformingTestBase {
  ...
  private static final String TEST_FILE_ROOT =
      "xmltransforming/component/transformSearchResultUserGroupListTest/";
  private static final String SAMPLE_FILE = TEST_FILE_ROOT
      + "searchRetrieveUserGroupList_sample.xml";
