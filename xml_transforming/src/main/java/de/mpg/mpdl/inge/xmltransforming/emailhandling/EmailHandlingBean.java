...
package de.mpg.mpdl.inge.xmltransforming.emailhandling;
...
public class EmailHandlingBean implements EmailHandling {
  ...
  public String sendMail(String smtpHost, String withAuth, String usr, String pwd,
    ...
    try {
      ...
      /*
       * Transport tr = mailSession.getTransport("smtp"); tr.connect(smtpHost, 25, usr, "null");
       * message.saveChanges(); tr.sendMessage(message, message.getAllRecipients()); tr.close();
       */
