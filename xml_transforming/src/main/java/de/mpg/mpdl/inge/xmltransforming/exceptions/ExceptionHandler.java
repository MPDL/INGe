...
package de.mpg.mpdl.inge.xmltransforming.exceptions;
...
public class ExceptionHandler {
  ...
  public static void handleException(Exception e, String methodname) throws TechnicalException {
    if (e instanceof SecurityException || e instanceof SystemException
        || e instanceof MissingContentException || e instanceof ComponentNotFoundException
        || e instanceof ReadonlyAttributeViolationException
...

    {
      Logger.getLogger(ExceptionHandler.class).debug(
          MessageCreator.getMessage(CommonLogicMessages.FRAMEWORK_SYSTEM_ERROR,
