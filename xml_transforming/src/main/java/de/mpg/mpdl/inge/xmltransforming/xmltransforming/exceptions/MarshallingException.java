...
/**
 * This exception occurs whenever something goes wrong during marshalling. The member variable
 * <i>marshalledObjectType</i> contains information about the object type that should have been
 * marshalled.
 * 
...
public class MarshallingException extends TransformingException {
  ...
  /**
   * This constructor creates a new MarshallingException and stores the given name of the object
   * type that should have been marshalled in the according member variable.
   * 
