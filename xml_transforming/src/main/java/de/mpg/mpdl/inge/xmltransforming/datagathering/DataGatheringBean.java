...
package de.mpg.mpdl.inge.xmltransforming.datagathering;
...
import de.mpg.mpdl.inge.xmltransforming.exceptions.AffiliationNotFoundException;
...
public class DataGatheringBean implements DataGathering {
   ...
   * 
   * @see
   * de.mpg.mpdl.inge.xmltransforming.DataGathering#findRevisionsOfItem(de.mpg.mpdl.inge.xmltransforming
   * .referenceobjects.ItemRO)
   */
  public List<RelationVO> findRevisionsOfItem(String userHandle, ItemRO itemRef)
