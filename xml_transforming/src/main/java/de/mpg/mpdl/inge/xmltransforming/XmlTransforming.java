...
public interface XmlTransforming {
  ...
  public List<AccountUserVO> transformToAccountUserVOList(String accountUserListXml)
      throws TechnicalException;
   ...
   * 
   * @param organizationalUnit XML String that is valid according to "${xsd.soap.ou.ou}"
   *        (organizational-unit)
  ...
  /**
   * Transforms an XML String that is valid according to
   * "http://www.escidoc. de/schemas/organizationalunitlist/0.6" (organizational-unit-list.xsd) to
   * the corresponding <code>List&lt;AffiliationVO></code>.
   * 
  ...
  /**
   * Transforms an XML String that is valid according to
   * "http://www.escidoc. de/schemas/organizationalunitlist/0.6" (organizational-unit.xsd) to the
   * corresponding <code>List&lt;AffiliationRO></code>.
   * 
   ...
   * de/schemas/organizationalunitpathlist/0.2" (organizational-unit-path-list.xsd) to the
   * corresponding <code>List&lt;AffiliationPath></code>.
   * 
   * @param pathList XML String that is valid according to "${xsd.soap.ou.oupathlist}"
  ...
  /**
   * This method gets as input a XML (as String) containing the existing citation styles and their
   * file formats. It returns a list of <code>LayoutFormatVOs</code> according to the input.
   * 
   ...
   * @throws UnmarshallingException
   */
  public List<ExportFormatVO> transformToExportFormatVOList(String xml) throws TechnicalException,
      UnmarshallingException;
  ...
  /**
   * Transforms a given <code>FilterTaskParamVO</code> to corresponding XML that is valid according
   * to (filter.xsd, filter-containers.xsd, filter-contexts.xsd, filter-items.xsd, or
   * filter-organizational-units.xsd respectively).
   * 
   * @param filter A <code>FilterTaskParamVO</code>
   * @return Corresponding XML that is valid according to (filter.xsd, filter-containers.xsd,
   *         filter-contexts.xsd, filter-items.xsd, or filter-organizational-units.xsd respectively)
   * @throws TechnicalException
   * @throws MarshallingException
   */
  public String transformToFilterTaskParam(FilterTaskParamVO filter) throws TechnicalException,
      MarshallingException;

  /**
   * Transforms an XML String that is valid according to "http://www.escidoc.de/schemas/grants/0.2"
   * (grants.xsd) to the corresponding <code>GrantVO</code>.
   * 
   * @param xmlGrants XML String that is valid according to
   *        "http://www.escidoc.de/schemas/grants/0.2" (grants.xsd)
  ...
  /**
   * Transforms an <code>GrantVO</code> to the corresponding xml that is valid according to
   * "http://www.escidoc.de/schemas/grants/0.2" (grants.xsd)
   * 
   * @param grantVO The GrantVO object
   * @return XML String that is valid according to "http://www.escidoc.de/schemas/grants/0.2"
   *         (grants.xsd)
   */
  ...
  /**
   * Transforms a given <code>PubItemVO</code> to corresponding XML that is valid according to
   * "http://www.escidoc. de/schemas/item/0.3" (item.xsd).
   * 
   * @param pubItem A <code>PubItemVO</code>
   * @return Corresponding XML that is valid according to "http://www.escidoc.de/schemas/item/0.3"
   *         (item.xsd)
   * @throws TechnicalException
   */
  ...
  /**
   * Transforms a given <code>List&lt;ItemVO></code> to corresponding XML that is valid according to
   * "http://www. escidoc.de/schemas/itemlist/0.10" (item-list.xsd).
   * 
  ...
  /**
   * Transforms a given <code>ItemVOListWrapper</code> to corresponding XML that is valid according
   * to "http://www. escidoc.de/schemas/itemlist/0.10" (item-list.xsd).
   * 
   ...
   * @return Corresponding XML that is valid according to "${xsd.soap.ou.ou}"
   *         (organizational-unit.xsd)
   * @throws TechnicalException
   * @throws MarshallingException
   */
  public String transformToOrganizationalUnit(AffiliationVO affiliation) throws TechnicalException,
      MarshallingException;

  /**
   * Transforms an XML String that is valid according to "${xsd.soap.context.context}" (context.xsd)
   * to the corresponding <code>ContextVO</code>.
   * 
   * @param context XML String that is valid according to "${xsd.soap.context.context}"
   *        (context.xsd)
  ...
  /**
   * Transforms an XML String that is valid according to
   * "http://www.escidoc.de/schemas/contextlist/0.2" (context-list.xsd) to the corresponding
   * <code>List&lt;ContextVO></code>.
   * 
   * @param contextList XML String that is valid according to
   *        "http://www.escidoc.de/schemas/contextlist/0.2" (context-list.xsd)
  ...
  /**
   * Transforms an XML String that is valid according to "http://www.escidoc.de/schemas/item/0.2"
   * (item. xsd) to the corresponding <code>ItemVO</code>.
   * 
   * @param item XML String that is valid according to "http://www.escidoc.de/schemas/item/0.2"
   *        (item. xsd)
  ...
  /**
   * Transforms an XML String that is valid according to
   * "http://www.escidoc.de/schemas/itemlist/0.2" (item-list.xsd) to the corresponding
   * <code>List&lt;ItemVO></code>.
   * 
   * @param itemList XML String that is valid according to
   *        "http://www.escidoc.de/schemas/itemlist/0.2" (item-list.xsd)
   ...
   * 
   * @param searchResultItem XML String that is valid according to
   *        "${xsd.soap.searchresult.searchresult}" (search-result.xsd)
  ...
  /**
   * Transforms a given <code>TaskParamVO</code> to corresponding XML that is valid according to
   * (filter.xsd, filter- containers.xsd, filter-contexts.xsd, filter-items.xsd, or
   * filter-organizational-units.xsd respectively).
   * 
   ...
   * @throws MarshallingException
   */
  public String transformToTaskParam(TaskParamVO taskParam) throws TechnicalException,
      MarshallingException;

  /**
   * Transforms a given <code>PidTaskParamVO</code> to corresponding XML that is valid according to
   * (filter.xsd, filter- containers.xsd, filter-contexts.xsd, filter-items.xsd, or
   * filter-organizational-units.xsd respectively).
   * 
   ...
   * @throws MarshallingException
   */
  public String transformToPidTaskParam(PidTaskParamVO pidTaskParam) throws TechnicalException,
      MarshallingException;

  /**
   * Transforms an XML String that is valid according to
   * "http://www.escidoc.de/schemas/stagingfile/0.2" (staging-file.xsd) to the corresponding
   * <code>java.net.URL</code>.
   * 
   * @param uploadResponse XML String that is valid according to
   *        "http://www.escidoc.de/schemas/stagingfile/0.2" (staging-file.xsd)
  ...
  /**
   * Transforms an XML String that is valid according to "http://www.escidoc. de/schemas/..."
   * (version-history.xsd) to the corresponding <code>List<VersionHistoryEntryVO></code>.
   * 
   * @return The corresponding <code>List<VersionHistoryEntryVO></code>
   * 
   * @param versionList XML String that is valid according to "http://www.escidoc.de/schemas/..."
   *        (version-history.xsd)
   ...
   * @throws UnmarshallingException
   */
  public List<RelationVO> transformToRelationVOList(String relationList)
      throws UnmarshallingException;
  ...
  public SearchRetrieveResponseVO transformToSearchRetrieveResponse(String searcRetrieveResponseXml)
      throws TechnicalException;
  ...
  public ItemVOListWrapper transformSearchRetrieveResponseToItemList(String xmlItemList)
      throws TechnicalException;

  public List<ContextVO> transformSearchRetrieveResponseToContextList(String xmlContextList)
      throws TechnicalException;
}
