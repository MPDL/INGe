...
@TransformerModule(sourceFormat = TransformerFactory.FORMAT.PEER_TEI_XML, targetFormat = TransformerFactory.FORMAT.ESCIDOC_ITEM_V3_XML)
@TransformerModule(sourceFormat = TransformerFactory.FORMAT.PEER_TEI_XML, targetFormat = TransformerFactory.FORMAT.ESCIDOC_ITEMLIST_V3_XML)
public class PeerTeiXmlToItemXml extends XslTransformer {
