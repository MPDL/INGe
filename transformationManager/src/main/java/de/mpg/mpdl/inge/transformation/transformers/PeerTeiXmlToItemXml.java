...
public class PeerTeiXmlToItemXml extends XslTransformer implements ChainableTransformer {
	...
	public Source getXsltSource() throws TransformationException{
		...
		return getXmlSourceFromProperty("escidoc.transformation.peer.stylesheet.filename" ,"transformations/standardFormats/xslt/peer_tei2escidoc-publication-item.xsl");
