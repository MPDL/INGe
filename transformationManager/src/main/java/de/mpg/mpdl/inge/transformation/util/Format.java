...
public class Format implements Serializable {
  ...
  /**
   * Convert a Format object to the corresponding FORMAT enum.
   * 
   * @return Format as FRORMAT enum.
   */
  ...
  public boolean equals(Object other) {
    if (other == null) {
      ...
      return (this.name == null ? ((Format) other).name == null : this.name
          .equalsIgnoreCase(((Format) other).name))
          && (this.type == null ? ((Format) other).type == null : this.type
              .equalsIgnoreCase(((Format) other).type))
