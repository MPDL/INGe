...
public class ItemXmlToBibtex extends XslTransformer implements ChainableTransformer {
	...
	public Source getXsltSource() throws TransformationException{	
		return getXmlSourceFromProperty("escidoc.transformation.escidoc2bibtex.stylesheet.filename", "transformations/commonPublicationFormats/xslt/eSciDoc_to_BibTeX.xsl");
	}
