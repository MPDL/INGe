...
@TransformerModule(sourceFormat = TransformerFactory.FORMAT.SPIRES_XML, targetFormat = TransformerFactory.FORMAT.ESCIDOC_ITEM_V3_XML)
public class SpiresXmlToItemXml extends XslTransformer {
