...
@TransformerModule(sourceFormat = TransformerFactory.FORMAT.BMC_OAIPMH_XML, targetFormat = TransformerFactory.FORMAT.ESCIDOC_COMPONENT_XML)
public class BmcOaiPmhXmlToComponentXml extends XslTransformer {
