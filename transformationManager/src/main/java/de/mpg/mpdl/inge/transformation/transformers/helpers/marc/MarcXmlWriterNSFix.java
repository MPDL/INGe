 ...
 */
package de.mpg.mpdl.inge.transformation.transformers.helpers.marc;
...
/**
 * Fixed Class from https://raw.githubusercontent.com/marc4j/marc4j/2.6.5/src/org/marc4j/MarcXmlWriter.java
 * to handle correct MarcXML Namespace. There is only one change in line 411 which enables Prefix Mapping.
 * 
 * 
...
public class MarcXmlWriterNSFix implements MarcWriter {
     ...
     * @throws SAXException
     */
    public MarcXmlWriterNSFix(Result result, String stylesheetUrl) {
