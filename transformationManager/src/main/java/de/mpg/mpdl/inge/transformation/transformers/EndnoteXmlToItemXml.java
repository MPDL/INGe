...
public class EndnoteXmlToItemXml extends XslTransformer implements ChainableTransformer {
	...
	public Source getXsltSource() throws TransformationException{
		...
		if (flavor != null && ("ICE".equals(flavor) || "BGC".equals(flavor))) {
			...
			return getXmlSourceFromProperty("escidoc.transformation.endnote.ice.stylesheet.filename", "transformations/commonPublicationFormats/xslt/endnoteicexml2escidoc.xsl");
				
	    } else {
	        	
	        return getXmlSourceFromProperty("escidoc.transformation.endnote.stylesheet.filename", "transformations/commonPublicationFormats/xslt/endnotexml2escidoc.xsl");
	    }
	...
	public Map<String, String> getDefaultConfiguration() throws TransformationException {
		return SingleTransformer.getDefaultConfigurationFromProperty("escidoc.transformation.endnote.configuration.filename", "transformations/commonPublicationFormats/conf/endnote.properties");
	}
