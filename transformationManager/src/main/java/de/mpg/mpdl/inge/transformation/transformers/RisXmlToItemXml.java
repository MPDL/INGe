...
public class RisXmlToItemXml extends XslTransformer implements ChainableTransformer {
	...
	public Source getXsltSource() throws TransformationException{
		return getXmlSourceFromProperty("escidoc.transformation.ris.stylesheet.filename", "transformations/otherFormats/xslt/risxml2escidoc.xsl");
	}
	...
	public Map<String, String> getDefaultConfiguration() throws TransformationException{
		return getDefaultConfigurationFromProperty("escidoc.transformation.ris.configuration.filename", "transformations/otherFormats/conf/ris.properties");
	}
