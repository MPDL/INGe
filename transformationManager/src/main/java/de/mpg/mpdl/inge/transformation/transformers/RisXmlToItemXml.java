...
@TransformerModule(sourceFormat = TransformerFactory.FORMAT.RIS_XML, targetFormat = TransformerFactory.FORMAT.ESCIDOC_ITEM_V3_XML)
@TransformerModule(sourceFormat = TransformerFactory.FORMAT.RIS_XML, targetFormat = TransformerFactory.FORMAT.ESCIDOC_ITEMLIST_V3_XML)
public class RisXmlToItemXml extends XslTransformer {
