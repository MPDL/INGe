...
@TransformerModule(sourceFormat = TransformerFactory.FORMAT.PMC_OAIPMH_XML, targetFormat = TransformerFactory.FORMAT.ESCIDOC_ITEM_V3_XML)
public class PmcOaiPmhXmlToItemXml extends XslTransformer {
