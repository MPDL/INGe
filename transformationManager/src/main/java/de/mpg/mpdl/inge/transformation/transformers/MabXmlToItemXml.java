...
public class MabXmlToItemXml extends XslTransformer implements ChainableTransformer {
	...
	public Source getXsltSource() throws TransformationException{
		return getXmlSourceFromProperty("escidoc.transformation.mab.stylesheet.filename", "transformations/otherFormats/xslt/mabxml2escidoc.xsl");
	}
	...
	public Map<String, Object> getParameters() throws TransformationException {
		Map<String, Object> map = new HashMap<String, Object>(); 
		  ...
		  map.put("localPrefix", PropertyReader.getProperty("escidoc.transformation.mab.content.url.prefix"));
