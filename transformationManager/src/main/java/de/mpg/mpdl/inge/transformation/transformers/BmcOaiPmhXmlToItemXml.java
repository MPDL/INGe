...
public class BmcOaiPmhXmlToItemXml extends XslTransformer implements ChainableTransformer {
	...
	public Source getXsltSource() throws TransformationException{
		...
		return getXmlSourceFromProperty("escidoc.transformation.bmc2escidoc_publication_component.stylesheet.filename" ,"transformations/thirdParty/xslt/bmc2escidoc-publication-component.xsl");
