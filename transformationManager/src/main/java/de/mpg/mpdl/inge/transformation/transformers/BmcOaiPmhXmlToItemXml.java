...
@TransformerModule(sourceFormat = TransformerFactory.FORMAT.BMC_OAIPMH_XML, targetFormat = TransformerFactory.FORMAT.ESCIDOC_ITEM_V3_XML)
public class BmcOaiPmhXmlToItemXml extends XslTransformer {
