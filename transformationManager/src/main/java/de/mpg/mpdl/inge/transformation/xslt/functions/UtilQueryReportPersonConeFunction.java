...
/**
 * s9api extension function: Util:queryReportPersonCone(xs:string?, xs:string?) as node()* Namespace
 * URI: https://pubman.mpdl.mpg.de/util-functions
 */
public final class UtilQueryReportPersonConeFunction implements ExtensionFunction {
  private static final QName NAME = new QName("Util", "https://pubman.mpdl.mpg.de/util-functions", "queryReportPersonCone");
  private final Processor processor;

  public UtilQueryReportPersonConeFunction(Processor processor) {
  ...
  public XdmValue call(XdmValue[] arguments) throws SaxonApiException {
    ...
    Node dom = Util.queryReportPersonCone(model, query);
    if (dom == null) {
