...
public class BibtexToItemXml extends SingleTransformer implements ChainableTransformer {
	...
	public void transform(TransformerSource source, TransformerResult result) throws TransformationException {
		try {
			...
			{
				setConfiguration(getDefaultConfigurationFromProperty("escidoc.transformation.bibtex.configuration.filename", "transformations/commonPublicationFormats/conf/bibtex.properties"));
			}
