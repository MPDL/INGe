...
public class TransformerFactoryTest {
  ...
  public void testItemXmlV3ToItemXmlV2() throws FileNotFoundException, TransformationException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/escidoc_item_v13.xml")), new TransformerStreamResult(wr));

    logger.info("\n" + wr.toString());

    assertTrue(wr.toString()
        .length() > 1000);
  ...
  public void testItemXmlV3ToDoiMetadataXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/escidoc_item_doi_v13.xml")),
  ...
  @Test
  public void testItemXmlV3ToHtmlMetaTagsHighwirePressCitXml()
      throws TransformationException, IOException {

    StringWriter wr = new StringWriter();

    Transformer t = TransformerFactory.newInstance(FORMAT.ESCIDOC_ITEM_V3_XML,
  ...
  public void testArXivOaiXmlToItemXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/arXiv.xml")), new TransformerStreamResult(wr));
  ...
  public void testBibtexToItemXmlV3() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/bibtex.txt")), new TransformerStreamResult(wr));
  ...
  public void testBmcXmlToItemXmlV3() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/bmc.xml")), new TransformerStreamResult(wr));
  ...
  public void testEdocXmlToItemXmlV3() throws TransformationException, IOException {
    ...
    TransformerStreamSource streamSource = new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/edoc_item1.xml"));

    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/edoc_item1.xml")), new TransformerStreamResult(wr));
  ...
  public void testEndnoteXmlToItemXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/endnote_item.xml")), new TransformerStreamResult(wr));
    ...
    assertXmlTransformationWithIgnore(wr, "results/fromEndnoteXmlToItemXml.xml",
        Arrays.asList(new String[] {
            "creator,role=http://www.loc.gov/loc.terms/relators/AUT,http://purl.org/escidoc/metadata/terms/0.1/"}));
  }
  ...
  public void testMabXmlToItemXmlV3() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/mabXml_item.xml")), new TransformerStreamResult(wr));
  ...
  public void testMabXmlWrongLinkToItemXmlV3() throws TransformationException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/mabXml_item_wronglink.xml")),
        new TransformerStreamResult(wr));
    logger.info("\n" + wr.toString());
  }
  ...
  public void testMarcXmlToItemXmlV3() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/marc_item.xml")), new TransformerStreamResult(wr));
  ...
  public void testPmcOaiXmlToItemXmlV3() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/pmcOai.xml")), new TransformerStreamResult(wr));
  ...
  public void testSpiresToItemXmlV3() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/spires.html")), new TransformerStreamResult(wr));
  ...
  public void testEndnoteToEndnoteXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/endnote_item.txt")), new TransformerStreamResult(wr));
  ...
  public void testMabToMabXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/mab_item_list.txt")), new TransformerStreamResult(wr));
  ...
  public void testMarc21ToMarcXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/marc_record.mrc")), new TransformerStreamResult(wr));
  ...
  public void testModsXmlToMarcXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/mods_item.xml")), new TransformerStreamResult(wr));
  ...
  public void testRisToRisXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/ris.txt")), new TransformerStreamResult(wr));
  ...
  public void testRisXmlToItemXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/ris_item.xml")), new TransformerStreamResult(wr));
  ...
  public void testWosToWosXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/wos_item.txt")), new TransformerStreamResult(wr));
  ...
  public void testWosXmlToItemXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/wos_item.xml")), new TransformerStreamResult(wr));
  ...
  public void testMabToItemXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/mab_item.txt")), new TransformerStreamResult(wr));
  ...
  public void testMarc21ToItemXml() throws TransformationException, IOException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/marc21.txt")), new TransformerStreamResult(wr));
  ...
  public void testItemXmlV2ToItemXmlV1() throws FileNotFoundException, TransformationException {
    ...
    t.transform(new TransformerStreamSource(getClass().getClassLoader()
        .getResourceAsStream("sourceFiles/escidoc_item_v2.xml")), new TransformerStreamResult(wr));
