...
public class ValueObjectEqualsTest extends TestBase {
  ...
  /**
   * Tests the two MdsPublicationVOs with different number of Creator Person Organizations for
   * equality.
   */
  @Test
  ...
  /**
   * Tests the two MdsPublicationVOs with different Creator Person Organization Addresses for
   * equality.
   */
  @Test
