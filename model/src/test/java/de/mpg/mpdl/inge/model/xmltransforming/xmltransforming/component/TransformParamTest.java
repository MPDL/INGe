...
public class TransformParamTest extends TestBase {
  ...
  public void old_transformToFilterTaskParamCreatorAndState() throws Exception {
    ...
    String expectedXML =
        "<filter name=\"http://escidoc.de/core/01/structural-relations/created-by\">escidoc:user1</filter>";
    String expectedXML2 =
        "<filter name=\"http://escidoc.de/core/01/properties/version/status\">pending</filter>";
  ...
  public void old_transformToFilterTaskParamWithState() throws Exception {
    ...
    String expectedXML =
        "<filter name=\"http://escidoc.de/core/01/properties/version/status\">pending</filter>";
    String expectedXML2 =
        "<filter name=\"http://escidoc.de/core/01/properties/version/status\">submitted</filter>";
  ...
  public void old_transformToFilterTaskParamWithType() throws Exception {
    ...
    String expectedXML =
        "<filter name=\"http://escidoc.de/core/01/structural-relations/content-model\">escidoc:persistent4</filter>";
