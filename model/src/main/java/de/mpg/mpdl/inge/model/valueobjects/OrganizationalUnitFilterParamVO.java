...
/**
 * This VO is used to retrieve organizational units filtered by certain filter criteria. It
 * corresponds to filter-organizational-units.xsd.
 * 
...
public class OrganizationalUnitFilterParamVO {
  ...
  /**
   * @return This flag indicates whether to filter for top level OUs or not. Due to JSF
   *         requirements, the name of this boolean getter does not begin with "is".
   */
