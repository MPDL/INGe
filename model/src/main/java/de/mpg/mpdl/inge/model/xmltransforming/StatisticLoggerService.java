 ...
 */
public class StatisticLoggerService {
  // private static final Logger logger = Logger.getLogger(StatisticLoggerService.class);
  //
  // private static final String PROPERTY_GEOIP_FILE_LOCATION =
  // "escidoc.statistics.max_mind_geo_lite_city_db.location";
  // private static final String PROPERTY_SHORTENED_IPS = "escidoc.statistics.shortenedIps";
  //
  ...
  // }
  //
  // private static void getStandardIPLookupService(File geopIpCopyFile) {
  ...
  // StatisticLoggerService.class.getClassLoader());
  ...
  // logger.info(
  // "Geo IP Country functionality is activated. For city functionality please provide
  // GeoLiteCity.db and add location to pubman.properties.");
  // } catch (Exception e) {
  // logger.error(
  // "Cannot find any Geo IP lookup database. Statistic data is stored with unknown geo locations.",
  // e);
  // }
  // }
  //
  // public static void logNewUser(String sessionId, String ip, String userAgent, String referer,
  ...
  // browserParam.setParamValue(
  // new StatisticReportRecordStringParamValueVO(browsers[browsers.length - 1]));
  // } else {
  ...
  // }
  //
  // private static List<StatisticReportRecordParamVO> getUserStats(String sessionId, String ip)
  // throws Exception {
  // List<StatisticReportRecordParamVO> paramList = new ArrayList<StatisticReportRecordParamVO>();
  ...
  // }
  //
  // public static void logSearch(String sessionId, String ip, String keywords, String cql,
  // boolean loggedIn, String solutionId, String userHandle) throws Exception {
  ...
  // loggedInParam
  // .setParamValue(new StatisticReportRecordStringParamValueVO(String.valueOf(loggedIn)));
  ...
  // }
  //
  // public static void logItemAction(String sessionId, String ip, String userAgent, ItemVO item,
  // ItemAction action, boolean loggedIn, String referer, String solutionId,
  // List<StatisticReportRecordParamVO> additionalParams, String userHandle) throws Exception {
  // logger.debug(
  // "Logging new action " + action.toString() + "for item" + item.getVersion().getObjectId());
  // StatisticRecordVO statisticRecord = new StatisticRecordVO();
  // statisticRecord.setScope("escidoc:scope2");
  // List<StatisticReportRecordParamVO> paramList = new ArrayList<StatisticReportRecordParamVO>();
  // statisticRecord.setParamList(paramList);
  // StatisticReportRecordParamVO actionParam = new StatisticReportRecordParamVO();
  // actionParam.setName("action");
  // actionParam.setParamValue(
  // new StatisticReportRecordStringParamValueVO(action.toString().toLowerCase()));
  // paramList.add(actionParam);
  // StatisticReportRecordParamVO itemIdParam = new StatisticReportRecordParamVO();
  // itemIdParam.setName("itemId");
  // itemIdParam.setParamValue(
  // new StatisticReportRecordStringParamValueVO(item.getVersion().getObjectId()));
  // paramList.add(itemIdParam);
  // StatisticReportRecordParamVO pidParam = new StatisticReportRecordParamVO();
  // pidParam.setName("pid");
  // pidParam.setParamValue(new
  // StatisticReportRecordStringParamValueVO(item.getVersion().getPid()));
  ...
  // contextParam.setParamValue(
  // new StatisticReportRecordStringParamValueVO(item.getContext().getObjectId()));
  ...
  // itemStatusParam.setParamValue(
  // new StatisticReportRecordStringParamValueVO(item.getPublicStatus().toString()));
  ...
  // }
  //
  // public static void logAuthorAction(String sessionId, String ip, String authorId, boolean
  // loggedIn,
  // String referer, String solutionId, List<StatisticReportRecordParamVO> additionalParams,
  ...
  // enhanceParameterList(sessionId, ip, loggedIn, referer, solutionId, additionalParams,
  // paramList);
  // // TODO
  // // statisticRecord.createInCoreservice(userHandle);
  // }
  //
  // public static void logOrgAction(String sessionId, String ip, String orgId, boolean loggedIn,
  // String referer, String solutionId, List<StatisticReportRecordParamVO> additionalParams,
  // String userHandle) throws Exception {
  // StatisticRecordVO statisticRecord = new StatisticRecordVO();
  // statisticRecord.setScope("escidoc:scope2");
  ...
  // actionParam.setName("action");
  // actionParam
  // .setParamValue(new StatisticReportRecordStringParamValueVO("organization-retrieve-item"));
  // paramList.add(actionParam);
  ...
  // }
  //
  // private static void enhanceParameterList(String sessionId, String ip, boolean loggedIn,
  // String referer, String solutionId, List<StatisticReportRecordParamVO> additionalParams,
