...
public class CurrentGrants extends IntelligentVO {
  ...
  public static class Factory {
     ...
     * @throws Exception If an error occurs in coreservice or during marshalling/unmarshalling.
     */
    private static CurrentGrants retrieveCurrentGrantsForUserGroup(String userHandle,
        String userGroupId) throws RuntimeException {
      try {
        ...
        CurrentGrants currentGrants =
            (CurrentGrants) IntelligentVO.unmarshal(grantListXml, CurrentGrants.class);
     ...
     * @throws Exception If an error occurs in coreservice or during marshalling/unmarshalling.
     */
    private static CurrentGrants retrieveCurrentGrantsForUser(String userHandle, String userId)
     ...
     * @throws Exception If an error occurs in coreservice or during marshalling/unmarshalling.
     */
    private static void revokeGrants(String userHandle, List<Grant> grants, String comment)
        throws RuntimeException {
      try {
