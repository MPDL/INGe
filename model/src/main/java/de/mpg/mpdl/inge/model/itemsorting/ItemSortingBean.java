...
public class ItemSortingBean implements ItemSorting {
  ...
  public java.util.List<PubItemVO> sortItemList(java.util.List<PubItemVO> itemList,
      PubItemVOComparator.Criteria criterium, String sortOrderString) {
  ...
  public java.util.List<VersionHistoryEntryVO> sortItemVersionList(
      java.util.List<VersionHistoryEntryVO> itemList,
      VersionHistoryEntryVOComparator.Criteria criterium,
      VersionHistoryEntryVOComparator.Order sortOrder) {
    if (logger.isDebugEnabled()) {
    ...
    // instanciate the comparator with the sorting criteria
    VersionHistoryEntryVOComparator versionHistoryEntryVOComparator =
        new VersionHistoryEntryVOComparator(criterium);
