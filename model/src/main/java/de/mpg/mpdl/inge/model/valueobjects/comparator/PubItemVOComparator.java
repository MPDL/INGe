...
/**
 * The class implements the comparison of two PubItemVOs for the criteria which has to be given in
 * the constructor. Note: this comparator imposes orderings that are inconsistent with equals.
 * 
...
public class PubItemVOComparator implements Comparator<PubItemVO> {
  ...
  /**
   * This method is for the comparison of the titles of the sources of two PubItemVOs. Both items
   * must not be null. If no source is given (is null) it is greater than a given source.
   * 
   * @param pubItem1 The first publication item.
   * @param pubItem2 The second publication item.
   * @return 0 if the items are equal, -1 if the first argument is less than the second, 1
   *         otherwise.
   */
  ...
  /**
   * This method compares the publisher names of the publihing info metadata of two PubItemVOs. Both
   * pubItems must not be null. If no publisher name is given (is null) it is greater than a given
   * publisher name.
   * 
   * @param pubItem1 The first publication item.
   * @param pubItem2 The second publication item.
  ...
  /**
   * This method compares the creators of the sources of two PubItemVOs. Both items must not be
   * null. If no source is given (is null) it is greater than a given source.
   * 
   * @param pubItem1 The first publication item.
   * @param pubItem2 The second publication item.
   * @return 0 if the items are equal, -1 if the first argument is less than the second, 1
  ...
  /**
   * This methods compares the review methods of two PubItemVOs. Both items must not be null. If no
   * review type is given (is null) it is greater than a review type .
   * 
   * @param pubItem1 The first publication item.
   * @param pubItem2 The second publication item.
   * @return 0 if the items are equal, -1 if the first argument is less than the second, 1
  ...
  /**
   * This method compares the titles of the events of two PubItemVOs. Both items must not be null.
   * If no event is given (is null) it is greater than a given event.
   * 
   * @param pubItem1 The first publication item.
   * @param pubItem2 The second publication item.
   * @return 0 if the items are equal, -1 if the first argument is less than the second, 1
  ...
  /**
   * This method compares the dates of two PubItemVOs using the most recent date in the metadata
   * record. Both items must not be null. If no date is given (is null) it is greater than a given
   * date.
   * 
   * @param pubItem1 The first publication item.
   * @param pubItem2 The second publication item.
