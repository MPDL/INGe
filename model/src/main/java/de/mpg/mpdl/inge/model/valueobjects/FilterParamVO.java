...
public class FilterParamVO {
  ...
  /**
   * @return One role as filter criteria. If a role is given, at least one user has to be given,
   *         too.
   */
  ...
  /**
   * @param newVal One role as filter criteria. If a role is given, at least one user has to be
   *        given, too.
   */
