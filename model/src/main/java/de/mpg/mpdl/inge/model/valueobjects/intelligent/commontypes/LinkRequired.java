...
public class LinkRequired extends IntelligentVO {
  ...
  /**
   * Get the 'objid' attribute value. <create>required</create> <update>required</update>
   * 
   * 
   * @return value
   */
  ...
  /**
   * Set the 'objid' attribute value. <create>required</create> <update>required</update>
   * 
   * 
   * @param objid
   */
