...
/**
 * Scanned images contain information about the physical parameters of the original media and the
...
public class ImageInfoVO extends ValueObject {
  ...
  /**
   * Delivers the desired presentation resolution in its width and height in pixels per inch.
   * Constraint: DisplayPpi is required, if neither the DisplaySizeX/Y nor the DisplayPpiX/Y is
   * given.
   */
  ...
  /**
   * Delivers the desired presentation resolution in its width in pixels per inch. Constraint:
   * DisplayPpiX is required, if neither the DisplaySizeX/Y nor the DisplayPpi is given.
   */
  ...
  /**
   * Delivers the desired presentation resolution in its height in pixels per inch. Constraint:
   * DisplayPpiY is required, if neither the DisplaySizeX/Y nor the DisplayPpi is given.
   */
  ...
  /**
   * Delivers the resolution of the scan in its widths and height in pixels per inch. Constraint:
   * OriginalPpi is required, if neither the OriginalSizeX/Y nor the OriginalPpiX/Y is given.
   */
  ...
  /**
   * Delivers the resolution of the scan in its width in pixels per inch. Constraint: OriginalPpiX
   * is required, if neither the OriginalSizeX/Y nor the OriginalPpi is given.
   */
  ...
  /**
   * Delivers the resolution of the scan in its height in pixels per inch. Constraint: OriginalPpiY
   * is required, if neither the OriginalSizeX/Y nor the OriginalPpi is given.
   */
  ...
  /**
   * Delivers the original size of the image in the direction of the X-axis, i. e. the width of the
   * original scanned area. Without a specified unit, the value is given in meter.
   */
  ...
  /**
   * Delivers the original size of the image in the direction of the Y-axis, i. e. the height of the
   * original scanned area. Without a specified unit, the value is given in meter.
   */
  ...
  /**
   * Sets the desired presentation resolution in its width and height in pixels per inch.
   * Constraint: DisplayPpi is required, if neither the DisplaySizeX/Y nor the DisplayPpiX/Y is
   * given.
   * 
   * @param newVal
  ...
  /**
   * Sets the desired presentation resolution in its width in pixels per inch. Constraint:
   * DisplayPpiX is required, if neither the DisplaySizeX/Y nor the DisplayPpi is given.
   * 
   * @param newVal
   */
  ...
  /**
   * Sets the desired presentation resolution in its height in pixels per inch. Constraint:
   * DisplayPpiY is required, if neither the DisplaySizeX/Y nor the DisplayPpi is given.
   * 
   * @param newVal
   */
  ...
  /**
   * Sets the resolution of the scan in its widths and height in pixels per inch. Constraint:
   * OriginalPpi is required, if neither the OriginalSizeX/Y nor the OriginalPpiX/Y is given.
   * 
   * @param newVal
   */
  ...
  /**
   * Sets the resolution of the scan in its width in pixels per inch. Constraint: OriginalPpiX is
   * required, if neither the OriginalSizeX/Y nor the OriginalPpi is given.
   * 
   * @param newVal
   */
  ...
  /**
   * Sets the resolution of the scan in its height in pixels per inch. Constraint: OriginalPpiY is
   * required, if neither the OriginalSizeX/Y nor the OriginalPpi is given.
   * 
   * @param newVal
   */
  ...
  /**
   * Sets the original size of the image in the direction of the X-axis, i. e. the width of the
   * original scanned area. Without a specified unit, the value is given in meter.
   * 
   * @param newVal
   */
  ...
  /**
   * Sets the original size of the image in the direction of the Y-axis, i. e. the height of the
   * original scanned area. Without a specified unit, the value is given in meter.
   * 
   * @param newVal
   */
