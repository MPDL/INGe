...
public abstract class MapStructMapper {
  ...
  @Mappings({@Mapping(source = "publicStatus", target = "object.publicState"), @Mapping(source = "pid", target = "object.objectPid"),
      ...
      @Mapping(source = "context.title", target = "object.context.name"), @Mapping(source = "creationDate", target = "object.creationDate"),
      @Mapping(source = "latestVersion", target = "object.latestVersion"),
      @Mapping(source = "latestRelease", target = "object.latestRelease"), @Mapping(source = "localTags", target = "object.localTags"),
      @Mapping(source = "metadata", target = "metadata"), @Mapping(source = "files", target = "files")})
  ...
  @Mappings({@Mapping(source = "objectId", target = "objectId"), @Mapping(source = "versionNumber", target = "versionNumber"),
      @Mapping(source = "modificationDate", target = "modificationDate"), @Mapping(source = "state", target = "versionState"),
      @Mapping(source = "pid", target = "versionPid"), @Mapping(source = "modifiedByRO.objectId", target = "modifier.objectId"),
  ...
  @Mappings({@Mapping(source = "reference.objectId", target = "objectId"), @Mapping(source = "name", target = "name"),
      ...
      @Mapping(source = "creationDate", target = "creationDate"), @Mapping(source = "defaultMetadata", target = "metadata"),
      @Mapping(source = "defaultMetadata.size", target = "size"), @Mapping(source = "contentCategory", target = "metadata.contentCategory"),
  ...
  @Mappings({@Mapping(source = "objectId", target = "objectId"), @Mapping(source = "title", target = "name")})
  @SubclassMappings({@SubclassMapping(source = FileRO.class, target = FileDbRO.class),
  ...
  @Mappings({@Mapping(source = "name", target = "name"), @Mapping(source = "creator.objectId", target = "creator.objectId"),
      ...
      @Mapping(source = "lastModificationDate", target = "lastModificationDate"), @Mapping(source = "state", target = "state"),
  ...
  @Mappings({@Mapping(source = "creator.objectId", target = "creator.objectId"),
      @Mapping(source = "creator.title", target = "creator.name"), @Mapping(source = "modifiedBy.objectId", target = "modifier.objectId"),
      @Mapping(source = "modifiedBy.title", target = "modifier.name"),
      @Mapping(source = "lastModificationDate", target = "lastModificationDate"), @Mapping(source = "defaultMetadata", target = "metadata"),
