...
public class UserAgentAnalyser {
  ...
  // }
  //
  // // This method relies on the preceding one to get the version number. It then truncates it to
  // the
  ...
  // // parameters and returns an array of 3 strings. This array is used to return the right label
  // for
  // // the right verbosity.
  //
  ...
  // // including the version number. This method might be out of date as I am testing this code on
  // a
  ...
  //
  // /*
  // * Here we go with a big piece: The detection of the OS. The code is mostly focused on Windows
  // for
  // * two reasons:
  // *
  // * 1. It is the most encountered OS, see here for details. 2. The version numbers are a little
  // * screwed as the OS is represented by two names (Win and Windows) and the version numbers for
  // NT
  ...
  // * for the generic versions from mozilla.org. Additionally, Netscape in its versions greater
  // than
  // * 6 also uses Gecko. 3. KHTML stands for the KDE renderer. It is packaged as Konqueror for
  // Linux
