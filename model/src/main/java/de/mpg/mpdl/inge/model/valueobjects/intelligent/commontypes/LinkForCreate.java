...
public class LinkForCreate extends IntelligentVO {
  ...
  /**
   * Get the 'objid' attribute value. <create>required</create> <update>discarded</update>
   * 
   * 
   * @return value
   */
  ...
  /**
   * Set the 'objid' attribute value. <create>required</create> <update>discarded</update>
   * 
   * 
   * @param objid
   */
