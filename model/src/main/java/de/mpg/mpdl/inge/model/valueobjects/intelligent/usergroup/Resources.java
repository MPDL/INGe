...
import de.mpg.mpdl.inge.model.valueobjects.intelligent.commontypes.ReadOnlyLink;
...
public class Resources extends IntelligentVO {
  ...
  /**
   * Get the 'current-grants' element value. <create>discarded</create> <update>discarded</update>
   * 
   * 
   * @return value
   */
  ...
  /**
   * Set the 'current-grants' element value. <create>discarded</create> <update>discarded</update>
   * 
   * 
   * @param currentGrants
   */
  ...
  /**
   * Get the 'last-modification-date' attribute value. <create>discarded</create> <update>discarded
   * (see note 3.)</update> <comment> 3. This attribute is contained if the resources element is
   * retrieved as a sub resource. It is not contained in the resources element within the user-group
   * element. </comment>
   * 
   * 
   * @return value
  ...
  /**
   * Set the 'last-modification-date' attribute value. <create>discarded</create> <update>discarded
   * (see note 3.)</update> <comment> 3. This attribute is contained if the resources element is
   * retrieved as a sub resource. It is not contained in the resources element within the user-group
   * element. </comment>
   * 
