...
import de.mpg.mpdl.inge.model.valueobjects.metadata.ImageAcquisitionDeviceVO;
import de.mpg.mpdl.inge.model.valueobjects.metadata.ImageInfoVO;
...
public class MdsImageVO extends MetadataSetVO {
  ...
  /**
   * Delivers the image acquisition device, i. e. information about the technology used in the
   * process of producing the digital image.
   */
  ...
  /**
   * Delivers the location of the image, e.g. the place where the photographed object(s) were or are
   * located, described in common words.
   */
  ...
  /**
   * Delivers the page number of the image, i. e. the Number of the original page. Constraint:
   * PageNumber is only required for ImageType 'page'.
   */
  ...
  /**
   * Sets the image acquisition device, i. e. information about the technology used in the process
   * of producing the digital image.
   * 
   * @param newVal newVal
   */
  ...
  /**
   * Sets the location of the image, e.g. the place where the photographed object(s) were or are
   * located, described in common words.
   * 
   * @param newVal newVal
   */
  ...
  /**
   * Sets the page number of the image, i. e. the Number of the original page. Constraint:
   * PageNumber is only required for ImageType 'page'.
   * 
   * @param newVal newVal
   */
