...
public class Selector extends IntelligentVO {
  ...
  /**
   * Get the 'type' attribute value. <create>discarded</create> <update>discarded</update>
   * 
   * 
   * @return value
   */
  ...
  /**
   * Set the 'type' attribute value. <create>discarded</create> <update>discarded</update>
   * 
   * 
   * @param type
   */
