...
/**
 * Interface for creation and sending of emails with attachment. (Used in the export functionalty.)
...
public interface EmailHandling {
  ...
  /**
   * Method for creating and sending an email with attached file. The sending requires
   * authentication.
   * 
