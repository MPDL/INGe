 ...
 * which is the ADT type of ItemResultVO and ContainerResultVO, and it consists of the corresponding
 * cql query.
 * 
 * @author endres
 * 
...
public class ItemContainerSearchResult extends SearchResult implements Serializable {
   ...
   */
  public ItemContainerSearchResult(List<SearchResultElement> results, String cqlQuery,
