...
public interface Search {
   ...
   * @throws Exception if some errors occur during search
   */
  public ItemContainerSearchResult searchForItemContainerAdmin(SearchQuery query, String userHandle)
      throws Exception;

  /**
   * 
   * The SearchAndExport interface is used to search for items. and exports them to various formats.
   * 
   * @param query an export search query
