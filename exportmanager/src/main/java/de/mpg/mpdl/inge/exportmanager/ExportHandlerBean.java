...
public class ExportHandlerBean implements ExportHandler {
  ...
  public File generateArchiveFile(String exportFormat, String archiveFormat, byte[] exportOut,
    ...
    return exportService.generateArchiveFile(exportFormat, archiveFormat, exportOut,
        itemListFiltered);
  }
   ...
   * @throws IOException
   */
  public byte[] generateArchive(String exportFormat, String archiveFormat, byte[] export,
      String itemListFiltered) throws ExportManagerException, IOException {
