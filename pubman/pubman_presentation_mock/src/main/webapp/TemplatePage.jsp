	...
	<f:view>
		...
		<f:loadBundle var="msg" basename="Messages"/>
			<html>
				...
				<body>
					<h:outputText id="pageDummy" value="#{TemplatePage.beanName}" style="height: 0px; width: 0px; visibility:hidden; position: absolute" />
					<div id="page_margins">
						<div id="page">
							<h:form id="form1">
								<div id="header">
								...
								<div id="main">
									...
									<div id="col3">
										<div class="content">
											<jsp:directive.include file="template/Template.jspf"/>
										</div>
									</div>
								</div>
							</h:form>
