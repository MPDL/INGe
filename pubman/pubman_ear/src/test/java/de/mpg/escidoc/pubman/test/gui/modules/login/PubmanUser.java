...
public class PubmanUser {
  public enum UserType {
    DepositorModeratorSimpleWF, ModeratorSimpleWF, DepositorSimpleWF, DepositorModeratorStandardWF, ModeratorStandardWF, DepositorStandardWF, DepositorModeratorSimpleStandardWF, ModeratorSimpleStandardWF, DepositorSimpleStandardWF,
  }

  public enum UserRights {
    DepositorLink, QALink, SubmissionLink
  }
  ...
  public EnumMatrix<UserType, UserRights> userRightsMatrix = new EnumMatrix<UserType, UserRights>(
      20);
  ...
  private void buildUserRightsMatrix() {
    ...
    userRightsMatrix
        .setValue(UserType.DepositorModeratorStandardWF, UserRights.DepositorLink, true);
    userRightsMatrix.setValue(UserType.DepositorModeratorStandardWF, UserRights.QALink, true);
    userRightsMatrix.setValue(UserType.DepositorModeratorStandardWF, UserRights.SubmissionLink,
        true);
    ...
    userRightsMatrix.setValue(UserType.DepositorModeratorSimpleStandardWF,
        UserRights.DepositorLink, true);
    userRightsMatrix.setValue(UserType.DepositorModeratorSimpleStandardWF, UserRights.QALink, true);
    userRightsMatrix.setValue(UserType.DepositorModeratorSimpleStandardWF,
        UserRights.SubmissionLink, true);
  ...
  public void retrieveLoginCredentials() {
    switch (userType) {
      ...
      case DepositorModeratorSimpleStandardWF:
        this.username =
            properties.getProperty("selenium.depositorModerator.simpleStandardWF.username");
        this.password =
