...
/**
 * This class provides the ejb implementation of the {@link ItemExporting}
 * interface.
 * 
 * @author Galina Stancheva (initial creation)
 * @author $Author$ (last modification)
 * @version $Revision$ $LastChangedDate: 2014-08-20 10:31:05 +0200 (Mi,
 *          20 Aug 2014) $ Revised by StG: 24.08.2007
 */
...
public class ItemExportingBean implements ItemExporting {
	 ...
	 * {@inheritDoc}
	 */
	public List<ExportFormatVO> explainExportFormats()
	...
	public byte[] getOutput(ExportFormatVO exportFormat,
			List<PubItemVO> pubItemVOList) throws TechnicalException {
	...
	/**
	 * Output wrapper for structuredExportHandler.getOutput and
	 * citationStyleHandler.getOutput. Parameters should be controlled in the
	 * colling methods!
	 * 
	 * @param exportFormat
	 *            - export format
	 ...
	 *            - output format type
	 * @param itemList
	 *            - xml item list in item-list.xsd schema
	...
	/**
	 * Appends an export structured format to a list of ExportFormatVOs and
	 * returns it.
	 * 
	 * @param listExportFormatVO
	 *            the list of export formats to which a structured export format
	 *            should be added.
	 */
	private List<ExportFormatVO> appendStructuredFormat(
			List<ExportFormatVO> listExportFormatVO) {
