 ...
 * @version $Revision$ $LastChangedDate$ Revised by StG: 05.10.2007
 */
public class ItemExportingTest extends TestBase {
  ...
  public void setUp() throws NamingException {
    itemExporting =
        (ItemExporting) getService("ejb:pubman_logic_ear/pubman_logic/ItemExportingBean!"
            + ItemExporting.class.getName());
  ...
  public void testGetLayoutFormatOutput() throws TechnicalException {
    ...
    logger.info("List<PubItemVO> exported into " + exportLayoutFormat.getName() + " "
        + exportLayoutFormat.getSelectedFileFormat().getName());
  ...
  public void testGetStructuredFormatOutput() throws TechnicalException {
    ...
    logger.info("List<PubItemVO> exported into " + exportStructuredFormat.getName() + " "
        + exportStructuredFormat.getSelectedFileFormat().getName());
    assertNotNull(itemsExportData);
    logger.debug("export data  =\n" + new String(itemsExportData));
