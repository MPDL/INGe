...
public class ApplicationLogTest {
  ...
  /**
   * Test method for
   * {@link de.mpg.escidoc.services.pubman.logging.ApplicationLog#info(de.mpg.escidoc.services.common.logging.Messages, java.lang.Object[])}
   * .
   */
  @Test
  public void testInfo() {
    ...
    assertEquals("The PubItem with ID 4711 has been created by user userid.", appender
        .getLastLoggingEvent().getMessage());
    assertEquals(Level.INFO, appender.getLastLoggingEvent().getLevel());
    assertEquals(ApplicationLog.APPLICATION_LOGGER_NAME, appender.getLastLoggingEvent()
        .getLoggerName());
  }
}
