...
<body>
	<h:outputText id="pageDummy" value="#{ViewItemLogPage.beanName}" style="height: 0px; width: 0px; visibility:hidden; position: absolute" />
	<div id="page_margins">
						<div id="page">
		<h:form id="form1">
		<div id="header">
					 ...
					 <jsp:directive.include file="desktop/Navigation.jspf"/>
							...
							<div id="col2">
								<div class="contentActions">
									...
									<ul>
										<li><h:commandLink id="lnkHelp" onclick="loadHelp('#{InternationalizationHelper.selectedHelpPage}', '#ItemLog');return false" value="#{lbl.mainMenu_lnkHelp}"/></li>
									</ul>
								</div>
							</div>
									<div id="col3">
