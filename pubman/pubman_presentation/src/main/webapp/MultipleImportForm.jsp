													...
													<span class="xHuge_area0 xTiny_marginLExcl endline">
														<span class="huge_area0">
															<a4j:repeat var="parameter" value="#{MultipleImport.configParameters}">
																...
																<h:inputText id="inpImportParamOrgUnit" styleClass="xLarge_txtInput" value="#{LoginHelper.accountUsersAffiliations[0].name }" rendered="#{parameter.label == 'OrganizationalUnit' and LoginHelper.accountUsersAffiliations[0] != null}"/>
