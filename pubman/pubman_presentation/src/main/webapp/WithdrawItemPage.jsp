            ...
            <ui:html id="html1">
                <ui:head id="head1">
					...
					<script type="text/javascript">
						clickHeatPage = 'WithdrawItemPage'; //Identifier der Seite
						initClickHeat();
					</script>
                </ui:head>
                <ui:body id="body1">
		                        ...
		                        <div id="main">
			                        ...
			                        <div id="col2">
										<div class="contentActions">
											...
											<ul>
												<li><ui:hyperlink id="lnkHelp" onClick="loadHelp('#{util$InternationalizationHelper.selectedHelpPage}', '#WithdrawItem');return false"
										            text="#{lbl.mainMenu_lnkHelp}"/></li>
												<li><ui:hyperlink id="lnkWithdraw" text="#{lbl.WithdrawItem_lnkWithdraw}" action="#{withdrawItem$WithdrawItem.withdraw}"/></li>
												<li><ui:hyperlink id="lnkCancel" immediate="true" text="#{lbl.WithdrawItem_lnkCancel}" action="#{withdrawItem$WithdrawItem.cancel}"/></li>
											</ul>
										</div>
									</div>
									<div id="col3">
