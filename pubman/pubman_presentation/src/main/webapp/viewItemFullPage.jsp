					...
					<div class="clear">
						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<!-- content menu starts here -->
								...
								<h:panelGroup layout="block" styleClass="sub action" rendered="#{ViewItemSessionBean.subMenu == 'ACTIONS'}">
								<!-- content menu lower line starts here -->										
									...
									<h:panelGroup styleClass="seperator" rendered="#{!ViewItemFull.isStateWithdrawn and ViewItemFull.isStateReleased and ViewItemFull.isLatestRelease and !ViewItemFull.isCreateNewRevisionDisabled and ViewItemFull.isDepositor}" />
                                    <h:commandLink id="lnkCreateItemFromTemplate" action="#{ItemControllerSessionBean.createItemFromTemplate}" value="#{lbl.ViewItemFull_lblCreateItemFromTemplate}" rendered="#{!ViewItemFull.isStateWithdrawn and ViewItemFull.isStateReleased and ViewItemFull.isLatestRelease and !ViewItemFull.isCreateNewRevisionDisabled and ViewItemFull.isDepositor}"/>
