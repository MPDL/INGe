	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<link rel="unapi-server" type="application/xml" title="unAPI" href="#{YearbookMembersRetrieverRequestBean.unapiURLview}"/>

				<jsp:directive.include file="header/ui/StandardImports.jspf" />

			</head>
			<body lang="#{InternationalizationHelper.locale}">
			<h:outputText value="#{YearbookMembersRetrieverRequestBean.beanName}" styleClass="noDisplay" />
					...
					<div class="clear">
						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<div class="subHeader">
								...
								<h:messages styleClass="singleMessage" errorClass="messageError" warnClass="messageWarn" fatalClass="messageFatal" infoClass="messageStatus" layout="list" globalOnly="true" showDetail="false" showSummary="true" rendered="#{YearbookMembersRetrieverRequestBean.numberOfMessages == 1}"/>
								<h:panelGroup layout="block" styleClass="half_area2_p6 messageArea errorMessageArea" rendered="#{YearbookMembersRetrieverRequestBean.hasErrorMessages and YearbookMembersRetrieverRequestBean.numberOfMessages != 1}">
									<h2><h:outputText value="#{lbl.warning_lblMessageHeader}"/></h2>
									<h:messages errorClass="messageError" warnClass="messageWarn" fatalClass="messageFatal" infoClass="messageStatus" layout="list" globalOnly="true" showDetail="false" showSummary="true" rendered="#{YearbookMembersRetrieverRequestBean.hasMessages}"/>
								</h:panelGroup>
								<h:panelGroup layout="block" styleClass="half_area2_p6 messageArea infoMessageArea" rendered="#{YearbookMembersRetrieverRequestBean.hasMessages and !YearbookMembersRetrieverRequestBean.hasErrorMessages and YearbookMembersRetrieverRequestBean.numberOfMessages != 1}">
