            ...
            <ui:html id="html1">
                <ui:head id="head1">
					...
					<script type="text/javascript">
						clickHeatPage = 'DepositorWSPage'; //Identifier der Seite
						initClickHeat();
					</script>
                </ui:head>
                <ui:body id="body1">
...
<!--										        <li><ui:hyperlink binding="#{depositorWS$DepositorWS.lnkModify}" id="lnkModify" action="#{depositorWS$DepositorWS.editItem}" -->
<!--										             text="#{lbl.actionMenu_lnkModify}"/></li>-->
										        ...
										        <li><ui:hyperlink binding="#{depositorWS$DepositorWS.lnkWithdraw}" id="lnkWithdraw" action="#{depositorWS$DepositorWS.withdrawSelectedItem}" 
