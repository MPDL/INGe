            ...
            <ui:html id="html1">
                <ui:head id="head1">
					...
					<script type="text/javascript">
						clickHeatPage = 'ChooseCollectionPage'; //Identifier der Seite
						initClickHeat();
					</script>
                </ui:head>
                <ui:body id="body1">
		                        ...
		                        <div id="main">
			                        ...
			                        <div id="col2">
										<div class="contentActions">
											...
											<ul>
												<li><ui:hyperlink id="lnkHelp" onClick="loadHelp('#{util$InternationalizationHelper.selectedHelpPage}', '#CreateRevision');return false"
			                        ...
			                        <div id="col3">
										<div class="content">
				                            <jsp:directive.include file="revisions/ChooseCollection.jspf"/>
				                        </div>
				                    </div>
		                        </div>
		                    </ui:form>
