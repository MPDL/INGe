		    ...
		    <body id="helppage" lang="de-DE" dir="ltr">
		        <div class="maketitle wrapper" style="padding: 0.74em 0.74em 3em 0.74em; font-size: 129% !important; width: auto;">
					...
					<p class="noindent">
						...
						bei dem eine Publikation erst nach <span class="nobreak">Kontrolle und Zustimmung</span> einer autorisierten Person, z.B. einem/r Bibliotekar/in,
						f&#252;r die &#214;ffentlichkeit sichtbar gemacht wird.&#160;
					</p>
					<p class="noindent">
						Zus&#228;tzlich zu den Workflows gibt es
						Nutzerrollen mit unterschiedlichen Privilegien. Diese sind vom
						Grundprinzip her gleich aufgebaut, die Berechtigungen k&#246;nnen
						je nach Workflow anders sein. Die Rolle des Depositors, beispielsweise ist
					...
					<p class="noindent">
						Da die Rollen in den Instituten sehr unterschiedlich besetzt sein k&#246;nnen, k&#246;nnen Rollen
						auch kombiniert werden. So kann ein Nutzer beispielsweise auch Depositor und Moderator in einem sein.
					</p>
		            ...
		            <h3><span class="titlemark">3.3.</span><a name="Basket">Basket</a></h3>
		            <p class="noindent">
		            ...
		            <h4><span class="titlemark">3.4.1.</span><a name="Freigabegeschichte_einsehen">Freigabegeschichte einsehen</a></h4>
		            <p class="noindent">
		            ...
		            <h3><span class="titlemark">4.4.</span><a name="Validierung">Validierung</a></h3>
		            <p class="noindent">
		            ...
		            <h2><span class="titlemark">6.</span><a name="Hilfsmittel zur Datenverwaltung">Hilfsmittel zur Datenverwaltung</a></h2>
		            <p class="noindent">
