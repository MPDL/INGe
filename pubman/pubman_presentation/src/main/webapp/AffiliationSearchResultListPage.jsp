...
<jsp:root version="2.1" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:jsp="http://java.sun.com/JSP/Page" xmlns:tr="http://myfaces.apache.org/trinidad">
	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<h:outputText id="pageDummy" value="#{AffiliationSearchResultListPage.beanName}" styleClass="noDisplay" />
						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<!-- content menu starts here -->
								...
								<!-- content menu lower line starts here -->
									...
									<h:commandLink styleClass="ascSort" value="#{lbl.ItemList_SortOrderAscending}" id="sortOrderAsc" rendered="#{ItemListSessionBean.isAscending}" actionListener="#{ItemListSessionBean.setSortOrder}" />
									<h:commandLink styleClass="desSort" value="#{lbl.ItemList_SortOrderDescending}" id="sortOrderDesc" rendered="#{!ItemListSessionBean.isAscending}" actionListener="#{ItemListSessionBean.setSortOrder}" />
							...
							<div class="subHeader">
								<!-- Subheadline starts here -->
								<h:messages style="list-style-type: none; padding: 0px;" errorClass="messageError" warnClass="messageWarn" fatalClass="messageFatal" infoClass="messageStatus" layout="list" globalOnly="true" showDetail="false" showSummary="true" rendered="#{SearchResultListPage.numberOfMessages == 1}"/>
								<h:panelGroup layout="block" styleClass="half_area2_p6 messageArea errorMessageArea" rendered="#{SearchResultListPage.hasErrorMessages and SearchResultListPage.numberOfMessages != 1}">
								...
								<h:panelGroup layout="block" styleClass="half_area2_p6 messageArea infoMessageArea" rendered="#{SearchResultListPage.hasMessages and !SearchResultListPage.hasErrorMessages and SearchResultListPage.numberOfMessages != 1}">
	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
		...
		<f:loadBundle var="msg" basename="Messages"/>
			<html>
				...
				<body>
					<h:outputText id="pageDummy" value="#{AffiliationSearchResultListPage.beanName}" style="height: 0px; width: 0px; visibility:hidden; position: absolute" />
					<div id="page_margins">
						<div id="page">
							<h:form id="form1">
								<div id="header">
