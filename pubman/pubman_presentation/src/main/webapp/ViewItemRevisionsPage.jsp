...
<jsp:root version="1.2" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:jsp="http://java.sun.com/JSP/Page" xmlns:ui="http://www.sun.com/web/ui">
    ...
    <f:view>
        <ui:page id="page1" binding="#{ViewItemRevisionsPage.page}">
            <ui:html id="html1">
                <ui:head id="head1">
					...
					<script type="text/javascript">
						clickHeatPage = 'ViewItemRevisionsPage'; //Identifier der Seite
						initClickHeat();
					</script>
                </ui:head>
                <ui:body id="body1">
		                        ...
		                        <div id="main">
				                    ...
				                    <div id="col2">
										<div class="contentActions">
											...
											<ul>
												<li><ui:hyperlink id="lnkHelp" onClick="loadHelp('#{util$InternationalizationHelper.selectedHelpPage}', '#ViewRevision');return false"
