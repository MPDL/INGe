            ...
            <ui:html id="html1">
                <ui:head id="head1">
					...
					<script type="text/javascript">
						clickHeatPage = 'CreateRevisionPage'; //Identifier der Seite
						initClickHeat();
					</script>
                </ui:head>
                <ui:body id="body1">
		                        ...
		                        <div id="main">
			                        ...
			                        <div id="col2">
										<div class="contentActions">
											...
											<ul>
												<li><ui:hyperlink id="lnkHelp" onClick="loadHelp('#{util$InternationalizationHelper.selectedHelpPage}', '#NewRevision');return false"
			                        ...
			                        <div id="col3">
										<div class="content">
				                            <jsp:directive.include file="revisions/CreateRevision.jspf"/>
				                        </div>
				                    </div>
		                        </div>
		                    </ui:form>
