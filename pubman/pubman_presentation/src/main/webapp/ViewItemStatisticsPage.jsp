...
<jsp:root version="1.2" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:jsp="http://java.sun.com/JSP/Page" xmlns:ui="http://www.sun.com/web/ui">
    ...
    <f:view>
        <ui:page id="page1" binding="#{ViewItemStatisticsPage.page}">
            <ui:html id="html1">
                <ui:head id="head1">
					...
					<script type="text/javascript">
						clickHeatPage = 'ViewItemStatisticsPage'; //Identifier der Seite
						initClickHeat();
					</script>
                </ui:head>
                <ui:body id="body1">
                	<div id="page_margins">
						<div id="page" binding="ViewItemStatisticsPage.page">
		                    <ui:form id="form1">
		                          <div id="main">			                 
									<div id="col3">
										<div>
