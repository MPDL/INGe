            ...
            <ui:html id="html1">
                <ui:head id="head1">
					...
					<script type="text/javascript">
						clickHeatPage = 'ErrorPage'; //Identifier der Seite
						initClickHeat();
					</script>
                </ui:head>
                <ui:body id="body1">
			                        ...
			                        <div id="col3">
										<div class="content">
											...
											<h:panelGrid id="panButtons" columns="1">
												<h:outputLink value="#{ApplicationBean.appContext}#{breadCrumb$BreadCrumbNavigation.previousPageURI}">
													<h:outputText value="#{breadCrumb$BreadCrumbNavigation.previousPageName}"/>
												</h:outputLink>
											</h:panelGrid>
				                        </div>
				                    </div>
