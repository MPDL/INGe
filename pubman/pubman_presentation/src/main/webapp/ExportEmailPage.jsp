	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
		...
		<f:loadBundle var="msg" basename="Messages"/>
			<html>
				...
				<body>
					<h:outputText id="pageDummy" value="#{ExportEmailPage.beanName}" style="height: 0px; width: 0px; visibility:hidden; position: absolute" />
					<div id="page_margins">
						<div id="page">
							<h:form id="form1">
								<div id="header">
								...
								<div id="main">
									...
									<div id="col2">
										<div class="contentActions">
											...
											<ul>
												<li><h:commandLink id="lnkHelp" onclick="loadHelp('#{InternationalizationHelper.selectedHelpPage}', '#ExportEMail');return false" value="#{lbl.mainMenu_lnkHelp}"/></li>
											</ul>
										</div>
									</div>
									<div id="col3">
