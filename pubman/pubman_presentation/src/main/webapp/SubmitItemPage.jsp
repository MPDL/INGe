		                        ...
		                        <div id="main">
			                        ...
			                        <div id="col2">
										<div class="contentActions">
											...
											<ul>
												<li><ui:hyperlink id="lnkHelp" onClick="loadHelp('#{util$InternationalizationHelper.selectedHelpPage}', '#SubmissionComment');return false;return false;"
										            text="#{lbl.mainMenu_lnkHelp}"/></li>
												<li><ui:hyperlink id="lnkSubmit" text="#{lbl.SubmitItem_lnkSubmit}" action="#{submitItem$SubmitItem.submit}"/></li>
												<li><ui:hyperlink id="lnkCancel" immediate="true" text="#{lbl.SubmitItem_lnkCancel}" action="#{submitItem$SubmitItem.cancel}"/></li>
											</ul>
										</div>
									</div>
									<div id="col3">
