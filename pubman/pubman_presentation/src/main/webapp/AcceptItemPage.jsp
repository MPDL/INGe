            ...
            <ui:html id="html1">
                <ui:head id="head1">
					...
					<script type="text/javascript">
						clickHeatPage = 'AcceptItemPage'; //Identifier der Seite
						initClickHeat();
					</script>
                </ui:head>
                <ui:body id="body1">
		                        ...
		                        <div id="main">
			                        ...
			                        <div id="col2">
										<div class="contentActions">
											...
											<ul>
												<li><ui:hyperlink id="lnkHelp" onClick="loadHelp('#{util$InternationalizationHelper.selectedHelpPage}', '#AcceptanceComment');return false"
										            text="#{lbl.mainMenu_lnkHelp}"/></li>
												<li><ui:hyperlink id="lnkAccept" text="#{lbl.AcceptItem_lnkAccept}" action="#{acceptItem$AcceptItem.accept}"/></li>
												<li><ui:hyperlink id="lnkCancel" immediate="true" text="#{lbl.AcceptItem_lnkCancel}" action="#{acceptItem$AcceptItem.cancel}"/></li>
											</ul>
										</div>
									</div>
									<div id="col3">
