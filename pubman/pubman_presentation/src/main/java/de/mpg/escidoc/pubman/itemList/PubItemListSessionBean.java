...
public class PubItemListSessionBean extends BasePaginatorListSessionBean<PubItemVOPresentation, PubItemListSessionBean.SORT_CRITERIA>
{
    ...
    { 
        ...
        CREATOR ("sort.publication.compound.publication-creator-names", "/md-records/md-record/publication/creator/person/family-name", OrderFilter.ORDER_ASCENDING), //TODO: Change back to sort.escidoc.complete-name when complete name is filled!!
        ...
        STATE("sort.escidoc.property.version.status", "/properties/version/status", OrderFilter.ORDER_ASCENDING),
        OWNER("sort.escidoc.property.created-by.name", "/properties/created-by/title", OrderFilter.ORDER_ASCENDING),
