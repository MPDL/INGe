...
/**
 * GTEditItemPage.java Backing bean for GTEditItemPage.jsp This is for the GUI tool mode. The pubman frame will not be
 * displayed.
 * 
 ...
 */
public class GTEditItemPage extends AbstractPageBean
{
