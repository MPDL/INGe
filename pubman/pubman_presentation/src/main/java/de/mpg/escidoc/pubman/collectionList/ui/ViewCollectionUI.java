...
public class ViewCollectionUI extends HtmlPanelGroup
{
     ...
     * Public constructor.
     */
    public ViewCollectionUI(PubCollectionVOWrapper pubCollectionVOWrapper)
    {
        ...
        this.lblDescription.setValue(pubCollectionVOWrapper.getValueObject().getDescription());
