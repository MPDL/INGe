...
// <iso:assert test="not(escidocComponents:content/@xlink:href != '')
// or
// escidocMetadataRecords:md-records/escidocMetadataRecords:md-record[@name='escidoc']/file:file/dc:title
// != ''">
// ComponentFileNameNotProvided
// </iso:assert>

// <!-- If a file is given, the content category is mandatory. -->
// <iso:assert test="not(escidocComponents:content/@xlink:href != '')
// or escidocComponents:properties/prop:content-category != ''">
...
// or escidocComponents:content/@storage = 'external-url'">
// ComponentMimeTypeNotProvided
// </iso:assert>

// <!-- If a file is given, the visibility is mandatory. -->
// <iso:assert test="not(escidocComponents:content/@xlink:href != '')
// or escidocComponents:properties/prop:visibility != ''">
// ComponentVisibilityNotProvided
// </iso:assert>
...
// -> FileVO.mimeType
// escidocComponents:properties/prop:category
// -> FileVO.contentCategorie
// escidocComponents:properties/prop:visibility
// -> FileVO.visibility
