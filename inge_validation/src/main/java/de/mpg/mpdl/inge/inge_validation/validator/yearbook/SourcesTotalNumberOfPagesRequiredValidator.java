...
public class SourcesTotalNumberOfPagesRequiredValidator extends ValidatorHandler<List<SourceVO>>
        ...
        if (sourceVO != null) {
          ...
          if (ValidationTools.isEmpty(sourceVO.getTotalNumberOfPages())) {
            ...
            context.addError(ValidationError.create(
                ErrorMessages.TOTAL_NUMBER_OF_PAGES_NOT_PROVIDED).setField("source[" + i + "]"));
