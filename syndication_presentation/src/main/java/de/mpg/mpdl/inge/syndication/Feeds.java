...
public class Feeds {
   ...
   */
  public static Feeds readFeedsFromXml(String rulesFileName, String feedsFileName)
      throws SyndicationException {
    ...
    try {
      InputStream input =
          ResourceUtil.getResourceAsStream(feedsFileName, Feeds.class.getClassLoader());
