...
public class DatabaseHelper {
  ...
  public static final String GET_CACHE_FIRST_ELEMENT_STATEMENT = "SELECT * FROM ESCIDOC_PID_CACHE";
  public static final String ADD_ELEMENT_STATEMENT = "INSERT INTO ESCIDOC_PID_CACHE VALUES (?, ?)";
  public static final String REMOVE_ELEMENT_STATEMENT =
      "DELETE FROM ESCIDOC_PID_CACHE WHERE IDENTIFIER = ?";
  public static final String CACHE_SIZE_STATEMENT =
      "SELECT COUNT(*) AS SIZE FROM ESCIDOC_PID_CACHE";

  // Statements for pid queue table
  public static final String GET_QUEUE_FIRST_ELEMENT_STATEMENT = "SELECT * FROM ESCIDOC_PID_QUEUE";
  public static final String ADD_QUEUE_ELEMENT_STATEMENT =
      "INSERT INTO ESCIDOC_PID_QUEUE VALUES (?, ?, ?)";
  public static final String REMOVE_QUEUE_ELEMENT_STATEMENT =
      "DELETE FROM ESCIDOC_PID_QUEUE WHERE IDENTIFIER = ?";
