...
public class GwdgPidService {
  ...
  public String retrieve(String id) throws Exception {
    GwdgClient client = new GwdgClient();
    GetMethod retrieve =
        new GetMethod(GWDG_PIDSERVICE.concat(GWDG_PIDSERVICE_VIEW).concat("?pid=").concat(id));
  ...
  public String search(String url) throws Exception {
    GwdgClient client = new GwdgClient();
    GetMethod search =
        new GetMethod(GWDG_PIDSERVICE.concat(GWDG_PIDSERVICE_FIND).concat("?url=").concat(url));
  ...
  public String update(String id, String url) throws Exception {
    PostMethod update =
        new PostMethod(GWDG_PIDSERVICE.concat(GWDG_PIDSERVICE_EDIT).concat("?pid=").concat(id));
  ...
  public String delete(String id) throws Exception {
    DeleteMethod delete =
        new DeleteMethod(GWDG_PIDSERVICE.concat(GWDG_PIDSERVICE_DELETE).concat("?pid=").concat(id));
    GwdgClient client = new GwdgClient();
  ...
  public boolean available() {
    ...
    try {
      ...
      client.getHttpConnectionManager().getParams()
          .setConnectionTimeout(GwdgClient.GWDG_SERVICE_TIMEOUT);
