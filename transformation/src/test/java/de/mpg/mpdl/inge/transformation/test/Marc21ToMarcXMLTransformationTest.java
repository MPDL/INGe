...
public class Marc21ToMarcXMLTransformationTest {
  ...
  public static final Format MARCXML_FORMAT_RECEIVED = new Format("marcxml",
      "application/marcxml+xml", "*");
  public static final Format MARCXML_FORMAT_REQUEST = new Format("marcxml",
      "application/marcxml+xml", "UTF-8");

  private Marc21ToMarcXMLTransformation marc21ToMarcXML_transf =
      new Marc21ToMarcXMLTransformation();
...

  {
    try {
      src =
          ResourceUtil.getResourceAsBytes("testFiles/marc/simplemarcrecord.mrc",
              Marc21ToMarcXMLTransformationTest.class.getClassLoader());
      expected =
          ResourceUtil.getResourceAsString("testFiles/marcxml/simplemarcrecord.xml",
              Marc21ToMarcXMLTransformationTest.class.getClassLoader());
    } catch (Exception e) {
  ...
  @Test
  public void testTransformByteArrayStringStringStringStringStringStringString()
      throws TransformationNotSupportedException, RuntimeException {
    String actual =
        new String(marc21ToMarcXML_transf.transform(src, "marc21", "application/marc", "",
            "marcxml", "application/marcxml+xml", "UTF-8", null)) + "\n";
  ...
  public void testTransformByteArrayFormatFormatString()
    ...
    String actual =
        new String(transf.transform(src, MARC21_FORMAT, MARCXML_FORMAT_REQUEST, null)) + "\n";
    assertEquals(expected, actual);
    transf = null;
  }

  @Test
  public void testTransformByteArrayFormatFormatStringMapOfStringString()
      throws TransformationNotSupportedException, RuntimeException {
    String actual =
        new String(marc21ToMarcXML_transf.transform(src, MARC21_FORMAT, MARCXML_FORMAT_REQUEST,
  ...
  public void testGetConfiguration() throws Exception {
    Map<String, String> actual =
        marc21ToMarcXML_transf.getConfiguration(MARC21_FORMAT, MARCXML_FORMAT_REQUEST);
  ...
  public void testGetConfigurationValues() throws Exception {
    List<String> actual =
        marc21ToMarcXML_transf.getConfigurationValues(MARC21_FORMAT, MARCXML_FORMAT_REQUEST,
            "nevermind");
  ...
  public void testWrongSourceFormat() throws TransformationNotSupportedException, RuntimeException {
    String actual =
        new String(marc21ToMarcXML_transf.transform(src, MARCXML_FORMAT_REQUEST,
            MARCXML_FORMAT_REQUEST, null, null)) + "\n"; // somewhere in the chain a \n was added
    assertEquals("", actual);
  }
  ...
  public void testWrongTargetFormat() throws TransformationNotSupportedException, RuntimeException {
    String actual =
        new String(marc21ToMarcXML_transf.transform(src, MARC21_FORMAT, MARC21_FORMAT, null, null))
            + "\n"; // somewhere in the chain a \n was added
    assertEquals("", actual);
  }
  ...
  public void testTransformationBean() {
    ...
    assertTrue("missing MARCXML_FORMAT in transformationbean.getTargetFormats(MARC21_FORMAT)",
        Util.containsFormat(transformationbean.getTargetFormats(MARC21_FORMAT),
            MARCXML_FORMAT_RECEIVED));

    assertTrue(
        "missing MARC21_FORMAT in transformationbean.getSourceFormats(MARCXML_FORMAT_REQUEST)",
        Util.containsFormat(transformationbean.getSourceFormats(MARCXML_FORMAT_REQUEST),
            MARC21_FORMAT));

    assertTrue("checkTransformation MARC21_FORMAT->MARCXML_FORMAT_REQUEST failed",
        transformationbean.checkTransformation(MARC21_FORMAT, MARCXML_FORMAT_REQUEST));
    assertTrue("checkTransformation MARC21_FORMAT->MARCXML_FORMAT_RECEIVED failed",
        transformationbean.checkTransformation(MARC21_FORMAT, MARCXML_FORMAT_RECEIVED));
