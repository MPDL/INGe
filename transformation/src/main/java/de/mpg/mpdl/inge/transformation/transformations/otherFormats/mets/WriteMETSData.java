...
public class WriteMETSData {
  ...
  public void createAmdSec(String id, String owner, String logo, String url, String reference) {
    ...
    dpCur.insertElementWithText("presentation", "http://dfg-viewer.de/",
        "http://vm38.mpdl.mpg.de:8080/dlib-journals/");
    dpCur.dispose();
   ...
   * @param ischild
   */
  public void addToStructMap(String mapType, String[] fileId, String order, String orderlabel,
      String divId, String structElem, boolean ischild) {
    // PHYSICAL structMap
  ...
  public MetsDocument getMetsDoc(String metsId) {
    ...
    /*
     * this.mets.setDmdSecArray(0, this.dmdSec); if (this.amdSec != null) {
     * this.mets.setAmdSecArray(0, this.amdSec); } if (this.fileSec != null) {
     * this.mets.setFileSec(this.fileSec); } this.metsDoc.setMets(this.mets);
     */
    return this.metsDoc;
  }
