...
package de.mpg.mpdl.inge.transformation.transformations.otherFormats.escidoc;
...
public class eSciDocVer1ToeSciDocVer2 extends DefaultHandler implements Transformation {
  ...
  private static final Format ESCIDOC_ITEM_V1_FORMAT = new Format("escidoc-publication-item-v1",
      "application/xml", "*");
  private static final Format ESCIDOC_ITEM_LIST_V2_FORMAT = new Format(
  ...
  public byte[] transform(byte[] src, Format srcFormat, Format trgFormat, String service)
    ...
    try {
      ...
      InputStream stylesheet =
          ResourceUtil.getResourceAsStream(XSLT_PATH,
              eSciDocVer1ToeSciDocVer2.class.getClassLoader());
