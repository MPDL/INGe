 ...
 * 
 */
public class TransformationService implements Transformation, Configurable {
  ...
  public TransformationService(boolean local) {
    if (initializer == null) {
      initializer = new TransformationInitializer();
  ...
  private byte[] escidocTransformService(byte[] src, Format srcFormat, Format trgFormat,
      String service) throws TransformationNotSupportedException, RuntimeException {
    ...
    if (transformationClass == null) {
      ...
      try {
        ...
        Class[] parameterTypes =
            new Class[] {byte[].class, Format.class, Format.class, String.class};
        ...
        // Execute the method
        result =
            (byte[]) method.invoke(transformationClass.newInstance(), src, srcFormat, trgFormat,
                service);
      } catch (Exception e) {
    ...
    if (transformationClass == null) {
      ...
      try {
        ...
        if (transformation instanceof Configurable) {
          ...
          // Set methods parameters
          Class[] parameterTypes =
              new Class[] {byte[].class, Format.class, Format.class, String.class, Map.class};
          ...
          // Execute the method
          result =
              (byte[]) method.invoke(transformation, src, srcFormat, trgFormat, service,
                  configuration);
        } else {
  ...
  public List<String> getConfigurationValues(Format srcFormat, Format trgFormat, String key)
    ...
    if (transformation instanceof Configurable) {
      ...
      // Execute the method
      return (List<String>) method.invoke(transformationClass.newInstance(), srcFormat, trgFormat,
          key);
    }
