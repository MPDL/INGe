...
public class Bibtex implements BibtexInterface {
    ...
    for (Object object : entries) {
      if (object instanceof BibtexEntry) {
        ...
        if (fields.get("number") != null && bibGenre != BibTexUtil.Genre.techreport) {
          sourceVO.setIssue(BibTexUtil.stripBraces(
              BibTexUtil.bibtexDecode(fields.get("number").toString()), false));
        } else if (fields.get("number") != null && bibGenre == BibTexUtil.Genre.techreport) {
          {
            mds.getIdentifiers().add(
                new IdentifierVO(IdentifierVO.IdType.REPORT_NR, BibTexUtil.stripBraces(
                    BibTexUtil.bibtexDecode(fields.get("number").toString()), false)));
          }
        }
        // pages
        if (fields.get("pages") != null) {
          if (bibGenre == BibTexUtil.Genre.book || bibGenre == BibTexUtil.Genre.proceedings) {
            mds.setTotalNumberOfPages(BibTexUtil.stripBraces(
                BibTexUtil.bibtexDecode(fields.get("pages").toString()), false));
          } else {
        ...
        if (fields.get("address") != null) {
          if (!(bibGenre == BibTexUtil.Genre.article || bibGenre == BibTexUtil.Genre.inbook
            ...
            sourceVO.getPublishingInfo().setPlace(
                BibTexUtil.stripBraces(BibTexUtil.bibtexDecode(fields.get("address").toString()),
                    false));
          }
        }
        // edition
        if (fields.get("edition") != null) {
          publishingInfoVO.setEdition(BibTexUtil.stripBraces(
              BibTexUtil.bibtexDecode(fields.get("edition").toString()), false));
        }
        // publisher
        if (!(bibGenre == BibTexUtil.Genre.article || bibGenre == BibTexUtil.Genre.inbook
            || bibGenre == BibTexUtil.Genre.inproceedings
          ...
          } else if (fields.get("school") != null
              && (bibGenre == BibTexUtil.Genre.mastersthesis
                  || bibGenre == BibTexUtil.Genre.phdthesis || bibGenre == BibTexUtil.Genre.techreport)) {
            publishingInfoVO.setPublisher(BibTexUtil.stripBraces(
                BibTexUtil.bibtexDecode(fields.get("school").toString()), false));
          } else if (fields.get("institution") != null) {
            publishingInfoVO.setPublisher(BibTexUtil.stripBraces(
                BibTexUtil.bibtexDecode(fields.get("institution").toString()), false));
          ...
          if (fields.get("publisher") != null) {
            sourceVO.getPublishingInfo().setPublisher(
                BibTexUtil.stripBraces(BibTexUtil.bibtexDecode(fields.get("publisher").toString()),
                    false));
          } else if (fields.get("school") != null
              && (bibGenre == BibTexUtil.Genre.mastersthesis
                  || bibGenre == BibTexUtil.Genre.phdthesis || bibGenre == BibTexUtil.Genre.techreport)) {
            sourceVO.getPublishingInfo().setPublisher(
                BibTexUtil.stripBraces(BibTexUtil.bibtexDecode(fields.get("school").toString()),
                    false));
          } else if (fields.get("institution") != null) {
            sourceVO.getPublishingInfo().setPublisher(
        ...
        if (fields.get("volume") != null) {
          if (bibGenre == BibTexUtil.Genre.article || bibGenre == BibTexUtil.Genre.book) {
            sourceVO.setVolume(BibTexUtil.stripBraces(
                BibTexUtil.bibtexDecode(fields.get("volume").toString()), false));
          } else if (bibGenre == BibTexUtil.Genre.inbook
              || bibGenre == BibTexUtil.Genre.inproceedings
              || bibGenre == BibTexUtil.Genre.incollection
              || bibGenre == BibTexUtil.Genre.conference) {
        ...
        if (bibGenre != null
            && (bibGenre.equals(BibTexUtil.Genre.inproceedings)
                ...
                || bibGenre.equals(BibTexUtil.Genre.poster) || bibGenre
                  .equals(BibTexUtil.Genre.talk))) {
        ...
        if (fields.get("year") != null) {
          dateString =
              BibTexUtil.stripBraces(BibTexUtil.bibtexDecode(fields.get("year").toString()), false);
        ...
        if (fields.get("affiliation") != null) {
          affiliation =
              BibTexUtil.stripBraces(BibTexUtil.bibtexDecode(fields.get("affiliation").toString()),
                  false);
        }
        // affiliationaddress
          ...
          if (fields.get("author") instanceof BibtexPersonList) {
            ...
            for (Object author : authors.getList()) {
              if (author instanceof BibtexPerson) {
                ...
                logger.warn("Entry in BibtexPersonList not a BibtexPerson: [" + author + "] in ["
                    + author + "]");
              }
            }
              ...
              if (decoder.getBestFormat() != null) {
                ...
                for (Author author : authors) {
                  ...
                  if (configuration != null
                      ...
                      && ("identifier and affiliation in brackets".equals(configuration
                          .get("CurlyBracketsForCoNEAuthors")))
                      && (author.getTags().get("identifier") != null)) {
                    String query = author.getTags().get("identifier");
                    int affiliationsCount =
                        Integer.parseInt(author.getTags().get("affiliationsCount"));
                    if (affiliationsCount > 0 || configuration.get("OrganizationalUnit") != null) {
                      for (int ouCount = 0; ouCount < (affiliationsCount > 0 ? affiliationsCount
                          : 1); ouCount++) // 1
                                           // is
                                           // for
                                           // the
                                           ...
                                           // null
                      {
                        String organizationalUnit =
                            (author.getTags().get("affiliation" + new Integer(ouCount).toString()) != null ? author
                                .getTags().get("affiliation" + new Integer(ouCount).toString())
                        ...
                        if (query.equals(author.getTags().get("identifier"))) {
                          coneEntries =
                              Util.queryConeExactWithIdentifier("persons", query,
                                  organizationalUnit);
                          ...
                          if (coneEntries.getFirstChild().getFirstChild() == null) {
                            logger.error("No Person with Identifier ("
                                ...
                                + organizationalUnit + ") found in CoNE for Publication \""
                                + fields.get("title") + "\"");
                          }
                        } else {
                        ...
                        if (coneNode != null) {
                          ...
                          while (currentNode != null) {
                            if (currentNode.getNodeType() == Node.ELEMENT_NODE && first) {
                              ...
                              String coneId =
                                  coneEntry.getAttributes().getNamedItem("rdf:about")
                                      .getNodeValue();
                   ...
                   */
                      ...
                      && "true".equals(configuration.get("CoNE"))
                      && ("affiliation id in brackets".equals(configuration
                          .get("CurlyBracketsForCoNEAuthors")))
                      && (author.getTags().get("identifier") != null)) {
                    ...
                    if (!("extern".equals(identifier))) {
                      ...
                      if (coneNode != null) {
                        ...
                        while (currentNode != null) {
                          if (currentNode.getNodeType() == Node.ELEMENT_NODE && first) {
                            ...
                            Node coneEntry = currentNode;
                            String coneId =
                                coneEntry.getAttributes().getNamedItem("rdf:about").getNodeValue();
                            personVO.setIdentifier(new IdentifierVO(IdType.CONE, coneId));
                            if (identifier != null && !("".equals(identifier))) {
                              try {
                                ...
                                Document document =
                                    Util.queryFramework("/oum/organizational-units?query="
                                        + URLEncoder.encode("\"/title\"=\"" + ouSubTitle + "\"",
                                            "UTF-8"));
                                NodeList ouList =
                                ...
                                throw new RuntimeException("Error getting Organizational Unit for "
                                    + identifier);
                              }
                            }
                          } else if (currentNode.getNodeType() == Node.ELEMENT_NODE) {
                      ...
                      && "true".equals(configuration.get("CoNE"))
                      && ("empty brackets".equals(configuration.get("CurlyBracketsForCoNEAuthors")) && (author
                          .getTags().get("brackets") != null))) {
                    String query = personVO.getFamilyName() + ", " + personVO.getGivenName();
                    Node coneEntries =
                        Util.queryConeExact(
                            "persons",
          ...
          if (fields.get("editor") instanceof BibtexPersonList) {
            ...
            for (Object editor : editors.getList()) {
              if (editor instanceof BibtexPerson) {
                ...
                logger.warn("Entry in BibtexPersonList not a BibtexPerson: [" + editor + "] in ["
                    + editors + "]");
              }
            }
              ...
              if (decoder.getBestFormat() != null) {
                ...
                for (Author editor : editors) {
                  ...
                  if (configuration != null
                    ...
                    int affiliationsCount =
                        Integer.parseInt(editor.getTags().get("affiliationsCount"));
                    if (affiliationsCount > 0 || configuration.get("OrganizationalUnit") != null) {
                      for (int ouCount = 0; ouCount < (affiliationsCount > 0 ? affiliationsCount
                          : 1); ouCount++) // 1
                                           // is
                      ...
                      {
                        String organizationalUnit =
                            (editor.getTags().get("affiliation" + new Integer(ouCount).toString()) != null ? editor
                                .getTags().get("affiliation" + new Integer(ouCount).toString())
                                : (configuration.get("OrganizationalUnit") != null ? configuration
                                    .get("OrganizationalUnit") : ""));
                        Node coneEntries = null;
                   ...
                   */
                    ...
                    if (!("extern".equals(identifier))) {
                      ...
                      && "true".equals(configuration.get("CoNE"))
                      && ("empty brackets".equals(configuration.get("CurlyBracketsForCoNEAuthors")) && (editor
                          .getTags().get("brackets") != null))) {
                    String query = personVO.getFamilyName() + ", " + personVO.getGivenName();
                    Node coneEntries =
                        Util.queryConeExact(
        ...
        if (fields.get("isbn") != null) {
          if (bibGenre == BibTexUtil.Genre.inproceedings || bibGenre == BibTexUtil.Genre.inbook
              ...
              || bibGenre == BibTexUtil.Genre.conference) {
            if (sourceVO != null) {
              sourceVO.getIdentifiers().add(
                  new IdentifierVO(IdentifierVO.IdType.ISBN, BibTexUtil.stripBraces(
                      BibTexUtil.bibtexDecode(fields.get("isbn").toString()), false)));
            }
          } else {
            mds.getIdentifiers().add(
                new IdentifierVO(IdentifierVO.IdType.ISBN, BibTexUtil.stripBraces(
          ...
          if (bibGenre == BibTexUtil.Genre.inproceedings || bibGenre == BibTexUtil.Genre.inbook
            ...
            if (sourceVO.getSources() != null && !sourceVO.getSources().isEmpty()) {
              sourceVO
                  ...
                  .getIdentifiers()
                  .add(
                      new IdentifierVO(IdentifierVO.IdType.ISSN, BibTexUtil.stripBraces(
        ...
        if (fields.get("url") != null) {
          ...
          locator.setContent(BibTexUtil.stripBraces(
              BibTexUtil.bibtexDecode(fields.get("url").toString()), false));
        ...
        // web_url as URI-Identifier
          ...
          mds.getIdentifiers().add(
              new IdentifierVO(IdentifierVO.IdType.URI, BibTexUtil.stripBraces(
        ...
        if (fields.get("doi") != null) {
          mds.getIdentifiers().add(
              new IdentifierVO(IdentifierVO.IdType.DOI, BibTexUtil.stripBraces(
                  BibTexUtil.bibtexDecode(fields.get("doi").toString()), false)));
        }
        // eid
        if (fields.get("eid") != null) {
          if (mds.getSources().size() == 1) {
            mds.getSources()
                .get(0)
                .setSequenceNumber(
                    BibTexUtil.stripBraces(BibTexUtil.bibtexDecode(fields.get("eid").toString()),
                        false));
          }
        }
        // rev
        if (fields.get("rev") != null) {
          if ("Peer".equals(BibTexUtil.stripBraces(
              BibTexUtil.bibtexDecode(fields.get("rev").toString()), false))) {
            mds.setReviewMethod(ReviewMethod.PEER);
          } else if ("No review".equals(BibTexUtil.stripBraces(
              BibTexUtil.bibtexDecode(fields.get("rev").toString()), false))) {
        ...
        if (fields.get("MPG-Affil") != null) {
          if ("Peer".equals(BibTexUtil.stripBraces(
              BibTexUtil.bibtexDecode(fields.get("MPG-Affil").toString()), false))) {
            // TODO
          }
        }
        // MPIS Groups
        if (fields.get("group") != null) {
          String[] groups =
              BibTexUtil
                  .stripBraces(BibTexUtil.bibtexDecode(fields.get("group").toString()), false)
                  .split(",");
        ...
        if (fields.get("project") != null) {
          String[] projects =
              BibTexUtil.stripBraces(BibTexUtil.bibtexDecode(fields.get("project").toString()),
                  false).split(",");
  ...
  private void addCreator(MdsPublicationVO publicationVO, BibtexPerson person,
      CreatorVO.CreatorRole role, String affiliation, String affiliationAddress)
    ...
    if (configuration != null && "true".equals(configuration.get("CoNE"))) {
      String query =
          personVO.getFamilyName()
              + " "
              + personVO.getGivenName()
              + " "
              + (configuration.get("OrganizationalUnit") != null ? configuration
                  .get("OrganizationalUnit") : "");
