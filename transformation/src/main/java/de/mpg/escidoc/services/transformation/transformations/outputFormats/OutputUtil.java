...
/**
 * 
 * This class contains helper methods for the transformation into output formats.
 * 
...
public class OutputUtil {
  ...
  /**
   * Returns path to the Citation Styles directory for jasper report TODO: This should be in common
   * utils, as I copied this from citation manager
   * 
   * @return path
   * @throws IOException
   */
  ...
  public static String getPathToClasses() throws IOException {
    ...
    String result =
        Util.class.getClassLoader().getResource(classString).getFile().replace(classString, "");
    return result.indexOf(".jar!") == -1 ?
