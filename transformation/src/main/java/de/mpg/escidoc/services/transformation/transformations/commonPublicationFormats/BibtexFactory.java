...
public class BibtexFactory {
  private static final String DEFAUL_BIBTEX_CLASS =
      "de.mpg.escidoc.services.transformation.transformations.commonPublicationFormats.Bibtex";
  ...
  public static BibtexInterface getBibtexImplementation(Map<String, String> configuration) {
    ...
    try {
      ...
      logger
          .warn("Property \"escidoc.transformation.bibtex.class\" not found, taking default BibTex class: "
              + DEFAUL_BIBTEX_CLASS);
