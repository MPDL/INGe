 ...
 */
public class PubCollectionRO extends ReferenceObject implements Cloneable
{
    /**
     ...
     */
    public PubCollectionRO(String objectId)
    {
        super(objectId);
    }
     ...
     */
    public PubCollectionRO(PubCollectionRO other)
    {
        super(other);
    }
    ...
    public Object clone()
    {
        return new PubCollectionRO(this);
    }
}