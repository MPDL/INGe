...
public class UserGroup extends IntelligentVO {
   ...
   * @throws Exception If an error occurs in coreservice or during marshalling/unmarshalling.
   */
  public void addNewSelectorsInCoreservice(Selectors selectors, String userHandle)
   ...
   * @throws Exception If an error occurs in coreservice or during marshalling/unmarshalling.
   */
  public void removeSelectorsInCoreservice(Selectors selectors, String userHandle)
      throws RuntimeException {
  ...
  public static class Factory {
    ...
    private static UserGroup update(UserGroup userGroup, String userHandle) throws RuntimeException {
      try {
        ...
        UserGroup updatedUserGroup =
            (UserGroup) IntelligentVO.unmarshal(updatedUserGroupXml, UserGroup.class);
      ...
      try {
        ...
        ugh.activate(
            ...
            "<param last-modification-date=\""
                + JiBXHelper.serializeDate(userGroup.getLastModificationDate()) + "\" >");
     ...
     * @throws Exception If an error occurs in coreservice or during marshalling/unmarshalling.
     */
    private static void addSelectors(Selectors selectors, UserGroup userGroup, String userHandle)
        throws RuntimeException {
      try {
        UserGroupHandler ugh = ServiceLocator.getUserGroupHandler(userHandle);
        String param =
        ...
        for (Selector selector : selectors.getSelectors()) {
          param +=
              "<selector name=\"" + selector.getName() + "\" type=\"" + selector.getType() + "\" >"
     ...
     * @throws Exception If an error occurs in coreservice or during marshalling/unmarshalling.
     */
    private static void removeSelectors(Selectors selectors, UserGroup userGroup, String userHandle)
        throws RuntimeException {
      try {
