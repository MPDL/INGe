...
public class FilmAcquisitionDeviceVO extends ValueObject {
  ...
  /**
   * Delivers the production comment of the film acquisition device. The production comment is a
  ...
  /**
   * Delivers the type of the film acquisition device, i. e. the type of the device which produced
   * the image.
   */
  ...
  /**
   * Sets the production comment of the film acquisition device. The production comment is a short
  ...
  /**
   * Sets the type of the film acquisition device, i. e. the type of the device which produced the
   * image.
   * 
   * @param newVal
   */
