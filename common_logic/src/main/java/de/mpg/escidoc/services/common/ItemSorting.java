...
import de.mpg.mpdl.inge.model.valueobjects.comparator.VersionHistoryEntryVOComparator;
...
public interface ItemSorting {
  ...
  /**
   * Method for sorting a list of pubItems according the given criterium and order. It sorts the
   * items by comparing them relatively their structure.
   * 
   ...
   */
  public java.util.List<PubItemVO> sortItemList(java.util.List<PubItemVO> itemList,
      PubItemVOComparator.Criteria criterium, String order);
   ...
   * @return The sorted list.
   */
  public java.util.List<VersionHistoryEntryVO> sortItemVersionList(
      java.util.List<VersionHistoryEntryVO> itemVersionList,
      VersionHistoryEntryVOComparator.Criteria criterium,
      VersionHistoryEntryVOComparator.Order order);
}
