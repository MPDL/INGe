...
public class TransformPubItemTest extends XmlTransformingTestBase
{
    ...
    private static final String MPDL_METADATA_SCHEMA_FILE = "misc/xsd/metadata/0.1/escidocprofile.xsd";
    private static String TEST_FILE_ROOT = "test/xmltransforming/component/transformPubItemTest/";
