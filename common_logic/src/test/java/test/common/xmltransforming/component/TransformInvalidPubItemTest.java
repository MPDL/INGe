...
public class TransformInvalidPubItemTest extends XmlTransformingTestBase
{
    ...
    {
        logger = Logger.getLogger(TransformInvalidPubItemTest.class);
    ...
    private PubItemVO getMinimalPubItemVO()
    {
        ...
        // set collection
        PubCollectionRO pubCollectionRO = new PubCollectionRO();
        pubCollectionRO.setObjectId("escidoc:persistent3");
        pubItemVO.setPubCollection(pubCollectionRO);
    ...
    {
        PubCollectionRO pubCollection = new PubCollectionRO();
