...
public class Grant extends IntelligentVO {
  ...
  public static class Factory {
     ...
     * @throws Exception If an error occurs in coreservice or during marshalling/unmarshalling.
     */
    private static Grant retrieveGrant(String userHandle, String userId, String grantId, UserType ut)
        throws RuntimeException {
      String grantXml = "";
     ...
     * @throws Exception If an error occurs in coreservice or during marshalling/unmarshalling.
     */
    private static void revokeGrant(String userHandle, Grant grant, String comment)
        throws RuntimeException {
      try {
        ...
        if (grant.getLastModificationDate() == null) {
          ...
          // grant = new Grant(userHandle, grant.getGrantedTo(), grant.getObjid(),
          // UserType.valueOf(grant.getGrantType()));
        }

        String param =
            "<param last-modification-date=\""
                + JiBXHelper.serializeDate(grant.getLastModificationDate()) + "\" >";
