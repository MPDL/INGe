...
/**
 * This class is used by the XML transforming classes to wrap a String containing a URL String.
 * The reason for this is that JiBX cannot be bound directly to an java.net.URL.
 *
