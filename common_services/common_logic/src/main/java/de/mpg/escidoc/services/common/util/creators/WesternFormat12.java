...
/**
 * Parser for semicolon seperated author strings (surname first, comma, given name(s)), mixed initials and semicolons
 *
...
public class WesternFormat12 extends AuthorFormat {
    ...
    public String getPattern() {
        return "^\\s*" + NAME + ", ?" + GIVEN_NAME_FORMAT_MIXED + "( *(;| and | und | et ) *" + NAME + ", ?" + GIVEN_NAME_FORMAT_MIXED + ")*\\s*$";
    }
    ...
    public String getDescription() {
        return "Nachname, Vorname(n) I.[; Nach-name, I. Vor-Name; Nachname, Vorname I.; Nachname, I.]";
    }
