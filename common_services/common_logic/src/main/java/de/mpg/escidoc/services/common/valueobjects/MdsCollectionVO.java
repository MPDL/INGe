...
import de.mpg.escidoc.services.common.valueobjects.metadata.PartnerVO;

/**
 * The set Collection describes resources which are Scholarly Workbench Collections which contain
 * bjects and bundles.
 * 
...
public class MdsCollectionVO extends MetadataSetVO {
   ...
   */
  private java.util.List<PartnerVO> partners = new java.util.ArrayList<PartnerVO>();

  /**
   * Delivers the list of partners of this collection.
   */
  public java.util.List<PartnerVO> getPartners() {
    return partners;
  }
}
