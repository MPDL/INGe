...
public class XpathPrefixResolver implements PrefixResolver
{
    ...
    public XpathPrefixResolver()
    {
        ...
        nsMap.put("escidocAccountUser", "http://www.escidoc.de/schemas/useraccount/0.3");
        nsMap.put("escidocAdminDescriptor", "http://www.escidoc.de/schemas/admindescriptor/0.2");
        nsMap.put("escidocContext", "http://www.escidoc.de/schemas/context/0.3");
        ...
        nsMap.put("escidocOrganizationalUnit", "http://www.escidoc.de/schemas/organizationalunit/0.3");
        nsMap.put("escidocRelations", "http://www.escidoc.de/schemas/relations/0.2");
        nsMap.put("escidocResources", "http://www.escidoc.de/schemas/resources/0.2");
        nsMap.put("escidocSearchResult", "http://www.escidoc.de/schemas/searchresult/0.3");
