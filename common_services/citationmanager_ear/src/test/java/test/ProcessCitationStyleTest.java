...
/**
 * Test class for citation manager processing component Can be started from eclipse and ant ask. Can
 * be started from the command line as ant task: <code>ant test-apa</code>. The system property
 * <code>citation.style</code> is used to define citation style to test. See
 * <code>resource/CitationStyles/APA/test.properties</code> for definition of the tests. The
 * following fields are obligatory to define the correct test: <li><code>data.source</code> <li>
 * <code>test.[i].data.source.item.id</code> <li><code>test.[i].result</code>
 * 
