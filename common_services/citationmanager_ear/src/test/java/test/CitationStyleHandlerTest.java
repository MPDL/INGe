...
public class CitationStyleHandlerTest {
  ...
  private static final String dsName =
      "target/target/test-classes/DataSources/CitationStyleTestCollection.xml";
  ...
  public static final void getCitationStyleManager() throws Exception {
    ...
    pcs =
        (CitationStyleHandler) ctx
            .lookup("ejb:citationmanager_ear/citationmanager/CitationStyleHandlerBean!"
                + CitationStyleHandler.class.getName());
  }
