...
/**
 * 
 * Process managing the {@link Queue} - Check whether queue has enqueued PID (i.e waiting for an
 * update at GWDG service) - Update enqueued item at the GWDG service.
 * 
 * @author saquet
 * 
 */
public class QueueProcess {
   ...
   * update the PID with the new URL - The PID doesn't exist: Some Reporting...
   * 
   * @throws Exception
   */
