...
public class BibTeXMixedSurnameAndGivennameFormat extends AuthorFormat {
  ...
  public List<Author> getAuthors(String authorsString) throws Exception {
    ...
    List<Author> authorListSurnnameFirst =
        getAuthorListLeadingSurname(surnameFirst.toArray(new String[surnameFirst.size()]), ",");
    List<Author> authorListGivennameFirst =
        getAuthorListNormalFormat(givennameFirst.toArray(new String[givennameFirst.size()]));
