...
public class DoiMetadataTransformation implements Transformation{
	...
	private static final String STYLESHEET_PROPERTY_NAME = "escidoc.transformation.doi.stylesheet.filename";
	public static final Format ESCIDOC_ITEM_FORMAT = new Format("escidoc", "application/xml", "UTF-8");
	...
	public byte[] transform(byte[] src, Format srcFormat, Format trgFormat,
		...
		try
        {
            ...
            InputStream stylesheet = ResourceUtil.getResourceAsStream(xslPath, DoiMetadataTransformation.class.getClassLoader());
