...
public class TEITransformation implements Transformation{
	
	private Logger logger = Logger.getLogger(getClass());
	
	private static final Format TEI_FORMAT = new Format("TEI", "application/xml", "UTF-8");
    ...
    public Format[] getTargetFormats(Format sourceFormat) throws RuntimeException{
    	if (TEI_FORMAT.equals(sourceFormat))
        {
    ...
    {	
        ...
        {	
            ...
            if(srcFormat.matches(TEI_FORMAT))
            {
            	
            	String teiSource = new String(src,"UTF-8");
//            	FileOutputStream fos = new FileOutputStream("inter.xml");
//            	fos.write(teiSource.getBytes());
//            	fos.close();            	
            	//logger.info(output);
            ...
            {
                throw new TransformationNotSupportedException("Sorry, this is the TEI transformation");
            }
