...
public class TEITransformation {
    ...
    {	
        ...
        {	
            ...
            {
                stylesheet = ResourceUtil.getResourceAsStream("transformations/otherFormats/xslt/peer_tei2escidoc-publication-item.xsl");
            ...
            {
                stylesheet = ResourceUtil.getResourceAsStream("transformations/otherFormats/xslt/peer_tei2escidoc-publication-component.xsl");
                transformer = factory.newTransformer(new StreamSource(stylesheet));
            	transformer.setParameter("is-item-list", Boolean.FALSE);
            }
            else
