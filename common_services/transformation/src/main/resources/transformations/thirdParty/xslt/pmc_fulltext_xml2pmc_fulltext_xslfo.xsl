...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xpath-default-namespace="http://dtd.nlm.nih.gov/2.0/xsd/archivearticle"
...
<xsl:template match="/">
  <fo:root>
    ...
    <xsl:apply-templates select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article" />
  </fo:root>
</xsl:template>
...
<xsl:template name="set-article-cover-page">
  ...
  <xsl:for-each select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/title-group">
  ...
  <fo:block font-family="{$textfont}" font-size="{$textsize}"
    ...
    <xsl:apply-templates mode="cover-page"
      select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/title-group/trans-title-group
            | /oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/title-group/alt-title"/>


    <xsl:apply-templates mode="metadata"
      select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/article-categories
            | /oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/kwd-group
            | /oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/supplementary-material
            | /oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/counts
            | /oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/custom-meta-group"/>

    <xsl:apply-templates select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/notes/*"/>
...
<xsl:template name="make-journal-metadata-table">
  ...
  <xsl:for-each select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/journal-meta">
    <!-- start the table -->
    <fo:table border-style="solid" border-width="1pt" width="2.75in">
      <fo:table-body>
        <xsl:call-template name="make-metadata-cell">
          <xsl:with-param name="contents">
            <fo:block xsl:use-attribute-sets="coverpage-heading">
...
<xsl:template name="make-article-metadata-table">
  <!-- Builds a table listing article-level metadata
       Don't be confused: this entire table fits into a table
       cell on the cover page -->
  <xsl:for-each select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta">
...
<xsl:template name="set-article">
  ...
  <xsl:apply-templates select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/body"/>
  
  <xsl:apply-templates select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/back"/>

  <xsl:apply-templates select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/floats-group"/>
...
<xsl:template name="page-header-title">
  <xsl:for-each select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/title-group/alt-title
                        [@alt-title-type='running-head']">
    <xsl:apply-templates mode="page-header-text"/>
  </xsl:for-each>
  <xsl:if test="not(/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/title-group/alt-title
                        [@alt-title-type='running-head'])">
    <xsl:for-each
      select="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/title-group/article-title">
    <xsl:apply-templates mode="page-header-text"/>
  </xsl:for-each>
  </xsl:if>
</xsl:template>
...
<xsl:template mode="cover-page"
  match="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/title-group/article-title">
...
<xsl:template mode="cover-page"
  match="/oai:OAI-PMH/oai:GetRecord/oai:record/oai:metadata/article/front/article-meta/title-group/subtitle">
...
<xsl:template name="notes">
  <xsl:call-template name="subsection-title">
    <xsl:with-param name="contents">
      <fo:block xsl:use-attribute-sets="generated">Notes</fo:block>
    </xsl:with-param>
  </xsl:call-template>
  <xsl:apply-templates/>
</xsl:template>
...
<xsl:template match="inline-graphic">
  ...
  <xsl:variable name="article-id">
    <xsl:value-of select="//article-id[@pub-id-type='pmc']"/>
  </xsl:variable>
  <fo:external-graphic src="url('{concat(concat(concat(concat('http://www.ncbi.nlm.nih.gov/pmc/articles/', $article-id), '/bin/'), $href), '.jpg')}')" content-width="auto"
      ...
      <fo:block-container xsl:use-attribute-sets="media-object">
        ...
        <fo:block start-indent="0pc">
          <fo:block line-stacking-strategy="max-height">
            <fo:external-graphic src="url('{concat(concat(concat(concat('http://www.ncbi.nlm.nih.gov/pmc/articles/', $article-id), '/bin/'), $href), '.jpg')}')"
