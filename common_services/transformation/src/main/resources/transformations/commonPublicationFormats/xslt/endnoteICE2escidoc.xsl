	...
	<xsl:template name="createPerson">
		...
		<xsl:choose>
			<xsl:when test="$source-name = 'endnote-ice'">
				...
				<xsl:variable name="multiplePersonsFound" as="xs:boolean" select="exists($cone-creator/cone/rdf:RDF/rdf:Description[@rdf:about != preceding-sibling::attribute/@rdf:about])"/>
