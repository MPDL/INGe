...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<?xml-stylesheet type="text/xsl" href="/cone/files/xsl/explain.xsl"?>

	<xsl:template match="/">
		<xsl:processing-instruction name="xml-stylesheet">
			type="text/xsl" href="/cone/files/xsl/explain.xsl"
					...
					<service>
						...
						<methods>
							<method>
								...
								<return>
									<type>text/html</type>
									<value>A HTML page containing the results matching the given query linked to the detailed view.</value>
								</return>
							</method>
							<method>
								<name>details</name>
								...
								<return>
									...
									<value>A HTML page containing the details of the requested resource</value>
								</return>
							</method>
						</methods>
						<samples>
							...
							<xsl:for-each select="samples/sample">
								<sample description="{description}">../html/<xsl:value-of select="$name"/>/<xsl:value-of select="method/name"/>?<xsl:for-each select="method/parameters/parameter">
