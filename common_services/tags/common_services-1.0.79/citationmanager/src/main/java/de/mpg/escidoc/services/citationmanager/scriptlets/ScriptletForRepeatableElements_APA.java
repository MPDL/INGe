...
chunk_default_2 = xmlEncode((String)subDs.getFieldValue(field_default_2));chunk_default_2 = chunk_default_2!=null && chunk_default_2.length()>0 ? chunk_default_2 : "";chunk_default_2 = get_initials(chunk_default_2);
...
chunk_last_2 = xmlEncode((String)subDs.getFieldValue(field_last_2));chunk_last_2 = chunk_last_2!=null && chunk_last_2.length()>0 ? chunk_last_2 : "";chunk_last_2 = get_initials(chunk_last_2);
...
default:
chunk_default_0 = xmlEncode((String)subDs.getFieldValue(field_default_0));chunk_default_0 = chunk_default_0!=null && chunk_default_0.length()>0 ? chunk_default_0 : "";
chunk_default_1 = xmlEncode((String)subDs.getFieldValue(field_default_1));chunk_default_1 = chunk_default_1!=null && chunk_default_1.length()>0 ? chunk_default_1 : "";chunk_default_1 = get_initials(chunk_default_1);
