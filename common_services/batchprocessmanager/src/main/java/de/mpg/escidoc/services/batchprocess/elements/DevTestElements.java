 ...
 *
 */
public class DevTestElements extends Elements<ItemVO>
{
    ...
    private static final String LOCAL_TAG = "Import PDFs 2011-02-16 16:39";

    public DevTestElements(String[] args)
    {
        super(args);
    }
