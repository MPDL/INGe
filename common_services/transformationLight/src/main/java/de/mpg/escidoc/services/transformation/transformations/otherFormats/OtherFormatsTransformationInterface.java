...
public class OtherFormatsTransformationInterface implements Transformation
{
    ...
    */
        ...
        throws TransformationNotSupportedException
    {
        ...
        {
            result = this.escidocTransform(src, srcFormat, trgFormat, service, configuration);
            supported = true;
        }
	...
	private byte[] escidocTransform(byte[] src, Format srcFormat, Format trgFormat, String service, Map<String, String> configuration)
        throws TransformationNotSupportedException
    {
        byte[] result = null;
        boolean supported = false;
        ...
        {   
            try
            {
                String transformedXml = this.transformer.xsltTransform(srcFormatName, trgFormatName, new String(src, "UTF-8"), configuration);
