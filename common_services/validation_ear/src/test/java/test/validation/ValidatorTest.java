...
public class ValidatorTest {
  ...
  public final void getTransformer() throws Exception {
    InitialContext ctx = new InitialContext();
    xmlTransforming =
        (XmlTransforming) ctx.lookup("ejb:validation_ear/common_logic/XmlTransformingBean!"
  ...
  public final void getValidItemXml() throws Exception {
    validXml =
        ResourceUtil.getResourceAsString("validation/validItem.xml",
  ...
  public final void getInvalidItemXml() throws Exception {
    invalidXml =
        ResourceUtil.getResourceAsString("validation/invalidItem.xml",
            ValidatorTest.class.getClassLoader());
  ...
  public final void testInvalidItemXmlValidation() throws Exception {
    ...
    assertNotNull("Report is null", reportXml);
    assertTrue("Report xml does not contain failure messages, although it should.",
        reportXml.contains("failure"));
  }
