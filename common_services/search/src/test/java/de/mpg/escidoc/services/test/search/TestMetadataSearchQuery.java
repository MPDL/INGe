...
public class TestMetadataSearchQuery {
  ...
  public void testBuildSimpleMetadataQuery() throws Exception {
    ...
    contentTypes.add(PropertyReader
    ...
    String expected =
        "( ( escidoc.publication.title=\"test\" ) ) and  ( escidoc.content-model.objid=\""
  ...
  public void testBuildMetadataQueryWithLogicalOperators() throws Exception {
    ...
    MetadataSearchQuery msq = new MetadataSearchQuery(contentTypes);
    msq.addCriterion(new MetadataSearchCriterion(CriterionType.TITLE, "test"));
    msq.addCriterion(new MetadataSearchCriterion(CriterionType.CREATED_BY_OBJECTID, "user1234",
        LogicalOperator.AND));
    msq.addCriterion(new MetadataSearchCriterion(CriterionType.LANGUAGE, "de", LogicalOperator.OR));
    msq.addCriterion(new MetadataSearchCriterion(CriterionType.GENRE, "journal",
        LogicalOperator.NOT));
    String query = msq.getCqlQuery();
    String expected =
        "( ( escidoc.publication.title=\"test\" )  and  ( escidoc.component.created-by.objid=\"user1234\" )  or  ( escidoc.publication.language=\"de\" )  not  ( escidoc.publication.type=\"journal\" ) ) and  ( escidoc.content-model.objid=\""
            + PropertyReader.getProperty("escidoc.framework_access.content-model.id.publication")
            + "\" ) ";
    assertNotNull(query);
    assertEquals(expected, query);
  ...
  public void testBuildMetadataDateQuery() throws Exception {
    logger
        .info("Testing simple metadata search query transformation with dates and boolean operators");
    ...
    logger.debug(query);
    String expected =
        "( (  ( escidoc.publication.dateAccepted>=\"2008\\-05\\-15\" and ( escidoc.publication.dateAccepted<=\"2008\\-10\\-08\" not ( escidoc.publication.dateAccepted=\"2008\" )  not ( escidoc.publication.dateAccepted=\"2008\\-10\" )  ) )  ) ) and  ( escidoc.content-model.objid=\""
            + PropertyReader.getProperty("escidoc.framework_access.content-model.id.publication")
            + "\" ) ";
    assertNotNull(query);
    assertEquals(expected, query);
  ...
  public void testBuildMetadataComponentQuery() throws Exception {
    ...
    msq.addCriterion(new MetadataSearchCriterion(
        CriterionType.COMPONENT_COMPOUND_PROPERTIES,
        "\"internal-managed  http://purl.org/escidoc/metadata/ves/content-categories/publisher-version\"",
        LogicalOperator.AND));

    String query = msq.getCqlQuery();
    logger.debug(query);
    String expected =
        "( ( (escidoc.component.visibility=\"argument\" or escidoc.component.creation-date=\"argument\" or escidoc.component.content-category=\"argument\") )  and  ( escidoc.component.compound.properties=\"internal\\-managed  http://purl.org/escidoc/metadata/ves/content\\-categories/publisher\\-version\" ) ) and  ( escidoc.content-model.objid=\""
            + PropertyReader.getProperty("escidoc.framework_access.content-model.id.publication")
            + "\" ) ";
    assertNotNull(query);
    assertEquals(expected, query);
  ...
  public void testBuildMetadataQueryWithEmptySearchString() throws Exception {
    ...
    logger.debug(query);
    String expected =
        "( ( escidoc.component.creation-date>\"''\" ) ) and  ( escidoc.content-model.objid=\""
            + PropertyReader.getProperty("escidoc.framework_access.content-model.id.publication")
            + "\" ) ";
    assertNotNull(query);
    assertEquals(expected, query);
  ...
  public void testMetadataQueryWithSubCriteria() throws Exception {
    ...
    MetadataSearchCriterion crit =
        new MetadataSearchCriterion(CriterionType.COMPONENT_VISIBILITY, "test2", LogicalOperator.OR);

    MetadataSearchCriterion crit2 =
        new MetadataSearchCriterion(CriterionType.ANY, "subtest1", LogicalOperator.AND);
    MetadataSearchCriterion crit3 =
        new MetadataSearchCriterion(CriterionType.ANY, "subtest2", LogicalOperator.OR);

    MetadataSearchCriterion crit4 =
        new MetadataSearchCriterion(CriterionType.ANY, "subsubtest1", LogicalOperator.AND);
    MetadataSearchCriterion crit5 =
        new MetadataSearchCriterion(CriterionType.ANY, "subsubtest2", LogicalOperator.OR);
    ...
    logger.debug(query);
    String expected =
        "( ( escidoc.component.creation-date=\"test1\" )  or  ( escidoc.component.visibility=\"test2\" ) and (  ( escidoc.metadata=\"subtest1\" ) and (  ( escidoc.metadata=\"subsubtest1\" )  or  ( escidoc.metadata=\"subsubtest2\" )  )  or  ( escidoc.metadata=\"subtest2\" )  ) ) and  ( escidoc.content-model.objid=\""
            + PropertyReader.getProperty("escidoc.framework_access.content-model.id.publication")
            + "\" ) ";
    assertNotNull(query);
    assertEquals(expected, query);
  ...
  public void testMetadataQueryWithSubCriteriaRightTree() throws Exception {
    ...
    logger.debug(query);
    String expected =
        "( ( escidoc.component.creation-date=\"test1\" )  or  ( escidoc.component.visibility=\"test2\" ) and (  ( escidoc.metadata=\"subtest1\" ) and (  ( escidoc.metadata=\"subsubtest1\" )  )  ) ) and  ( escidoc.content-model.objid=\""
            + PropertyReader.getProperty("escidoc.framework_access.content-model.id.publication")
            + "\" ) ";
    assertNotNull(query);
    assertEquals(expected, query);
  ...
  public void testCopyrightIndex() throws Exception {
    ...
    logger.debug(query);
    String expected =
        "( ( escidoc.component.file.dateCopyrighted=\"testing\" ) ) and  ( escidoc.content-model.objid=\""
            + PropertyReader.getProperty("escidoc.framework_access.content-model.id.publication")
            + "\" ) ";
    assertNotNull(query);
    assertEquals(expected, query);
