...
/**
 * This class offers all methods necessary for the oai provision and the transformations... (TODO)
 * @author kleinfe1
 *
 */
public class FetcheSciDoc
{
	private static final Logger LOGGER = Logger.getLogger(FetcheSciDoc.class);
