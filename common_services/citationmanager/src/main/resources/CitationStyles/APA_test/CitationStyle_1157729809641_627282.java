/*
 * Generated by JasperReports - 08.09.06 17:36
 */
 ...
 *
 */
public class CitationStyle_1157729809641_627282 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = (java.lang.String)(((((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue())).getCS_1_CSLD_1_P_default_E_1())).length() > 0 ? ((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue())).getCS_1_CSLD_1_P_default_E_1()) : ""));
                break;
            }
            case 9 : 
            {
                value = (java.lang.String)(((java.lang.String)field_title.getValue())!=null ? "<style fontName=\"Arial\" fontSize=\"12\" isBold=\"false\" isItalic=\"true\" isUnderline=\"false\" isStrikeThrough=\"false\" pdfFontName=\"Helvetica-Oblique\" forecolor=\"blue\" backcolor=\"yellow\" pdfEncoding=\"Cp1250\" isPdfEmbedded=\"false\">" + (((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue()).xmlEncode(((java.lang.String)field_title.getValue())))).length() > 0 ? (((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue()).xmlEncode(((java.lang.String)field_title.getValue()))) + "." : "") + "</style>" : "");
                break;
            }
            case 10 : 
            {
                value = (java.lang.String)(((((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue())).getCS_1_CSLD_1_P_default_E_3())).length() > 0 ? ((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue())).getCS_1_CSLD_1_P_default_E_3()) : ""));
                break;
            }
            case 11 : 
            {
                value = (java.lang.String)(((java.lang.String)field_genre.getValue())!=null ? "<style fontName=\"Arial\" fontSize=\"12\" isBold=\"true\" isItalic=\"false\" isUnderline=\"false\" isStrikeThrough=\"false\" pdfFontName=\"Helvetica-Bold\" forecolor=\"black\" backcolor=\"white\" pdfEncoding=\"Cp1250\" isPdfEmbedded=\"false\">" + (((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue()).xmlEncode(((java.lang.String)field_genre.getValue())))).length() > 0 ? "&amp;lt;HERE!!!&amp;gt;" + (((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue()).xmlEncode(((java.lang.String)field_genre.getValue()))) : "") + "</style>" : "");
                break;
            }
            case 12 : 
            {
                value = (java.lang.String)(((((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue())).getCS_1_CSLD_2_P_default_E_2())).length() > 0 ? ((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue())).getCS_1_CSLD_2_P_default_E_2()) : ""));
                break;
            }
            case 13 : 
            {
            ...
            case 14 : 
            {
                value = (java.lang.String)(((((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue())).getCS_1_CSLD_2_P_default_E_4())).length() > 0 ? ((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue())).getCS_1_CSLD_2_P_default_E_4()) : ""));
                break;
            }
            case 15 : 
            {
            ...
            case 17 : 
            {
                value = (java.lang.String)((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue()).cleanCit(((java.lang.String)variable_CS_1_CSLD_1.getValue()) + ((java.lang.String)variable_CS_1_CSLD_2.getValue()))));
                break;
            }
            case 18 : 
            {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 11 : 
            {
                value = (java.lang.String)(((java.lang.String)field_genre.getOldValue())!=null ? "<style fontName=\"Arial\" fontSize=\"12\" isBold=\"true\" isItalic=\"false\" isUnderline=\"false\" isStrikeThrough=\"false\" pdfFontName=\"Helvetica-Bold\" forecolor=\"black\" backcolor=\"white\" pdfEncoding=\"Cp1250\" isPdfEmbedded=\"false\">" + (((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue()).xmlEncode(((java.lang.String)field_genre.getOldValue())))).length() > 0 ? "&amp;lt;HERE!!!&amp;gt;" + (((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue()).xmlEncode(((java.lang.String)field_genre.getOldValue()))) : "") + "</style>" : "");
                break;
            }
            case 12 : 
            {
            ...
            case 17 : 
            {
                value = (java.lang.String)((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue()).cleanCit(((java.lang.String)variable_CS_1_CSLD_1.getOldValue()) + ((java.lang.String)variable_CS_1_CSLD_2.getOldValue()))));
                break;
            }
            case 18 : 
            {
    ...
    public Object evaluateEstimated(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 17 : 
            {
                value = (java.lang.String)((((ScriptletForRepeatableElements_1157729746875)parameter_REPORT_SCRIPTLET.getValue()).cleanCit(((java.lang.String)variable_CS_1_CSLD_1.getEstimatedValue()) + ((java.lang.String)variable_CS_1_CSLD_2.getEstimatedValue()))));
                break;
            }
            case 18 : 
            {
