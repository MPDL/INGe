...
public class ScriptletForRepeatableElements_1190130763993 extends JRDefaultScriptlet {
...
JRXmlDataSource subDs = ds.subDataSource("publication/creator/person");
...
int es = elems.size();
boolean n = !subDs.next();
if (hasLast && count>2 && ( n || maxCount)) {
...
String delim = "";
JRXmlDataSource ds = ((JRXmlDataSource) this.getParameterValue("REPORT_DATA_SOURCE"));
JRXmlDataSource subDs = ds.subDataSource("publication/creator/organization");
JRDesignField field_default_0 = new JRDesignField();
...
String delim = "";
JRXmlDataSource ds = ((JRXmlDataSource) this.getParameterValue("REPORT_DATA_SOURCE"));
JRXmlDataSource subDs = ds.subDataSource("publication/source/creator/person");
JRDesignField field_default_0 = new JRDesignField();
field_default_0.setDescription("complete-name");
field_default_0.setValueClass(String.class);
String chunk_default_0 = "";
...
public String getCS_1_CSLD_1_P_default_E_10() throws Exception {
String result = "";
String str = "";
String last = "";
String delim = "";
...
if (!hasLast) hasLast = true;
if (hasLast) {
chunk_last_0 = (String)subDs.getFieldValue(field_last_0);chunk_last_0 = xmlEncode(chunk_last_0);chunk_last_0 = chunk_last_0!=null && chunk_last_0.length()>0 ? chunk_last_0 : "";chunk_last_0 = chunk_last_0.length()>0 ? (chunk_last_0) : ""; chunk_last_0 = (chunk_last_0);chunk_last_0 = "<style fontName=\"Arial\" fontSize=\"12\" isBold=\"true\" isItalic=\"false\" isUnderline=\"false\" isStrikeThrough=\"false\" pdfFontName=\"Helvetica-Bold\" forecolor=\"black\" backcolor=\"white\" pdfEncoding=\"Cp1250\" isPdfEmbedded=\"false\">" + chunk_last_0 + "</style>";
chunk_last_1 = (String)subDs.getFieldValue(field_last_1);chunk_last_1 = xmlEncode(chunk_last_1);chunk_last_1 = chunk_last_1!=null && chunk_last_1.length()>0 ? chunk_last_1 : "";chunk_last_1 = get_initials(chunk_last_1);chunk_last_1 = chunk_last_1.length()>0 ? (chunk_last_1) : ""; chunk_last_1 = get_initials(chunk_last_1);chunk_last_1 = "<style fontName=\"Arial\" fontSize=\"12\" isBold=\"true\" isItalic=\"false\" isUnderline=\"false\" isStrikeThrough=\"false\" pdfFontName=\"Helvetica-Bold\" forecolor=\"black\" backcolor=\"white\" pdfEncoding=\"Cp1250\" isPdfEmbedded=\"false\">" + chunk_last_1 + "</style>";
last = chunk_last_0 + insertDelimiter(chunk_last_0, ", ", chunk_last_1) + chunk_last_1;delim = "; &amp; ";}
