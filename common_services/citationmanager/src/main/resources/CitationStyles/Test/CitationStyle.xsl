...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="l_journal">
                        ...
                        <!--### Test specific Default Variables ###-->
	...
	<!--### @ref is available ###--><xsl:variable name="var" select="pub:publication/dc:title/text()"/>
                                                        <!--valid-if--><xsl:variable name="var">
                                                            <xsl:if test="$citationStyleForJournal='default'"><!--
				start-with/ends-with
			--><xsl:variable name="var">
                                                                    <xsl:copy-of select="$var"/>
                                                                    <xsl:if test="exists($var) and $var!=''">
	...
	<!--### @ref is available ###--><xsl:variable name="var" select="pub:publication/dc:title/text()"/>
                                                        <!--valid-if--><xsl:variable name="var">
                                                            <xsl:if test="$citationStyleForJournal='Kurztitel_ZS_Band_Jahr'"><!--
				start-with/ends-with
			--><xsl:variable name="var">
                                                                    <xsl:if test="exists($var) and $var!=''">
                                                                        <xsl:text>[Journal-spec-title: </xsl:text>
                                                                    </xsl:if>
                                                                    <xsl:copy-of select="$var"/>
                                                                    <xsl:if test="exists($var) and $var!=''">
                                                                        <xsl:text>].</xsl:text>
