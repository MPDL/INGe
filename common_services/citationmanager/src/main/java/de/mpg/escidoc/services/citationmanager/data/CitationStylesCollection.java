...
public class CitationStylesCollection implements Cloneable  {
    ...
    // add root level
        ...
        digester.addObjectCreate(cs, CitationStyle.class.getName());
        ...
        digester.addSetProperties(cs, "md-xpath", "mdXPath");
            ...
            digester.addObjectCreate(le, LayoutElement.class.getName());
            ...
            digester.addObjectCreate(csld, LayoutElement.class.getName());
...
//    		digester.addObjectCreate(csc, "de.mpg.escidoc.services.citationmanager.data.CitationStylesCollection");
//    		digester.addSetProperties(csc);
    		
    		// add citation-style
    		String cs = "citation-style";
    		digester.addObjectCreate(cs, "de.mpg.escidoc.services.citationmanager.data.CitationStyle");
//    		digester.addSetProperties(cs);
    		digester.addSetProperties(cs, "element-specific", "elementSpecific");
    		digester.addSetProperties(cs, "read-only", "readOnly");
    		digester.addSetProperties(cs, "md-xpath", "mdXPath");
	        ...
	        //add predefined layout elements
	        String le = cs + "/layout-elements/layout-element";
            digester.addObjectCreate(le, "de.mpg.escidoc.services.citationmanager.data.LayoutElement");
    		digester.addSetProperties(le);
            digester = LayoutElement.getDigesterRules(digester, le);
    		...
    		// add cs-layout-definition
    		String csld = cs + "/cs-layout-definition";
    		digester.addObjectCreate(csld, "de.mpg.escidoc.services.citationmanager.data.LayoutElement");
    		digester.addSetProperties(csld);
