...
public class LayoutElementsCollection implements Cloneable {
    ...
    public static LayoutElementsCollection loadFromXml( String xmlFileName )  throws IOException, SAXException {
        ...
        // add root level
        digester.addObjectCreate("layoutElementsCollection", "de.mpg.escidoc.services.citationmanager.LayoutElementsCollection");
        digester.addSetProperties("layoutElementsCollection");
        
        String path = "layoutElementsCollection/layout-element";
        
        digester.addObjectCreate(path, "de.mpg.escidoc.services.citationmanager.LayoutElement");
        ...
        //        // add layoutElement
//        digester.addObjectCreate("layoutElementsCollection/layoutElement", "de.mpg.escidoc.services.citationmanager.LayoutElement");
...
//        digester.addObjectCreate(elems, "de.mpg.escidoc.services.citationmanager.LayoutElement");
