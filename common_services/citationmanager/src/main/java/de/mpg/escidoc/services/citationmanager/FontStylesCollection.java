 ...
 * $Rev: 137 $
 * $Author: vdm $  
 * $Date: 2006-09-07 16:24:45 +0200 (Do, 07 Sep 2006) $ 
 */
...
//      throws Exception if not found (should be organized )
    ...
    public static FontStylesCollection loadFromXml( String xmlFileName )  throws IOException, SAXException {
        ...
        digester.addObjectCreate(path, "de.mpg.escidoc.services.citationmanager.FontStylesCollection");
        
        path += "/font-style";
        digester.addObjectCreate(path, "de.mpg.escidoc.services.citationmanager.FontStyle");
