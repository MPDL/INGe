...
/**
* Interface for managing of the Citation Styles. It includes 
* 1) methods for CRUD operations 
* 2) validation
* 3) compilation
* 4) view      
* 
...
public interface CitationStyleManager 
{
	 ...
	 * The method creates new Citation Style. Default Citation Style will 
	 * be taken as start up version of it.   
