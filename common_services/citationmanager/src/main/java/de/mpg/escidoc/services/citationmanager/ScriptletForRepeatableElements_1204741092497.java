...
public class ScriptletForRepeatableElements_1204741092497 extends JRDefaultScriptlet {
...
public String getCS_1_CSLD_1_P_default_E_1() throws Exception {
String result = "";
String str = "";
String last = "";
String delim = "";
JRXmlDataSource ds = ((JRXmlDataSource) this.getParameterValue("REPORT_DATA_SOURCE"));
JRXmlDataSource subDs = ds.subDataSource("publication/creator[@role='author']/person");
...
String delim = "";
JRXmlDataSource ds = ((JRXmlDataSource) this.getParameterValue("REPORT_DATA_SOURCE"));
JRXmlDataSource subDs = ds.subDataSource("publication/creator[@role='author']/organization");
JRDesignField field_default_0 = new JRDesignField();
...
public String getCS_1_CSLD_1_P_default_E_5() throws Exception {
String result = "";
String str = "";
String last = "";
String delim = "";
JRXmlDataSource ds = ((JRXmlDataSource) this.getParameterValue("REPORT_DATA_SOURCE"));
JRXmlDataSource subDs = ds.subDataSource("publication/source/creator[@role='editor']/person");
JRDesignField field_default_0 = new JRDesignField();
...
public String getCS_1_CSLD_2_P_default_E_1() throws Exception {
String result = "";
String str = "";
String last = "";
String delim = "";
...
String delim = "";
JRXmlDataSource ds = ((JRXmlDataSource) this.getParameterValue("REPORT_DATA_SOURCE"));
JRXmlDataSource subDs = ds.subDataSource("publication/creator[@role='author']/person|organization");
JRDesignField field_default_0 = new JRDesignField();
