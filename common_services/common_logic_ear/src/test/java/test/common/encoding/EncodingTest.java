...
/**
 * JUnit tests for the encoding of the communication between the framework and the common logic and
 * inside the transforming.
 * 
...
public class EncodingTest extends TestBase {
  ...
  public final void createItem() throws Exception {
    ...
    Assert
        .assertTrue(savedItemVO.getMetadata().getTitle().getValue().length() == encodingCharacters
            .length());
  }
}
