...
public class TransformAffiliationTest extends TestBase
{
    ...
    private static final String ORGANIZATIONAL_UNIT_SCHEMA_FILE = "src/test/resources/xsd/soap/organizational-unit/0.3/organizational-unit.xsd";
    private static final String ORGANIZATIONAL_UNIT_LIST_SCHEMA_FILE = "src/test/resources/xsd/soap/organizational-unit/0.3/organizational-unit-list.xsd";
    private static final String ORGANIZATIONAL_UNIT_PATH_LIST_SCHEMA_FILE = "src/test/resources/xsd/soap/organizational-unit/0.3/organizational-unit-path-list.xsd";
