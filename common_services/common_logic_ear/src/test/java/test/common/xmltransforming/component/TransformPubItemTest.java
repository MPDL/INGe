...
public class TransformPubItemTest extends XmlTransformingTestBase
{
    ...
    private static final String ITEM_SCHEMA_FILE = "src/test/resources/xsd/soap/item/0.3/item.xsd";
    private static final String ITEM_LIST_SCHEMA_FILE = "src/test/resources/xsd/soap/item/0.3/item-list.xsd";
    private static final String MPDL_METADATA_SCHEMA_FILE = "src/test/resources/xsd/metadata/0.1/escidocprofile.xsd";
    ...
    public void testTransformReleasedItemToPubItemAndCheckPID() throws Exception
    {
        ...
        assertNotNull("PID is null!", pubItemVO.getPid());
        assertEquals("hdl:someHandle/test/escidoc:4747", pubItemVO.getPid());
    }
    ...
    public void testTransformWithdrawnItemToPubItem() throws Exception
    {
        ...
        assertEquals(savedItem.getWithdrawalComment(), "Withdraw withdraw");
    }
