...
public class TransformStatisticsTest extends XmlTransformingTestBase {
  ...
  public void testTransformToStatisticReportRoundtrip() throws Exception {
    ...
    repDefVO
        .setSql("select * from escidocaggdef1_request_stats where month = {month} and year = {year};");
    ...
    StatisticReportDefinitionVO repDefVOReply =
        xmlTransforming.transformToStatisticReportDefinition(repDefXMLReply);
    ...
    StatisticReportRecordParamVO param1 =
        new StatisticReportRecordParamVO("month", new StatisticReportRecordDecimalParamValueVO(
            String.valueOf(Calendar.getInstance().get(Calendar.MONTH))));
    StatisticReportRecordParamVO param2 =
        new StatisticReportRecordParamVO("year", new StatisticReportRecordDecimalParamValueVO(
    ...
    List<StatisticReportRecordVO> repRecVOList =
