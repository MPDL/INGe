...
public class EmailHandlingTest extends TestBase {
  ...
  /**
   * @throws Exception TODO all these mail settings have to become properties!!
   */
  @BeforeClass
  public static void setUpBeforeClass() throws Exception {

    logger.debug("E-Mail props: "
        + PropertyReader.getProperty("escidoc.pubman_presentation.email.mailservername"));
    ...
    recipientsAddresses =
        new String[] {PropertyReader.getProperty("escidoc.pubman_presentation.email.sender")};
    replyToAddresses =
        new String[] {PropertyReader.getProperty("escidoc.pubman_presentation.email.sender")};
  ...
  /**
   * Test method for
   * {@link de.mpg.escidoc.services.common.exporthandling.EmailHandlingBean#sendMail()}. TODO Test
   * ignored cause mail settings has to become properties first
   */
  @Test
  public void testSendMail() throws TechnicalException {
    ...
    emailHandling.sendMail(smtpHost, withAuth, username, password, senderAddress,
        recipientsAddresses, null, null, replyToAddresses, subject, text, attachments);
  }
  ...
  private static EmailHandling getEmailHandling() throws NamingException {
    ...
    EmailHandling emailHandling =
        (EmailHandling) context.lookup("ejb:common_logic_ear/common_logic/EmailHandlingBean!"
            + EmailHandling.class.getName());
