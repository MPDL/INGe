...
public class TestCitationStyleLanguageManager
{
    ...
    public void init() throws Exception
    {
        ...
        this.citationStyleXml = IOUtils.toString(
                TestCitationStyleLanguageManager.class.getClassLoader().getResourceAsStream(PATH_CITATION_STYLE), "UTF-8");
        this.escidocItemXml = IOUtils.toString(
                TestCitationStyleLanguageManager.class.getClassLoader().getResourceAsStream(PATH_ESCDOC_ITEM), "UTF-8");
    ...
    {
        CitationStyleLanguageManagerInterface cslManager = new CitationStyleLanguageManagerDefaultImpl(this.citationStyleXml);
        String citationSnippet = IOUtils.toString(cslManager.getOutput(this.exportFormat, this.escidocItemXml), "UTF-8");
        assertEquals(
