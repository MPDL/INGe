...
public class StructuredExportIntegrationTest {
  ...
  public final void getStructuredExport() throws Exception {
    ...
    export =
        (StructuredExportHandler) ctx
            .lookup("ejb:structuredexportmanager_ear/structuredexportmanager/StructuredExportHandlerBean!"
                + StructuredExportHandler.class.getName());
  }
  ...
  public final void getStructuredTestOutput() throws Exception {
    endNoteTestOutput =
        new String(TestHelper.readBinFile("src/test/resources/EndNoteTestOutput.txt"));
