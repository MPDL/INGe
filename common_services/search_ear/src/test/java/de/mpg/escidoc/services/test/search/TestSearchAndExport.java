...
/**
 * Provides some basic test for the search and export component. The detailed tests are already
 * covered by tests of the structured export manager and the TestMetadataSearch class. TODO
 * Description
 * 
...
public class TestSearchAndExport extends TestSearchBase {
  ...
  public void testSearchAndExportSnippetAPA() throws Exception {
    ...
    String xPathExp =
        "/*[local-name() = 'item-list' and namespace-uri() = 'http://www.escidoc.de/schemas/itemlist/0.7']/*[local-name() = 'item' and namespace-uri() = 'http://www.escidoc.de/schemas/item/0.7']";
    ...
    String xPathExp2 =
        "*[local-name() = 'properties' and namespace-uri() = 'http://www.escidoc.de/schemas/item/0.7']/*[local-name() = 'content-model-specific' and namespace-uri() = 'http://escidoc.de/core/01/properties/']/*[local-name() = 'bibliographicCitation' and namespace-uri() = 'http://purl.org/dc/terms/']";
