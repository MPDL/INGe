...
public class SearchPubItemsByAffiliationTest extends TestBase {
  ...
  // * Test method for
  // * {@link
  // de.mpg.escidoc.services.pubman.searching.PubItemSearchingBean#searchPubItemsByAffiliation(de.mpg.escidoc.services.common.referenceobjects.AffiliationRO)}.
  // *
  // * @throws Exception
  // */
  // @Test
