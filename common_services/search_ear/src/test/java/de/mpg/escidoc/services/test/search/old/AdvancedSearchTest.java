...
public class AdvancedSearchTest extends TestBase {
  ...
  // * {@link
  // de.mpg.escidoc.services.pubman.searching.PubItemSearchingBean#advancedSearch(java.util.List)}.
  // *
  // * @throws Exception
  // */
  // @Test
  ...
  // * Publication.Title, Publication.AlternativeTitle, Publication.TableOfContents,
  // Publication.Abstract and Publication.Subject
  ...
  // * Publication.Title and Publication.AlternativeTitle for each language separately and for all
  // languages at once
  // * {@link
  // de.mpg.escidoc.services.pubman.searching.PubItemSearchingBean#advancedSearch(java.util.List)}.
  // *
  ...
  // * all Event.Title,Event.AlternativeTitle and Event.Place for each language separately and for
  ...
  // * all Source.Title and Source.AlternativeTitle for each language separately and for all
  // languages at once
  // * {@link
  // de.mpg.escidoc.services.pubman.searching.PubItemSearchingBean#advancedSearch(java.util.List)}.
  // *
