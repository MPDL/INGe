...
public interface DataHandler {
   ...
   * the default metadata format defined in sources.xml.
   * 
   * @param sourceName
   * @param identifier
   ...
   * The format properties are default This format can either be the format the external source
   * provides, or a format we can transform from a format the external source provides
   * 
   * @param sourceName
   * @param identifier
   * @param formatName
  ...
  /**
   * This operation fetches data from the specified source and returns it in the requested format.
   * The fetched data will return in zip format, currently only file fetching is possible for
   * multiple formats
   * 
   * @param sourceName
   * @param identifier
   ...
   * This operation fetches data from the specified source and returns it in the requested format.
   * The fetched data will return in zip format, currently only file fetching is possible for
   * multiple formats The formats properties are default
   * 
   * @param sourceName
   * @param identifier
   * @param formats[]
