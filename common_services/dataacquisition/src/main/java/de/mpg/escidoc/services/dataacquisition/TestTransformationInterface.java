 ...
 * @version $Revision: 2181 $ $LastChangedDate: 2009-07-20 16:23:34 +0200 (Mo, 20 Jul 2009) $
 *
 */
@TransformationModule
public class TestTransformationInterface implements de.mpg.escidoc.services.transformation.Transformation
{
    private final Logger logger = Logger.getLogger(TestTransformationInterface.class);
     ...
     * Public constructor.
     */
    public TestTransformationInterface()
    {
        this.util = new Util();
    }
    ...
    public byte[] transform(byte[] src, Format srcFormat, Format trgFormat, String service)
        throws TransformationNotSupportedException, RuntimeException
    {
        System.out.println("Test Transformation from the Dataacquisition Module");
        return null;
    }
