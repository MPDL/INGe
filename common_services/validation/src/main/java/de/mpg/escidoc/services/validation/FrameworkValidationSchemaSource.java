...
public class FrameworkValidationSchemaSource extends ShortContentHandler implements
  ...
  public Map<CacheTuple, String> retrieveNewSchemas(Date lastUpdate) throws Exception {
    ...
    while (true) {
      /*
       * String filter =
       * "<param><filter name=\"http://escidoc.de/core/01/structural-relations/content-model\">" +
       * contentModel +
       * "</filter><order-by sorting=\"descending\">http://escidoc.de/core/01/properties/creation-date</order-by><limit>1</limit><offset>"
       * + offset + "</offset></param>";
       */

      String qContent =
          "\"http://escidoc.de/core/01/structural-relations/content-model\"=" + contentModel;
      String qOrderBy =
          "\"sorting=\"=descending\"http://escidoc.de/core/01/properties/creation-date\"";
      ...
      if (modificationDate != null
          && (lastUpdate == null || modificationDate.getTime() > lastUpdate.getTime())) {
