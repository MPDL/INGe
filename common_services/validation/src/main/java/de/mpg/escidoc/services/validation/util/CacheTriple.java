...
public class CacheTriple extends CacheTuple
{
    ...
    */
   public CacheTriple(final String schemaName, final String contentModel, final String validationPoint)
   {
   ...
   public boolean equals(final Object other)
   {
               ...
               && other instanceof CacheTriple)
       {
           return (this.schemaName.equals(((CacheTriple) other).schemaName)
                   && this.contentModel.equals(((CacheTriple) other).contentModel)
                   && this.validationPoint.equals(((CacheTriple) other).validationPoint));
       }
       else
       {
           return false;
