...
public class TestContainer extends TestItemBase {
  ...
  /**
   * Test method for
   * {@link de.fiz.escidoc.om.ContainerHandlerLocal#update(java.lang.String,java.lang.String)}.
   */
  @Test
  public void updateContainer() throws Exception {
    userHandle = loginSystemAdministrator();
    String container =
        ServiceLocator.getContainerHandler(userHandle).create(readFile(CONTAINER_FILE));
    String id = getId(container);
    long zeit = -System.currentTimeMillis();
  ...
  /**
   * Test method for
   * {@link de.fiz.escidoc.om.ContainerHandlerLocal#retrieveVersionHistory(java.lang.String)}.
   */
  @Test
