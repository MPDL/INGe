...
public class TestFile extends TestBase {
  private static final String ITEM_FILE =
      "src/test/resources/test/TestFile/new_schindlmayr-springer.xml";
  private static final String COMPONENT_FILE =
  ...
  public void downloadFile() throws Exception {
    ...
    DocumentBuilder docBuilder = docBuilderFactory.newDocumentBuilder();
    Document document =
        docBuilder.parse(new ByteArrayInputStream(createItemWithFile(userHandle).getBytes()));
    document.getDocumentElement().normalize();
