...
alter table sm._escidocaggdef1_object_statistics set tablespace tbl_escidoc_core_data; 
alter table sm._escidocaggdef1_request_statistics set tablespace tbl_escidoc_core_data; 
alter table sm._escidocaggdef2_error_statistics set tablespace tbl_escidoc_core_data; 
...
alter table sm.statistic_data set tablespace tbl_escidoc_core_data; 
