...
<%
	...
	response.sendRedirect(PropertyReader.getProperty("escidoc.aa.instance.url") + "logout?target=" + URLEncoder.encode(PropertyReader.getProperty("inge.cone.service.url")));
%>