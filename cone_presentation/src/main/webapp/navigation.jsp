		...
		<!-- meta Menu starts here -->
			...
			<!-- Login -->
				...
				<% if (Login.getLoggedIn(request)) { %>
					<a class="medium_area0_p8 endline" href="logout.jsp?target=<%= URLEncoder.encode(PropertyReader.getProperty(PropertyReader.INGE_CONE_SERVICE_URL) + request.getServletPath().substring(1), "UTF-8") %>">Logout</a>
				<% } else { %>
