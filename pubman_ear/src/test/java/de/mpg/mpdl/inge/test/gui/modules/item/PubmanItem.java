...
public class PubmanItem {
  public enum ItemType {
    // Item,
    ItemWithFile, ItemWithLocator, ItemWithFileAndLocator, Other, Paper,
  }
  ...
  public enum IdentifierType {
    URI, ISBN, ISSN, DOI, URN, PII, EDOC, ESCIDOC, ISI, PND, ZDB, PMID, ARXIV, PMC, BMC, OTHER
  }
  ...
  List<PubmanItemPersonOrganizations> personOrganizationList =
      new ArrayList<PubmanItemPersonOrganizations>();
