...
public class PubmanItemSource {
  public enum SourceGenre {
    BOOK, ISSUE, JOURNAL, PROCEEDINGS, SERIES
  }
  ...
  public PubmanItemSource(SourceGenre genre, String title, CreatorRole creatorRole,
      CreatorType creatorType, String familyName, String givenName, String orgaName,
      String orgaAdress, String volume, String totalNumberOfPages, String publisher, String place,
      IdentifierType identifier, String identifierValue, String edition, String issue,
      String startPage, String endPage, String sequenceNumber) {
    this.genre = genre;
    this.title = title;
