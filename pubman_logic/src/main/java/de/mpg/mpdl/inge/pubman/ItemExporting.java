 ...
 * item list in accordance of a special export format. Revised by StG: 24.08.2007
 * 
...
public interface ItemExporting {
   ...
   */
  public byte[] getOutput(ExportFormatVO exportFormat, java.util.List<PubItemVO> pubItemVOList)
