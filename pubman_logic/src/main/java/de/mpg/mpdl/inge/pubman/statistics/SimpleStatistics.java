 ...
 */
package de.mpg.mpdl.inge.pubman.statistics;
...
public class SimpleStatistics implements PubItemSimpleStatistics {
  ...
  // protected static final String REPORTDEFINITION_PROPERTIES_FILE =
  // "report-definitions.properties";
   ...
   * {@inheritDoc}
   */
  public String getNumberOfItemOrFileRequests(String reportDefinitionId, String objectId,
      ...
      if (aggregationTableName == null) {
        ...
        String aggregationDefinitionXml =
            ResourceUtil.getResourceAsString("pubman_object_stats_aggregation.xml",
                SimpleStatistics.class.getClassLoader());
  ...
  private void logPubItemAction(PubItemVO pubItem, String ip, String userAgent, ItemAction action,
      String sessionId, boolean loggedIn, String referer,
      List<StatisticReportRecordParamVO> additionalParams) throws Exception {
    ...
    oaParam.setParamValue(new StatisticReportRecordStringParamValueVO(String
        .valueOf(getHasOAComponent(pubItem))));
    ...
    statisticLogger.logItemAction(sessionId, ip, userAgent, new PubItemVO(pubItem), action,
        loggedIn, referer, "pubman", paramList, AdminHelper.getAdminUserHandle());
  }
  ...
  public void logPubItemExport(PubItemVO pubItem, String ip, String userAgent, String sessionId,
    ...
    exportFormatParam.setParamValue(new StatisticReportRecordStringParamValueVO(exportFormat
        .getName()));
    ...
    exportFileFormatParam.setParamValue(new StatisticReportRecordStringParamValueVO(exportFormat
        .getSelectedFileFormat().getName()));
    paramList.add(exportFileFormatParam);

    this.logPubItemAction(pubItem, ip, userAgent, ItemAction.EXPORT, sessionId, loggedIn, referer,
        paramList);
  }
