...
public class ViewItemSourceUI extends HtmlPanelGroup
{
    ...
    protected void initialize(PubItemVO pubItemVO)
    {
        ...
        // add the subheader
        this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSubHeaderSource")));
        ...
        if(this.pubItem.getMetadata() != null)
        {
            if(this.pubItem.getMetadata().getSources() != null)
            {
                for(int i = 0; i < this.pubItem.getMetadata().getSources().size(); i++)
                {
                    ...
                    this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSourceGenre")));
                    ...
                    if(this.pubItem.getMetadata().getSources().get(i).getTitle() != null 
                            && this.pubItem.getMetadata().getSources().get(i).getTitle().getLanguage() != null 
                            && !this.pubItem.getMetadata().getSources().get(i).getTitle().getLanguage().trim().equals(""))
                    {
                        this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSourceTitle") + " <" + this.pubItem.getMetadata().getSources().get(i).getTitle().getLanguage() + ">"));
                    }
                    else
                    {
                        this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSourceTitle")));
                    }
                    ...
                    if(this.pubItem.getMetadata().getSources().get(i).getCreators() != null)
                    {
                        if(this.pubItem.getMetadata().getSources().get(i).getCreators().size() > 0)
                        {
                            // label
                            this.getChildren().add(htmlElement.getStartTagWithStyleClass("div", "itemTitle odd"));
                            
                            this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSourceCreators")));
                    ...
                    this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSourceVolumeIssue")));
                    ...
                    this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSourcePubInfo")));
                    ...
                    this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSourceSequenceNo")));
                    ...
                    if(this.pubItem.getMetadata().getSources().get(i).getSequenceNumber() != null)
                    {
                    ...
                    this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSourceIdentifier")));
    ...
    private void createCreatorList(int sourceNumber)
    {
        ...
        if(this.pubItem.getMetadata().getSources().get(sourceNumber).getCreators() != null)
        {
    ...
    private String getPublishingInfo(int sourceNumber)
    {
        ...
        if(this.pubItem.getMetadata().getSources().get(sourceNumber).getPublishingInfo() != null)
        {
            ...
            if(this.pubItem.getMetadata().getSources().get(sourceNumber).getPublishingInfo().getPlace() != null)
            {
