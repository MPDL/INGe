...
//        }
    ...
    public Vector<Collection> getDepositCollection (AccountUserVO user)
    {
        ...
        for (int i = 0; i< contextList.size(); i++)
        {
            ...
            //static value
            col.setTreatment("Zip archives recognised as content packages are opened and the individual files contained in them are stored.");
            //static value
     ...
     */
    public PubItemVO doDeposit (AccountUserVO user, PubItemVO item) throws ItemInvalidException, Exception 
    {
    ...
    public String getBaseUrl () throws IOException, URISyntaxException
    {
