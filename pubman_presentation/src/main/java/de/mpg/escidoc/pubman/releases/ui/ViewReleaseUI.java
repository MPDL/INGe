...
/**
 * UI for viewing release entries. 
 * 
...
public class ViewReleaseUI extends HtmlPanelGroup
{
     ...
     * Public constructor.
     */
    public ViewReleaseUI(PubItemVersionVOWrapper pubItemVersionVOWrapper)
    {
        ...
        this.lblDescription.setValue(pubItemVersionVOWrapper.getValueObject().getReference().getObjectId());
