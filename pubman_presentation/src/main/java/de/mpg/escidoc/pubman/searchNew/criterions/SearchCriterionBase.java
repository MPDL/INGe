...
public abstract class SearchCriterionBase implements Serializable{
	...
	public enum SearchCriterion
	{
		...
		REFEREE (PersonSearchCriterion.class, DisplayType.PERSON),  
		INVENTOR (PersonSearchCriterion.class, DisplayType.PERSON),  
		APPLICANT (PersonSearchCriterion.class, DisplayType.PERSON),  
		DIRECTOR (PersonSearchCriterion.class, DisplayType.PERSON),  
        PRODUCER (PersonSearchCriterion.class, DisplayType.PERSON),  
        ACTOR (PersonSearchCriterion.class, DisplayType.PERSON),  
        CINEMATOGRAPHER (PersonSearchCriterion.class, DisplayType.PERSON),  
        SOUND_DESIGNER (PersonSearchCriterion.class, DisplayType.PERSON),  
