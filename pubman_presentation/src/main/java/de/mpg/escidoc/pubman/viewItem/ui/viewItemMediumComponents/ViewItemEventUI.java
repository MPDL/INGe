...
public class ViewItemEventUI extends HtmlPanelGroup
{
    ...
    protected void initialize(PubItemVO pubItemVO)
    {
        ...
        // add the subheader
        this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblSubHeaderEvent")));
        ...
        if(this.pubItem.getMetadata() != null)
        {
            if(this.pubItem.getMetadata().getEvent() != null)
            {
                ...
                this.getChildren().add(CommonUtils.getTextElementConsideringEmpty(bundleLabel.getString("ViewItemMedium_lblEventTitle")));
