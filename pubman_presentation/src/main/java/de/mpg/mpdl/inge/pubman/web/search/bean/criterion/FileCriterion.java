  ...
  public ArrayList<MetadataSearchCriterion> createSearchCriterion() throws TechnicalException {
    ...
    if (this.componentAvailability != null) {
      if (this.componentAvailability
        ...
        return criterions;
          ...
          .equals(InternationalizationHelper.SelectComponentAvailability.SELECT_HAS_COMPONENTS
              .toString())) {
        criterions.add(new MetadataSearchCriterion(
            MetadataSearchCriterion.CriterionType.COMPONENT_ACCESSIBILITY,
            MetadataSearchCriterion.LogicalOperator.AND));
    ...
    if (this.componentVisibility != null) {
      if (this.componentVisibility
          .equals(InternationalizationHelper.SelectComponentVisibility.SELECT_COMPONENT_PRIVATE
              .toString())) {
        visibility = "private";
      } else if (this.componentVisibility
          .equals(InternationalizationHelper.SelectComponentVisibility.SELECT_COMPONENT_PUBLIC
              .toString())) {
        visibility = "public";
      } else if (this.componentVisibility
          .equals(InternationalizationHelper.SelectComponentVisibility.SELECT_COMPONENT_RESTRICTED
              .toString())) {
        visibility = "audience";
      }
      criterions.add(new MetadataSearchCriterion(
        ...
        if (visibility != null && storage != null && this.contentCategory == null) {
          ...
          lastMetadataSearchCriterion
              .addSubCriteria(new MetadataSearchCriterion(
                  MetadataSearchCriterion.CriterionType.COMPONENT_COMPOUND_PROPERTIES, "\""
                      + visibility + " external-url " + this.contentCategory + "\"",
                  LogicalOperator.OR));
