...
/**
 * This session bean is a plain copy of the PubItemListSessionBean exclusive for Revisions. So
 * states are hold in PubItemListSessionBean as long as no other "normal" item list is loaded
 * 
