...
package de.mpg.mpdl.inge.pubman.web.exceptions;
...
public class PubManStylesheetNotAvailableException extends Exception {
   ...
   */
  public PubManStylesheetNotAvailableException(Throwable cause) {
    super(cause);
  }

  public PubManStylesheetNotAvailableException(String cause) {
    super(cause);
  }
}
