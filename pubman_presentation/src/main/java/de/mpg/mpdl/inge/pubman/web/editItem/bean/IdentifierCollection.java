...
public class IdentifierCollection {
  ...
  public SelectItem[] getIdentifierTypes() {
    ...
    IdType[] typesToDisplay = new IdType[] {IdType.CONE, IdType.URI, IdType.ISBN, IdType.ISSN,
        IdType.DOI, IdType.URN, IdType.PII, IdType.EDOC, IdType.ESCIDOC, IdType.ISI, IdType.PND,
        IdType.ZDB, IdType.PMID, IdType.ARXIV, IdType.PMC, IdType.BMC, IdType.BIBTEX_CITEKEY,
    ...
    for (IdentifierVO.IdType type : typesToDisplay) {
      selectItemList.add(new SelectItem(type.toString(),
          labelBundle.getString("ENUM_IDENTIFIERTYPE_" + type.toString())));
    }
