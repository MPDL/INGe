...
/**
 * ViewItemSource.java Keeps structural information about the source(s) in the pubitem like nesting
 * etc.
 * 
...
public class ViewItemSource {
   ...
   * @param isCreatorsCollapsed flag if the creators should be displayed as collapsed (false if
   *        expanded)
   * @param isAbstractTitlesCollapsed flag if the abstract(s) should be displayed as collapsed
   *        (false if expanded)
   * @param isSourcesOfSourceCollapsed flag if the sources of this source should be displayed as
   *        collapsed (false if expanded)
   * @param isLastSource flag if this source is the last source in the structure
   */
  public ViewItemSource(String sourceID, boolean isCreatorsCollapsed,
      boolean isAbstractTitlesCollapsed, boolean isSourcesOfSourceCollapsed, boolean isLastSource) {
