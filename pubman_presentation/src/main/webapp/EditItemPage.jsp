	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
					...
					<div class="clear">
						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<div class="subHeader">
								...
								<h:outputText
									value="#{lbl.EditItem_lblItemVersionID} '#{EditItem.item.version.objectId}'."
									rendered="#{EditItem.item.version.objectId != null}" />
								<br />
								<h:outputText
							...
							<h:panelGroup id="messages" styleClass="subHeader">
								...
								<h:panelGroup layout="block"
									...
									rendered="#{EditItem.item.validationReport!=null}">
									<h2>
										<h:outputText value="#{lbl.Yearbook_validationMessageHeader}" />
									</h2>
									<ul>
										<ui:repeat var="valitem"
											value="#{EditItem.item.validationReport.items}">
					...
					<div class="full_area0">
						<div id="fullItem" class="full_area0 fullItem">
							...
							<div class="free_area0 xTiny_marginLIncl">
								<h:outputText value="* " />
								<h:commandLink id="lnkValidate2"
									value="#{msg.mandatoryFieldFS1}" action="#{EditItem.validate}"
									onclick="fullItemReloadAjax();" />
						...
						<div class="full_area0 formButtonArea">
							<h:commandLink
								...
								id="lnkCancel" value="#{lbl.EditItem_lnkCancel}"
								action="#{EditItem.cancel}" onclick="fullItemReloadAjax();" />
							<h:commandLink styleClass="free_area1_p8 activeButton"
								id="lnkDelete" binding="#{EditItem.lnkDelete}"
								onclick="if(!confirm('#{msg.deleteMessage}'))return false;"
								value="#{lbl.EditItem_lnkDelete}"
								onmousedown="if(!confirmDelete('form1:EditItem'))return false;"
								action="#{EditItem.delete}" />
							<h:commandLink styleClass="free_area1_p8 activeButton"
								...
								onclick="fullItemReloadAjax();" />
							<h:commandLink styleClass="free_area1_p8 activeButton"
								id="lnkReleaseReleasedItem"
								binding="#{EditItem.lnkReleaseReleasedItem}"
								value="#{lbl.actionMenu_lnkRelease}"
								action="#{EditItem.saveAndRelease}"
								onclick="fullItemReloadAjax();" />
							<h:commandLink styleClass="free_area1_p8 activeButton"
								id="lnkAccept" binding="#{EditItem.lnkAccept}"
								value="#{lbl.EditItem_lnkAccept}"
								action="#{EditItem.saveAndAccept}"
								onclick="fullItemReloadAjax();" />
							<h:commandLink styleClass="free_area1_p8 activeButton"
								...
								onclick="fullItemReloadAjax();" />
							<h:commandLink styleClass="free_area1_p8 activeButton"
								id="lnkSave" binding="#{EditItem.lnkSave}"
								value="#{lbl.EditItem_lnkSave}" action="#{EditItem.save}"
								onclick="fullItemReloadAjax();" />
							<h:commandLink styleClass="free_area1_p8 activeButton"
		...
		<script type="text/javascript">
			...
			function checkUpdatePersonFunction() {
				(typeof updatePersonUi == 'function') ? updatePersonUi()
						: setTimeout("checkUpdatePersonFunction()", 30);
			}
			...
			fundingProgramSuggestURL = suggestConeUrl
					+ 'funding-programs/query';
			fundingOrganizationSuggestURL = suggestConeUrl
					+ 'funding-organizations/query';
