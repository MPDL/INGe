					...
					<div class="full_area0">
						<div class="full_area0 fullItem">
							<div class="full_area0 fullItemControls">
								<span class="full_area0_p5 underRework"> <h:panelGroup
										styleClass="seperator" /> <h:outputLink
										id="lnkViewLocalTagsPageLocalTags"
							...
							<ui:include src="localTags/ViewLocalTags.jspf" />
