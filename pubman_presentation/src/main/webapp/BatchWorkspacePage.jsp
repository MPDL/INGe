...
<h:head>
    ...
    <link rel="unapi-server" type="application/xml" title="unAPI" href="${BatchItemsRetrieverRequestBean.unapiURLview}" />
            ...
            <h:form id="form1">
                <div id="content" class="full_area0 clear">
                        ...
                        <div class="small_marginLIncl subHeaderSection">
                            <div class="contentMenu">
                                ...
                                <div class="free_area0 sub">
                                    ...
                                    <h:outputText styleClass="seperator void" rendered="#{PubItemListSessionBean.totalNumberOfElements>0 }" />
                                    <h:commandLink id="lnkBatch_lblRemoveSelected" title="#{tip.List_lblAddToBasket}" styleClass="free_area0" value="#{lbl.Batch_lblRemoveSelected}" action="#{BatchItemsRetrieverRequestBean.deleteSelected}" rendered="#{PubItemListSessionBean.totalNumberOfElements>0 }" onclick="fullItemReloadAjax();" />
                    ...
                    <h:panelGroup styleClass="full_area0" rendered="#{PubItemListSessionBean.partListSize==0}">
                        <h:outputText styleClass="free_area0 small_marginLExcl" value="#{msg.batch_NoItems}" />
                    </h:panelGroup>
                    <!-- end: content section -->
                </div>
            </h:form>
