						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<!-- content menu starts here -->
								...
								<!-- content menu lower line starts here -->										
									...
									<h:commandLink id="lnkRelease" action="#{ViewItemFull.submitItem}" value="#{lbl.actionMenu_lnkRelease}" rendered="#{!ViewItemFull.isStateWithdrawn and ViewItemFull.isOwner and ViewItemFull.isLatestVersion and (((ViewItemFull.isStatePending || ViewItemFull.isStateSubmitted) and ViewItemFull.isWorkflowSimple) || (ViewItemFull.isWorkflowStandard and ViewItemFull.isModerator and ViewItemFull.isStateSubmitted))}"/>
									<h:panelGroup styleClass="seperator" rendered="#{!ViewItemFull.isStateWithdrawn and ViewItemFull.isOwner and ViewItemFull.isLatestVersion and (((ViewItemFull.isStatePending || ViewItemFull.isStateSubmitted) and ViewItemFull.isWorkflowSimple) || (ViewItemFull.isWorkflowStandard and ViewItemFull.isModerator and ViewItemFull.isStateSubmitted))}" />

									<h:commandLink id="lnkAccept" action="#{ViewItemFull.acceptItem}" value="#{lbl.actionMenu_lnkAccept}" rendered="#{!ViewItemFull.isStateWithdrawn and ViewItemFull.isStateSubmitted and ViewItemFull.isLatestVersion and ViewItemFull.isModerator and !ViewItemFull.isOwner and !ViewItemFull.isModifyDisabled}"/>
									<h:panelGroup styleClass="seperator" rendered="#{!ViewItemFull.isStateWithdrawn and ViewItemFull.isStateSubmitted and ViewItemFull.isLatestVersion and ViewItemFull.isModerator and !ViewItemFull.isOwner and !ViewItemFull.isModifyDisabled}" />
									...
									<h:panelGroup styleClass="seperator" rendered="#{!ViewItemFull.isStateWithdrawn and (ViewItemFull.isStateSubmitted and !ViewItemFull.isPublicStateReleased and ViewItemFull.isLatestVersion and ViewItemFull.isModerator and !ViewItemFull.isModifyDisabled and ViewItemFull.isWorkflowStandard)}" />

									<h:commandLink id="lnkDelete" onclick="if(!confirm('#{msg.deleteMessage}'))return false;" value="#{lbl.actionMenu_lnkDelete}" action="#{ViewItemFull.deleteItem}" rendered="#{!ViewItemFull.isStateWithdrawn and !ViewItemFull.isPublicStateReleased and (ViewItemFull.isStatePending || ViewItemFull.isStateInRevision) and ViewItemFull.isLatestVersion and ViewItemFull.isOwner}"/>
                                    <h:panelGroup styleClass="seperator" rendered="#{!ViewItemFull.isStateWithdrawn and !ViewItemFull.isPublicStateReleased and (ViewItemFull.isStatePending || ViewItemFull.isStateInRevision) and ViewItemFull.isLatestVersion and ViewItemFull.isOwner}" />

                                    <h:commandLink id="lnkWithdraw" action="#{ViewItemFull.withdrawItem}" value="#{lbl.actionMenu_lnkWithdraw}" rendered="#{!ViewItemFull.isStateWithdrawn and (ViewItemFull.isStateReleased and ViewItemFull.isLatestVersion) and (ViewItemFull.isOwner || ViewItemFull.isModerator)}"/>
									<h:panelGroup styleClass="seperator" rendered="#{!ViewItemFull.isStateWithdrawn and (ViewItemFull.isStateReleased and ViewItemFull.isLatestVersion) and (ViewItemFull.isOwner || ViewItemFull.isModerator)}" />
