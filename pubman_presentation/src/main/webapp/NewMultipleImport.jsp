				...
				<div id="content" class="full_area0 clear">
					...
					<div class="clear">
						<div class="headerSection">
							...
							<div id="contentSkipLinkAnchor" class="clear headLine">
								...
								<h1>
									<h:outputText
										value="#{lbl.submission_lnkMultipleImportCapitalized}" />
								</h1>
								<!--  /* Headline ends here */  -->
							</div>
						</div>
						<div class="small_marginLIncl subHeaderSection">
							<div class="contentMenu">
								...
								<div class="free_area0 sub">
									<h:commandLink id="lnkNewEasySubmission"
									...
									<h:outputText styleClass="seperator void" />
									<h:outputLink id="lnkImportWorkspace"
										title="#{tip.submission_lnkImportWorkspace}"
										value="ImportWorkspace.jsp"
										rendered="#{DepositorWSSessionBean.newSubmission and ContextListSessionBean.depositorContextListSize>0}">
							...
							<div class="subHeader">
								...
								<h:outputText
									value="#{lbl.easy_submission_lblCollectionOfItem} #{MultipleImport.context.name}." />
							...
							<div class="subHeader">
								...
								<h:panelGroup layout="block"
									...
									rendered="#{MultipleImport.hasErrorMessages}">
									...
									<h:messages errorClass="messageError" warnClass="messageWarn"
										...
										showSummary="true" rendered="#{MultipleImport.hasMessages}" />
								</h:panelGroup>
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea infoMessageArea absoluteMessageArea"
									rendered="#{MultipleImport.hasMessages and !MultipleImport.hasErrorMessages}">
									<input type="button"
					...
					<div class="full_area0">
						<div class="full_area0 fullItem">
							<div class="full_area0 itemBlock noTopBorder">
								...
								<div class="free_area0 itemBlockContent endline">
									...
									<h:panelGroup id="uploadFile" layout="block"
										...
										<h:panelGroup
											class="xHuge_area0 xTiny_marginLExcl endline fileSection"
											rendered="#{empty MultipleImport.uploadedImportFile}">
											<p:fileUpload id="inpMultipleImportUploadedImportFile"
												label="#{lbl.multipleImport_uploadFile}"
												styleClass="fileInput"
												fileUploadListener="#{MultipleImport.fileUploaded}"
												auto="true" fileLimit="1" update="uploadFile,buttons"
												multiple="false" onstart="beforeAjaxRequest();"
												onerror="afterAjaxRequest();"
												oncomplete="afterAjaxRequest();">
											</p:fileUpload>
										</h:panelGroup>
										<h:panelGroup
											class="xHuge_area0 xTiny_marginLExcl endline fileSection"
											rendered="#{not empty MultipleImport.uploadedImportFile}">
						...
						<h:panelGroup id="buttons" layout="block"
							...
							<h:commandLink id="lnkUploadFile"
								styleClass="free_area1_p8 activeButton #{empty MultipleImport.uploadedImportFile ? 'disabled' : ''}"
								title="#{tip.easy_submission_btnImport}"
								action="#{MultipleImport.uploadFile}"
								disabled="#{empty MultipleImport.uploadedImportFile}">
