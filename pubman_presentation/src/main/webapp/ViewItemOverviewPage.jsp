						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<h:panelGroup layout="block" styleClass="contentMenu"
								...
								<div class="free_area0 sub">
									<h:outputLink id="lnkLinkForActionsView"
								...
								<h:panelGroup layout="block" styleClass="free_area0 sub action"
									...
									<h:outputLink id="lnkAddDoi" styleClass="free_area0" value="#"
										title="#{tip.ViewItemFull_lblAddDoi}"
										rendered="#{ViewItemFull.doiCappable and (ViewItemFull.canEdit or ViewItemFull.canModify)}"
										onclick="showDialog();">
					...
					<h:panelGroup layout="block" styleClass="full_area0"
						...
						<div class="full_area0 fullItem">
							...
							<h:panelGroup layout="block" styleClass="full_area0">
								...
								<h:panelGroup layout="block"
									styleClass="huge_area0 xTiny_marginRExcl small_marginLExcl"
								...
								<h:panelGroup layout="block" styleClass="third_area0">
									...
									<ui:include
										src="viewItemOverview/supplementaryMaterialGroup.jspf" />
