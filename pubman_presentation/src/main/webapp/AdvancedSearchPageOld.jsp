				...
				<div id="content" class="full_area0 clear">
					...
					<div class="clear">
						...
						<h:panelGroup layout="block"
							...
							rendered="#{AdvancedSearchPage.numberOfMessages > 0}">
							...
							<div class="subHeader">
								...
								<h:messages styleClass="singleMessage" errorClass="messageError"
									...
									rendered="#{AdvancedSearchPage.numberOfMessages == 1}" />
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea errorMessageArea"
									rendered="#{AdvancedSearchPage.hasErrorMessages and AdvancedSearchPage.numberOfMessages != 1}">
									<h2>
									...
									<h:messages errorClass="messageError" warnClass="messageWarn"
										...
										showSummary="true"
										rendered="#{AdvancedSearchPage.hasMessages}" />
								</h:panelGroup>
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea infoMessageArea"
									rendered="#{AdvancedSearchPage.hasMessages and !AdvancedSearchPage.hasErrorMessages and AdvancedSearchPage.numberOfMessages != 1}">
									<h2>
								...
								<h:outputText value="&#160;"
									rendered="#{!AdvancedSearchPage.hasErrorMessages}" />
								<!-- Subheadline ends here -->
							</div>
						</h:panelGroup>
					</div>
					...
					<div class="full_area0 formButtonArea">
						<h:commandLink id="lnkAdvancedSearchClearAll"
							styleClass="free_area1_p8 cancelButton xLarge_marginLIncl"
							value="#{lbl.adv_search_btClearAll}"
							action="#{AdvancedSearchEdit.clearAllForms}" />
						<h:commandLink id="lnkAdvancedSearchStartSearch"
							styleClass="free_area1_p8 activeButton"
							value="#{lbl.adv_search_btStart}"
							action="#{AdvancedSearchEdit.startSearch}" />
					</div>
					<!-- end: content section -->
				</div>
			</h:form>
