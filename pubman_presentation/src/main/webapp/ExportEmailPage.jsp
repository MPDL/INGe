				...
				<div id="content" class="full_area0 clear">
					...
					<div class="full_area0 formButtonArea">
						...
						<h:outputLink
							...
							id="lnkCancel"
							value="#{ApplicationBean.appContext}#{ExportEmailPage.previousPageURI}">
							<h:outputText value="#{lbl.ExportEmail_lblBack}" />
						</h:outputLink>
						<h:commandLink styleClass="free_area1_p8 activeButton"
							id="lnkSave" value="#{lbl.ExportEmail_lblSend}"
							action="#{ExportItems.sendEMail}" onclick="fullItemReloadAjax();" />
