						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<div class="subHeader">
								...
								<h:panelGroup layout="block"
									...
									<h:messages id="txtViewItemStatisticsPageWarn"
								...
								<h:panelGroup layout="block"
									...
									<h:messages id="txtViewItemStatisticsPageInfo"
										errorClass="messageError" warnClass="messageWarn"
										fatalClass="messageFatal" infoClass="messageStatus"
										layout="list" globalOnly="true" showDetail="false"
										showSummary="true" rendered="#{ViewItemFull.hasMessages}" />
						...
						<div class="full_area0 fullItem">
							<div class="full_area0 fullItemControls">
								<span class="full_area0_p5"> <h:panelGroup
									...
									<h:outputLink id="lnkViewItemStatisticsPageLocalTags"
										...
										id="lnkViewItemStatisticsPageAudience" styleClass="free_area0"
										...
										id="lnkViewItemStatisticsPageCollaborator"
										styleClass="free_area0"
									...
									<h:commandLink id="lnkViewItemStatisticsPageLog"
									...
									<h:outputLink id="lnkViewItemStatisticsPageStatisticsLink"
										...
										rendered="#{ViewItemFull.isLatestRelease and !ViewItemFull.isStateWithdrawn}" />
									<h:commandLink id="lnkViewItemStatisticsPageRevisions"
									...
									<h:commandLink id="lnkViewItemStatisticsPageVersions"
										styleClass="free_area0"
							...
							<div class="full_area0 itemHeader">
								...
								<h:panelGroup layout="block"
									...
									<h:outputLabel id="lblViewItemStatisticsPagePublicState"
										styleClass="medium_label endline" style="text-align: center;"
										rendered="#{ViewItemFull.isStateWithdrawn}">
										<h:outputText value="#{ViewItemFull.itemPublicState}" />
									</h:outputLabel>
									<h:outputLabel id="lblViewItemStatisticsPageItemState"
										styleClass="medium_label endline" style="text-align: center;"
										rendered="#{!ViewItemFull.isStateWithdrawn}">
							...
							<ui:include src="statistics/viewItemStatistics.jspf" />
