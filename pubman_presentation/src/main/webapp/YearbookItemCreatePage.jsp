						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<div class="subHeader">
								...
								<h:messages styleClass="singleMessage" errorClass="messageError"
									...
									rendered="#{YearbookItemCreateBean.numberOfMessages == 1}" />
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea errorMessageArea"
									rendered="#{YearbookItemCreateBean.hasErrorMessages and YearbookItemCreateBean.numberOfMessages != 1}">
									<h2>
								...
								<h:panelGroup layout="block"
									...
									rendered="#{YearbookItemCreateBean.hasMessages and !YearbookItemCreateBean.hasErrorMessages and YearbookItemCreateBean.numberOfMessages != 1}">
									<h2>
					...
					<div class="full_area0">
						...
						<div class="full_area0 formButtonArea">
							<h:commandLink styleClass="free_area1_p8 activeButton"
								id="lnkSave" value="Save"
								action="#{YearbookItemCreateBean.save}"
