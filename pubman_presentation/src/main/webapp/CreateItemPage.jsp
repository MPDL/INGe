						...
						<div class="small_marginLIncl subHeaderSection">
							<div class="contentMenu">
								...
								<div class="free_area0 sub">
									...
									<h:outputText styleClass="seperator void" />
									<h:commandLink id="lnkNewMultipleImport"
							...
							<div class="full_area0 small_marginLExcl">
								...
								<h3>
									<h:outputText value="#{msg.create_Item_Select_Collection}"
										rendered="#{ContextListSessionBean.openContextsAvailable}" />
								</h3>
								<h3>
									<h:outputText
										value="#{msg.depositorWE_noOpenContextsAvailable}"
										rendered="#{!ContextListSessionBean.openContextsAvailable}" />
								</h3>
