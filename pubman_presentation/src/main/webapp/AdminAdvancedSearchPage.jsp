		...
		<div class="full wrapper">
			...
			<h:form id="form1">
				<div id="content" class="full_area0 clear">
						...
						<h:panelGroup layout="block"
							...
							<h:panelGroup id="messages" styleClass="subHeader">
								<h:panelGroup layout="block"
									...
									rendered="#{AdvancedSearchBean.hasErrorMessages}">
									...
									<h:messages errorClass="messageError" warnClass="messageWarn"
										...
										showSummary="true"
										rendered="#{AdvancedSearchBean.hasMessages}" />
								</h:panelGroup>
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea infoMessageArea absoluteMessageArea"
									rendered="#{AdvancedSearchBean.hasMessages and !AdvancedSearchBean.hasErrorMessages}">
									<input type="button"
					...
					<h:commandButton id="lnkAdvancedSearchStartSearchTop"
						style="height:0; width:0; padding:0; margin:0; border:none;"
						value="#{lbl.adv_search_btStart}"
						action="#{AdvancedSearchBean.startAdminSearch}"
					...
					<div class="full_area0 formButtonArea">
						<h:commandButton id="lnkAdvancedSearchClearAll"
							styleClass="free_area1_p8 cancelButton xLarge_marginLIncl"
							value="#{lbl.adv_search_btClearAll}"
							action="#{AdvancedSearchBean.clearAndInit}"
							onclick="fullItemReloadAjax();" />
						<h:commandButton id="lnkAdvancedSearchStartSearch"
