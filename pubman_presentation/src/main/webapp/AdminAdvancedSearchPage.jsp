...
<jsp:root version="2.1" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:jsp="http://java.sun.com/JSP/Page" xmlns:rich="http://richfaces.org/rich" xmlns:a4j="http://richfaces.org/a4j" xmlns:c="http://java.sun.com/jsp/jstl/core" >
					...
					<div class="clear">
						<div class="headerSection">
							...
							<div id="contentSkipLinkAnchor" class="clear headLine">
								...
								<h1><h:outputText value="#{lbl.search_lblAdvancedSearchAdmin}" /></h1>
								<!-- Headline ends here -->
							</div>
						</div>
