		...
		<h:form id="form1">
			<div class="full wrapper withoutPageHeader">
				<div id="content" class="full_area0 clear">
					...
					<h:messages errorClass="messageError" infoClass="messageStatus"
						layout="list" globalOnly="true" showDetail="false"
						showSummary="true" rendered="#{AffiliationDetailPage.hasMessages}" />
					<div class="full_area0 fullItem">
						...
						<h:panelGroup layout="block" styleClass="full_area0 itemBlock"
							rendered="#{AffiliationDetailPage.affiliation.hasSuccessors}">
							<h3 class="xLarge_area0_p8 endline blockHeader">
							...
							<div class="free_area0 itemBlockContent endline">
								<!-- any field -->
								<ui:repeat id="successorsDescription" var="successors"
									value="#{AffiliationDetailPage.affiliation.successors}">
									<div class="free_area0 endline itemLine noTopBorder">
										<b class="xLarge_area0_p8 endline labelLine clear"> <h:outputText
						...
						<h:panelGroup layout="block" styleClass="full_area0 itemBlock"
							rendered="#{AffiliationDetailPage.affiliation.hasPredecessors}">
							<h3 class="xLarge_area0_p8 endline blockHeader">
							...
							<div class="free_area0 itemBlockContent endline">
								<!-- any field -->
								<ui:repeat id="predecessorsDescription" var="predecessor"
									value="#{AffiliationDetailPage.affiliation.predecessors}">
									<div class="free_area0 endline itemLine noTopBorder">
										<b class="xLarge_area0_p8 endline labelLine clear"> <h:outputText
												value="#{lbl.AffiliationDetailName}" /><span
											class="noDisplay">: </span>
