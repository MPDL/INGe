						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<div class="subHeader">
								...
								<h:panelGroup layout="block"
									...
									<h:messages id="txtVieItemLogPageTitleWarnMessage"
								...
								<h:panelGroup layout="block"
									...
									<h:messages id="txtViewItemLogPageTitleInfoMessage"
										errorClass="messageError" warnClass="messageWarn"
										fatalClass="messageFatal" infoClass="messageStatus"
										layout="list" globalOnly="true" showDetail="false"
										showSummary="true" rendered="#{ViewItemFull.hasMessages}" />
							...
							<div class="full_area0 fullItemControls">
								<span class="full_area0_p5"> <h:panelGroup
									...
									<h:outputLink id="lnkViewItemLogPageLocalTags"
										...
										id="lnkViewItemLogPageManageAudience" styleClass="free_area0"
									...
									<h:commandLink id="lnkViewItemLogPageStatistics"
										...
										rendered="#{ViewItemFull.isLatestRelease and !ViewItemFull.isStateWithdrawn}" />
									<h:commandLink id="lnkViewItemLogPageRevisions"
