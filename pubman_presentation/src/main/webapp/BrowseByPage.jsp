							...
							<div id="contentSkipLinkAnchor" class="clear headLine">
								...
								<h1>
									<h:outputText value="#{lbl.BrowseByCreator}"
										rendered="#{BrowseByPage.selectedValue == 'persons'}" />
									<h:outputText value="#{lbl.BrowseByYear}"
										rendered="#{BrowseByPage.selectedValue == 'year'}" />
									<h:outputText
										value="#{lbl.BrowseByPage} #{BrowseByPage.selectedValue}"
