						...
						<div class="small_marginLIncl subHeaderSection">
							<div class="contentMenu">
								...
								<div class="free_area0 sub">
									...
									<h:outputText styleClass="seperator void"
										rendered="#{PubItemListSessionBean.totalNumberOfElements>0 }" />
									<h:commandLink id="lnkBasket_lblRemoveSelected"
										title="#{tip.List_lblAddToBasket}" styleClass="free_area0"
										value="#{lbl.Basket_lblRemoveSelected}"
										action="#{CartItemsRetrieverRequestBean.deleteSelected}"
										rendered="#{PubItemListSessionBean.totalNumberOfElements>0 }"
										onclick="fullItemReloadAjax();" />
								...
								<h:panelGroup layout="block" styleClass="xHuge_area0 sub action"
									...
									<h:commandButton id="btnUpdateExportOptions"
										title="#{tip.export_btFormat}"
										styleClass="noDisplay exportUpdateButton"
										action="#{CartItemsRetrieverRequestBean.updateExportOptions}"
