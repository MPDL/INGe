...
<body lang="${InternationalizationHelper.locale}">
	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
		...
		<ui:repeat var="item" value="#{ImportItems.import.items}"
			varStatus="status">

			<h:panelGroup>
				<div class="full_area0" style="margin-bottom: 0.19em;">
					<div class="medium_area0_p8 state noPaddingTopBottom"
						style="margin-left: 2.28em;">
						<h:outputText value="#{item.status}" />
					</div>
					<div class="huge_area0_p8 noPaddingTopBottom"
						style="margin-left: 0.36em; margin-right: 0.19em">
						<h:outputText value="#{item.localizedMessage}"
							rendered="#{item.itemId == null}" />
						<h:outputLink id="lnkItem" value="#{item.link}"
							rendered="#{item.itemId != null}">
							<h:outputText value="#{item.localizedMessage}" />&#160;
							</h:outputLink>
					</div>
					...
					<div class="large_area0_p8 noPaddingTopBottom">
						...
						<a href="#"
							onclick="showDialog($(this).siblings('input').val());return false;">
							Details </a>
