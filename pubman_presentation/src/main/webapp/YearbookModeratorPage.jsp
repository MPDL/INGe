							...
							<h:panelGroup layout="block" styleClass="contentMenu">
								...
								<h:panelGroup layout="block" styleClass="free_area0 sub action"
									...
									<h:panelGroup layout="block" styleClass="xLarge_area1 endline selectContainer">
										...
										<h:selectOneMenu id="selExportFormatName" styleClass="replace" onfocus="updateSelectionBox(this);"
									...
									<h:commandButton id="btnUpdateExportFormats" title="#{tip.export_btFormat}"
										styleClass="noDisplay exportUpdateButton" action="#{ExportItems.updateExportFormats}"
									...
									<h:panelGroup layout="block" styleClass="medium_area1 endline selectContainer"
										...
										<h:selectOneMenu id="selFileFormat" styleClass="replace" onfocus="updateSelectionBox(this);"
											value="#{ExportItemsSessionBean.fileFormat}" onchange="updateSelectionBox(this);">
