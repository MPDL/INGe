						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<h:panelGroup layout="block" styleClass="contentMenu">
								...
								<div class="free_area0 sub action">
									...
									<h:outputText styleClass="seperator void" />
									<h:commandLink id="lnkSendBackForReworkYearbook"
										styleClass="free_area0"
										value="#{lbl.Yearbook_sendBackForReworkYearbook}"
										action="#{YearbookModeratorRetrieverRequestBean.sendBackForRework}"
										onclick="fullItemReloadAjax();" />

									<h:outputText styleClass="seperator void" />
									<h:commandLink id="lnkReleaseYearbook" styleClass="free_area0"
										value="#{lbl.Yearbook_releaseYearbook}"
										action="#{YearbookModeratorRetrieverRequestBean.releaseSelectedYearbooks}"
										onclick="fullItemReloadAjax();" />
								...
								<h:panelGroup layout="block" styleClass="free_area0 sub action"
									...
									<h:commandLink title="#{tip.export_btDownload}"
										...
										action="#{YearbookModeratorRetrieverRequestBean.exportSelectedDownload}" />
								</h:panelGroup>
							...
							<div class="subHeader">
								...
								<h:messages styleClass="singleMessage" errorClass="messageError"
									...
									rendered="#{YearbookModeratorRetrieverRequestBean.numberOfMessages == 1}" />
								<h:panelGroup layout="block"
