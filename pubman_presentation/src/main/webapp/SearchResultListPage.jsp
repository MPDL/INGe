	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
						...
						<div class="small_marginLIncl subHeaderSection">
								...
								<div class="contentMenu">
									...
									<h:panelGroup layout="block" styleClass="free_area0 sub action"
										...
										<h:panelGroup layout="block"
											...
											<h:selectOneMenu id="selEXPORTFORMAT_OPTIONS"
										...
										<h:panelGroup layout="block"
											...
											<h:selectOneMenu id="selFILEFORMAT_OPTIONS"
												styleClass="replace" onfocus="updateSelectionBox(this);"
										...
										<h:panelGroup layout="block"
											...
											<h:outputLink class="fa fa-list-ul"
												value="#{AdvancedSearchEdit.suggestConeUrl}citation-styles/all/format=html"
											...
											<h:commandButton id="btnRemoveCslAutoSuggest" value=" "
												...
												style="display:none;"
												onclick="removeCslAutoSuggest($(this))"
							...
							<h:panelGroup layout="block" styleClass="subHeader"
								...
								<a class="free_area0 xTiny_marginRIncl" href="#"
									onclick="$(this).parents('.subHeaderSection').find('.searchQuery').slideToggle('slow'); $(this).hide();"><h:outputText
										value="#{lbl.ShowQuery}" /></a>
								<h:outputLink id="lnkRestServiceExamplePage"
									styleClass="free_area0 xTiny_marginRIncl"
									value="#{ApplicationBean.pubmanInstanceUrl}/search/SearchAndExport_rest_sample.jsp?#{SearchRetrieverRequestBean.cqlQuery}"
									target="_blank">
									<h:outputText
							...
							<h:panelGroup layout="block" styleClass="subHeader"
								...
								<!-- Subheadline starts here -->
								<h:panelGroup layout="block"
									styleClass="half_area0_p6 searchQuery" style="display: none;">
									<h2>
							...
							<h:panelGroup layout="block" styleClass="subHeader"
								rendered="#{SearchRetrieverRequestBean.searchType == 'org'}">
								<!-- Subheadline starts here -->
								<h:outputLink id="lnkAffiliationTreePage"
									styleClass="free_area0 xTiny_marginRIncl"
									value="AffiliationTreePage.jsp">
									<h:outputText value="#{lbl.SearchResultList_lblAdvancedSearch}" />
								</h:outputLink>
								<!-- Subheadline ends here -->
							</h:panelGroup>
		...
		<script type="text/javascript">
			...
			function checkUpdateCslUi() {
				(typeof updateCslUi == 'function') ? updateCslUi()
						: setTimeout("checkUpdateCslUi()", 30);
			}
		</script>
	</f:view>
</body>
