					...
					<div class="full_area0">
						<div class="full_area0 fullItem">
							<div class="full_area0 fullItemControls">
								<span class="full_area0_p5 underRework"> <b
									...
									<h:outputLink id="lnkViewLocalTagsPage" styleClass="free_area0"
									...
									<h:commandLink id="lnkShowStatistics" styleClass="free_area0"
										action="#{ViewItemFull.showStatistics}"
										rendered="#{ViewItemFull.isLatestRelease and !ViewItemFull.isStateWithdrawn}">
										<h:outputText value="#{lbl.ViewItemFull_btnItemStatistics}" />
									</h:commandLink> <h:panelGroup styleClass="seperator"
										rendered="#{ViewItemFull.isLatestRelease and !ViewItemFull.isStateWithdrawn}" />
									<h:commandLink id="lnkShowRevisions" styleClass="free_area0"
							...
							<div class="full_area0 itemHeader">
								...
								<h:panelGroup layout="block"
									...
									<h:outputLabel id="lblItemPublicState"
							...
							<ui:include src="collaborator/Collaborator.jspf" />
						...
						<div class="full_area0 formButtonArea">
							...
							<h:commandLink styleClass="free_area1_p8 activeButton"
								id="lnkAccept" value="#{lbl.EditItem_lnkSave}"
								action="#{EditItem.acceptLocalTags}"
