						...
						<div class="full_area0 fullItem">
							<div class="full_area0 fullItemControls">
								<span class="full_area0_p5 underRework">
									...
									<h:outputLink id="lnkViewAudiencePage" styleClass="free_area0" value="#{ApplicationBean.appContext}AudiencePage.jsp" rendered="#{ViewItemFull.hasAudience}">
										<h:outputText value="#{lbl.AudiencePage}" />
									</h:outputLink>
									<h:panelGroup styleClass="seperator"/>
									<h:outputLink id="lnkCollaboratorPage" styleClass="free_area0 actual" value="#contentSkipLinkAnchor">
							...
							<jsp:directive.include file="collaborator/Collaborator.jspf" />
