			...
			<h:form>
				<div id="content" class="full_area0 clear">
						...
						<div class="small_marginLIncl subHeaderSection">
							<h:panelGroup layout="block" styleClass="contentMenu">
								<h:panelGroup layout="block" styleClass="free_area0 sub">
									<h:outputLink id="lnkMenuQAWorkspace"
										title="#{tip.chooseWorkspace_QAWorkspace}"
									...
									<h:outputLink id="lnkSubmission_lnkImportWorkspaceMenu"
									...
									<h:panelGroup id="txtMenuYearbookWorkspace"
										rendered="#{LoginHelper.isYearbookEditor}">
										<h:outputText styleClass="seperator void" />
										<h:outputText
							...
							<h:panelGroup layout="block" styleClass="contentMenu"
								rendered="#{YearbookItemSessionBean.yearbookItem!=null}">
								<!-- content menu starts here -->
								<div class="free_area0 sub">
									<h:commandLink id="lnkChangeToCandidates"
										styleClass="free_area0"
										action="#{YearbookItemSessionBean.changeToCandidates}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace!='CANDIDATES'}">
										<h:outputText value="#{lbl.YearbookCandidatesPage}" />
									</h:commandLink>
									<h:outputText id="txtChangeToCandidates"
										styleClass="free_area0" value="#{lbl.YearbookCandidatesPage}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='CANDIDATES'}" />

									<h:outputText styleClass="seperator void" />
									<h:commandLink id="lnkChangeToMembers" styleClass="free_area0"
										action="#{YearbookItemSessionBean.changeToMembers}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace!='MEMBERS'}">
										<h:outputText
											value="#{lbl.YearbookMembersPage} (#{YearbookItemSessionBean.numberOfMembers})" />
									</h:commandLink>
									<h:outputText id="txtChangeToMembers" styleClass="free_area0"
										value="#{lbl.YearbookMembersPage} (#{YearbookItemSessionBean.numberOfMembers})"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='MEMBERS'}" />

									<h:outputText styleClass="seperator void" />
									<h:commandLink id="lnkChangeToNonCandidates"
										styleClass="free_area0"
										action="#{YearbookItemSessionBean.changeToNonCandidates}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace!='NON_CANDIDATES'}">
										<h:outputText value="#{lbl.YearbookNonCandidatesPage}" />
									</h:commandLink>
									<h:outputText id="txtChangeToNonCandidates"
										styleClass="free_area0"
										value="#{lbl.YearbookNonCandidatesPage}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='NON_CANDIDATES'}" />

									<h:outputText styleClass="seperator void" />
									<h:commandLink id="lnkChangeToInvalidItems"
										styleClass="free_area0"
										action="#{YearbookItemSessionBean.changeToInvalidItems}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace!='INVALID'}">
										<h:outputText value="#{lbl.YearbookInvalidItemsPage}" />
									</h:commandLink>
									<h:outputText id="txtChangeToInvalidItems"
										styleClass="free_area0"
										value="#{lbl.YearbookInvalidItemsPage}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='INVALID'}" />

									<h:outputText styleClass="seperator void" />
									<h:outputLink id="lnkChangeToYearbookEditPage"
										styleClass="free_area0" value="YearbookItemEditPage.jsp"
										rendered="#{YearbookItemSessionBean.yearbookItem!=null and YearbookItemSessionBean.yearbookItem.owner==LoginHelper.accountUser.reference and (YearbookItemSessionBean.yearbookItem.version.state=='PENDING' or YearbookItemSessionBean.yearbookItem.version.state=='IN_REVISION')}">
										<h:outputText value="#{lbl.Yearbook_editYearbook}" />
									</h:outputLink>

									<h:outputText styleClass="seperator void" />
									<h:outputLink id="lnkChangeToYearbookArcivePage"
										styleClass="free_area0" value="YearbookArchivePage.jsp">
								...
								<div class="free_area0 sub action">
									...
									<h:commandLink id="lnkChangeSubmenuToExport"
										...
										rendered="#{PubItemListSessionBean.subMenu != 'EXPORT' and YearbookItemSessionBean.selectedWorkspace=='MEMBERS'}"
										onclick="fullItemReloadAjax();" />
									<h:outputText styleClass="free_area0"
										value="#{lbl.List_lblExportOptions}"
									...
									<h:outputText styleClass="seperator void"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='CANDIDATES' and (YearbookItemSessionBean.yearbookItem.version.state=='PENDING' or YearbookItemSessionBean.yearbookItem.version.state=='IN_REVISION')}" />
									<h:commandLink id="lnkAddToYearbook" styleClass="free_area0"
										value="#{lbl.Yearbook_addToYearbook}"
										action="#{YearbookCandidatesRetrieverRequestBean.addSelectedToYearbook}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='CANDIDATES' and (YearbookItemSessionBean.yearbookItem.version.state=='PENDING' or YearbookItemSessionBean.yearbookItem.version.state=='IN_REVISION')}"
										onclick="fullItemReloadAjax();" />

									<h:outputText styleClass="seperator void"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='MEMBERS' and (YearbookItemSessionBean.yearbookItem.version.state=='PENDING' or YearbookItemSessionBean.yearbookItem.version.state=='IN_REVISION')}" />
									<h:commandLink id="lnkRemoveFromYearbook"
										styleClass="free_area0"
										value="#{lbl.Yearbook_removeFromYearbook}"
										action="#{YearbookCandidatesRetrieverRequestBean.removeSelectedFromYearbook}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='MEMBERS' and (YearbookItemSessionBean.yearbookItem.version.state=='PENDING' or YearbookItemSessionBean.yearbookItem.version.state=='IN_REVISION')}"
										onclick="fullItemReloadAjax();" />

									<h:outputText styleClass="seperator void"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='MEMBERS' || YearbookItemSessionBean.selectedWorkspace=='INVALID'}" />
									<h:commandLink id="lnkValidate" styleClass="free_area0"
										value="#{lbl.Yearbook_validate}"
										action="#{YearbookItemSessionBean.validateYearbook}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='MEMBERS' || YearbookItemSessionBean.selectedWorkspace=='INVALID'}"
										onclick="fullItemReloadAjax();" />
									...
									<h:commandLink id="lnkSubmitYearbook" styleClass="free_area0"
										value="#{lbl.Yearbook_submitYearbook}"
										action="#{YearbookItemSessionBean.submitYearbook}"
										rendered="#{YearbookItemSessionBean.selectedWorkspace=='MEMBERS' and (YearbookItemSessionBean.yearbookItem.version.state=='PENDING' or YearbookItemSessionBean.yearbookItem.version.state=='IN_REVISION') and ContextListSessionBean.yearbookContextListSize>0}"
										onclick="fullItemReloadAjax();" />
									&#160;
								...
								<h:panelGroup layout="block" styleClass="free_area0 sub action"
									...
									<h:outputText styleClass="free_area0 clearLeft"
									...
									<h:panelGroup layout="block"
										...
										<h:selectOneMenu id="selSelectedOrgUnit" styleClass="replace"
											...
											value="#{YearbookCandidatesRetrieverRequestBean.selectedOrgUnit}"
											onchange="$(this).parents('div').find('.changeOrgUnit').click();">
											<f:selectItems
												value="#{YearbookCandidatesRetrieverRequestBean.orgUnitSelectItems}" />
										</h:selectOneMenu>
									</h:panelGroup>
									<h:commandButton id="btChangeOrgUnit"
										styleClass="noDisplay changeOrgUnit"
										action="#{YearbookCandidatesRetrieverRequestBean.changeOrgUnit}"
								...
								<h:panelGroup layout="block" styleClass="free_area0 sub action"
									...
									<h:panelGroup layout="block"
										...
										<h:selectOneMenu id="selExportFormatName" styleClass="replace"
											onfocus="updateSelectionBox(this);"
									...
									<h:commandButton id="btnUpdateExportFormats"
										title="#{tip.export_btFormat}"
										styleClass="noDisplay exportUpdateButton"
									...
									<h:commandLink title="#{tip.export_btDownload}"
										id="btnExportDownload" styleClass="free_area0"
										value="#{lbl.Yearbook_btnExport}"
										action="#{YearbookItemSessionBean.exportYearbook}"
										onclick="fullItemReloadAjax();" />
									<!-- content menu lower line ends here -->
								</h:panelGroup>
							...
							<div class="subHeader">
								...
								<h:messages styleClass="singleMessage" errorClass="messageError"
									...
									rendered="#{YearbookCandidatesRetrieverRequestBean.numberOfMessages == 1}" />
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea errorMessageArea"
									rendered="#{YearbookCandidatesRetrieverRequestBean.hasErrorMessages and YearbookCandidatesRetrieverRequestBean.numberOfMessages != 1}">
									<h2>
									...
									<h:messages errorClass="messageError" warnClass="messageWarn"
										...
										showSummary="true"
										rendered="#{YearbookCandidatesRetrieverRequestBean.hasMessages}" />
								</h:panelGroup>
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea infoMessageArea"
									rendered="#{YearbookCandidatesRetrieverRequestBean.hasMessages and !YearbookCandidatesRetrieverRequestBean.hasErrorMessages and YearbookCandidatesRetrieverRequestBean.numberOfMessages != 1}">
									<h2>
					...
					<h:panelGroup
						...
						<h:panelGroup styleClass="full_area0">
							<h:outputText styleClass="free_area0 small_marginLExcl"
								value="#{msg.Yearbook_noYearbookFound}" />
							<h:outputLink styleClass="free_area0 small_marginLExcl"
								value="YearbookItemCreatePage.jsp"
								rendered="#{ContextListSessionBean.yearbookContextListSize>0}">
								<h:outputText value="#{lbl.Yearbook_createYearbook}" />
							</h:outputLink>
						</h:panelGroup>
						<h:panelGroup styleClass="full_area0">
							<h:outputText styleClass="free_area0 small_marginLExcl"
								value="#{msg.Yearbook_loadArchive}" />
							<h:outputLink styleClass="free_area0 small_marginLExcl"
								value="YearbookArchivePage.jsp">
								<h:outputText value="#{lbl.Yearbook_YearbookArchive}" />
							</h:outputLink>
						</h:panelGroup>
					</h:panelGroup>
