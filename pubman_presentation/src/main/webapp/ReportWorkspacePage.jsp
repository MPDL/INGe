...
<body lang="${InternationalizationHelper.locale}">
	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
		...
		<div class="full wrapper">
			...
			<h:outputLink styleClass="skipLink" title="skip link"
				value="#mainMenuSkipLinkAnchor">
			...
			<h:outputLink styleClass="skipLink" title="skip link"
				value="#searchMenuSkipLinkAnchor">
				<h:outputText value="Skip to the search menu" />
			</h:outputLink>
			<h:outputLink styleClass="skipLink" title="skip link"
				value="#metaMenuSkipLinkAnchor">
				...
				<div id="content" class="full_area0 clear">
						...
						<div class="small_marginLIncl subHeaderSection">
							<div class="contentMenu">
								...
								<h:panelGroup layout="block" styleClass="free_area0 sub">
									...
									<h:panelGroup id="txtMenuReportWorkspace"
							...
							<div class="subHeader">
								<h:panelGroup layout="block"
									...
									rendered="#{ReportWorkspaceBean.hasErrorMessages}">
									...
									<h:messages errorClass="messageError" warnClass="messageWarn"
										...
										showSummary="true"
										rendered="#{ReportWorkspaceBean.hasMessages}" />
								</h:panelGroup>
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea infoMessageArea absoluteMessageArea"
									rendered="#{ReportWorkspaceBean.hasMessages and !ReportWorkspaceBean.hasErrorMessages}">
									<input type="button"
					...
					<div class="full_area0">
						...
						<div class="full_area0 formButtonArea">
							...
							<h:commandLink id="lnkGenerateReport"
								styleClass="free_area1_p8 activeButton"
								title="#{tip.easy_submission_btnImport}"
								action="#{ReportWorkspaceBean.generateReport}">
