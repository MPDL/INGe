						...
						<h:panelGroup layout="block"
							...
							<div class="contentMenu">
								...
								<h:panelGroup layout="block" styleClass="free_area0 sub">
									...
									<h:panelGroup id="txtMenuImportWorkspace"
									...
									<h:outputLink id="lnkMenuYearbookWorkspace"
										title="#{tip.chooseWorkspace_YearbookWorkspace}"
										value="#{ApplicationBean.appContext}YearbookPage.jsp"
										rendered="#{LoginHelper.isYearbookEditor}">
										<h:outputText
						...
						<table class="full_area0 itemList listBackground loggedIn"
							...
							<thead style="text-align: left; vertical-align: top;">
								<tr class="full_area0 listHeader">
									...
									<th class="free_area0 endline status statusArea"><h:panelGroup
											styleClass="seperator"></h:panelGroup> <h:outputLink
											id="lnkSort1"
											value="ImportWorkspace.jsp?sortColumn=STATUS&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn != 'STATUS'}">
											<h:outputText styleClass="medium_area0_p8"
												value="#{lbl.import_workspace_status}" />
										</h:outputLink> <h:outputLink id="lnkSort2"
											value="ImportWorkspace.jsp?sortColumn=STATUS&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'STATUS' and ImportWorkspace.sortDirection == 'ASCENDING'}">
											<h:outputText styleClass="medium_area0_p8 ascSort"
												value="#{lbl.import_workspace_status}" />
										</h:outputLink> <h:outputLink id="lnkSort3"
											value="ImportWorkspace.jsp?sortColumn=STATUS&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'STATUS' and ImportWorkspace.sortDirection == 'DESCENDING'}">
											<h:outputText styleClass="medium_area0_p8 desSort"
												value="#{lbl.import_workspace_status}" />
										</h:outputLink></th>
									<th class="large_area0"><h:panelGroup
											styleClass="seperator"></h:panelGroup> <h:outputLink
											id="lnkSort4"
											value="ImportWorkspace.jsp?sortColumn=NAME&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn != 'NAME'}">
											<h:outputText styleClass="large_area0_p8"
												value="#{lbl.import_workspace_name}" />
										</h:outputLink> <h:outputLink id="lnkSort5"
											value="ImportWorkspace.jsp?sortColumn=NAME&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'NAME' and ImportWorkspace.sortDirection == 'ASCENDING'}">
											<h:outputText styleClass="large_area0_p8 ascSort"
												value="#{lbl.import_workspace_name}" />
										</h:outputLink> <h:outputLink id="lnkSort6"
											value="ImportWorkspace.jsp?sortColumn=NAME&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'NAME' and ImportWorkspace.sortDirection == 'DESCENDING'}">
											<h:outputText styleClass="large_area0_p8 desSort"
												value="#{lbl.import_workspace_name}" />
										</h:outputLink></th>
									<th class="large_area0"><h:panelGroup
											styleClass="seperator"></h:panelGroup> <h:outputLink
											id="lnkSort7"
											value="ImportWorkspace.jsp?sortColumn=FORMAT&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn != 'FORMAT'}">
											<h:outputText styleClass="large_area0_p8"
												value="#{lbl.import_workspace_format}" />
										</h:outputLink> <h:outputLink id="lnkSort8"
											value="ImportWorkspace.jsp?sortColumn=FORMAT&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'FORMAT' and ImportWorkspace.sortDirection == 'ASCENDING'}">
											<h:outputText styleClass="large_area0_p8 ascSort"
												value="#{lbl.import_workspace_format}" />
										</h:outputLink> <h:outputLink id="lnkSort9"
											value="ImportWorkspace.jsp?sortColumn=FORMAT&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'FORMAT' and ImportWorkspace.sortDirection == 'DESCENDING'}">
											<h:outputText styleClass="large_area0_p8 desSort"
												value="#{lbl.import_workspace_format}" />
										</h:outputLink></th>
									<th class="large_area0"><h:panelGroup
											styleClass="seperator"></h:panelGroup> <h:outputLink
											id="lnkSort10"
											value="ImportWorkspace.jsp?sortColumn=STARTDATE&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn != 'STARTDATE'}">
											<h:outputText styleClass="large_area0_p8"
												value="#{lbl.import_workspace_startdate}" />
										</h:outputLink> <h:outputLink id="lnkSort11"
											value="ImportWorkspace.jsp?sortColumn=STARTDATE&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'STARTDATE' and ImportWorkspace.sortDirection == 'ASCENDING'}">
											<h:outputText styleClass="large_area0_p8 ascSort"
												value="#{lbl.import_workspace_startdate}" />
										</h:outputLink> <h:outputLink id="lnkSort12"
											value="ImportWorkspace.jsp?sortColumn=STARTDATE&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'STARTDATE' and ImportWorkspace.sortDirection == 'DESCENDING'}">
											<h:outputText styleClass="large_area0_p8 desSort"
												value="#{lbl.import_workspace_startdate}" />
										</h:outputLink></th>
									<th class="large_area0"><h:panelGroup
											styleClass="seperator"></h:panelGroup> <h:outputLink
											id="lnkSort13"
											value="ImportWorkspace.jsp?sortColumn=ENDDATE&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn != 'ENDDATE'}">
											<h:outputText styleClass="large_area0_p8"
												value="#{lbl.import_workspace_enddate}" />
										</h:outputLink> <h:outputLink id="lnkSort14"
											value="ImportWorkspace.jsp?sortColumn=ENDDATE&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'ENDDATE' and ImportWorkspace.sortDirection == 'ASCENDING'}">
											<h:outputText styleClass="large_area0_p8 ascSort"
												value="#{lbl.import_workspace_enddate}" />
										</h:outputLink> <h:outputLink id="lnkSort15"
											value="ImportWorkspace.jsp?sortColumn=ENDDATE&amp;currentColumn=#{ImportWorkspace.sortColumn}&amp;currentDirection=#{ImportWorkspace.sortDirection}"
											rendered="#{ImportWorkspace.sortColumn == 'ENDDATE' and ImportWorkspace.sortDirection == 'DESCENDING'}">
											<h:outputText styleClass="large_area0_p8 desSort"
												value="#{lbl.import_workspace_enddate}" />
										</h:outputLink></th>
									<th class="large_area0"><h:panelGroup
											...
											value="#{lbl.import_workspace_details}" /></th>
									<th class="large_area0 endline"><h:panelGroup
											styleClass="seperator"></h:panelGroup> <h:outputText
											styleClass="large_area0_p8"
											value="#{lbl.import_workspace_actions}" /></th>
								</tr>
							</thead>
							<tbody style="text-align: left; vertical-align: top;">
								<ui:repeat var="import" value="#{ImportWorkspace.imports}"
									varStatus="status">
									<h:panelGroup>
										<tr class="full_area0 listItem">
											<td class="tiny_area0 endline">&#160;</td>
											<td class="free_area0 endline status"><h:panelGroup
													styleClass="seperator"></h:panelGroup> <h:panelGroup
													styleClass="free_area0 endline statusArea">
													<h:panelGroup layout="block"
														styleClass="big_imgArea statusIcon #{import.status} import#{import.status}#{import.errorLevel}" />
													<h:outputLabel id="lblErrorLevel"
														styleClass="free_area0_p3 medium_label endline"
														title="#{import.errorLevel}">
														<h:panelGroup rendered="#{!import.finished}">
															<h:outputText value="#{import.percentage}" />% - </h:panelGroup>
														<h:outputText value="#{import.status}" />
													</h:outputLabel>
													<h:inputHidden id="inpImportLogLink"
														value="#{import.logLink}" />
												</h:panelGroup></td>
											<td class="free_area0 endline"><h:panelGroup
													styleClass="seperator"></h:panelGroup> <span
												class="large_area0_p8"> <h:outputLink id="lnkItems"
											...
											<td class="free_area0 endline"><h:panelGroup
													styleClass="seperator"></h:panelGroup> <span
												class="large_area0_p8"> <h:outputText
											...
											<td class="free_area0 endline"><h:panelGroup
													styleClass="seperator"></h:panelGroup> <span
												class="large_area0_p8 detailsLinkArea"> <h:inputHidden
											...
											<td class="free_area0 endline"><h:panelGroup
													styleClass="seperator"></h:panelGroup> <span
												class="large_area0 endline"> <h:panelGroup
														rendered="false"
