						...
						<div class="small_marginLIncl subHeaderSection">
								...
								<h:panelGroup layout="block" styleClass="free_area0 sub action"
									...
									<h:panelGroup layout="block"
										...
										<h:selectOneMenu id="selSelectedOrgUnit" styleClass="replace"
											...
											value="#{YearbookArchiveRetrieverRequestBean.selectedOrgUnit}"
											onchange="$(this).parents('div').find('.changeOrgUnit').click();">
											<f:selectItems
												value="#{YearbookArchiveRetrieverRequestBean.orgUnitSelectItems}" />
										</h:selectOneMenu>
									</h:panelGroup>
									<h:commandButton id="btChangeOrgUnit"
										styleClass="noDisplay changeOrgUnit"
										action="#{YearbookArchiveRetrieverRequestBean.changeOrgUnit}"
								...
								<h:panelGroup layout="block" styleClass="free_area0 sub action"
									...
									<h:panelGroup layout="block"
										...
										<h:selectOneMenu id="selExportFormatName" styleClass="replace"
											...
											<f:selectItems
												value="#{ExportItems.EXPORTFORMAT_OPTIONS_EXTENDED}" />
										</h:selectOneMenu>
									</h:panelGroup>
									...
									<h:commandLink title="#{tip.export_btDownload}"
										...
										value="#{lbl.export_lblExport}"
										action="#{YearbookArchiveRetrieverRequestBean.exportSelectedDownload}" />
									<!-- content menu lower line ends here -->
								</h:panelGroup>
							...
							<div class="subHeader">
								...
								<h:messages styleClass="singleMessage" errorClass="messageError"
									...
									rendered="#{YearbookArchiveBean.numberOfMessages == 1}" />
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea errorMessageArea"
									rendered="#{YearbookArchiveBean.hasErrorMessages and YearbookArchiveBean.numberOfMessages != 1}">
									<h2>
									...
									<h:messages errorClass="messageError" warnClass="messageWarn"
										...
										showSummary="true"
										rendered="#{YearbookItemCreateBean.hasMessages}" />
								</h:panelGroup>
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea infoMessageArea"
									rendered="#{YearbookArchiveBean.hasMessages and !YearbookArchiveBean.hasErrorMessages and YearbookArchiveBean.numberOfMessages != 1}">
									<h2>
									...
									<h:messages errorClass="messageError" warnClass="messageWarn"
										...
										layout="list" globalOnly="true" showDetail="false"
										showSummary="true"
										rendered="#{YearbookArchiveBean.hasMessages}" />
								</h:panelGroup>
