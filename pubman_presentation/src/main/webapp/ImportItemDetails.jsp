...
<body lang="${InternationalizationHelper.locale}">
	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
		...
		<div class="xHuge_area2_p8 messageArea"
			style="height: 28.37em; overflow-y: auto;">

			<input type="button" id="btnClose"
				onclick="currentDialog.dialog('close')" value=" "
				class="min_imgBtn quad_marginLIncl fixMessageBlockBtn" />
			...
			<h:panelGroup styleClass="free_area0" style="margin-bottom: 0.56em;"
				rendered="#{ImportItemDetails.length == 0}">
