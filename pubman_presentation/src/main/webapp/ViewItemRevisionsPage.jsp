...
<body lang="${InternationalizationHelper.locale}">
	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
		...
		<div class="full wrapper">
			...
			<h:outputLink id="lnkViewItemRevisionsPageMainMenu"
				styleClass="skipLink" title="skip link"
				value="#mainMenuSkipLinkAnchor">
				<h:outputText value="Skip to the main menu" />
			</h:outputLink>
			<h:outputLink id="lnkViewItemRevisionsPageContent"
				styleClass="skipLink" title="skip link"
				value="#contentSkipLinkAnchor">
				<h:outputText value="Skip to the page content" />
			</h:outputLink>
			<h:outputLink id="lnkViewItemRevisionsPageSearch"
				styleClass="skipLink" title="skip link"
				value="#searchMenuSkipLinkAnchor">
				<h:outputText value="Skip to the search menu" />
			</h:outputLink>
			<h:outputLink id="lnkViewItemRevisionsPageMeta" styleClass="skipLink"
				title="skip link" value="#metaMenuSkipLinkAnchor">
				...
				<div id="content" class="full_area0 clear">
					...
					<div class="full_area0">
						<div class="full_area0 fullItem">
							<div class="full_area0 fullItemControls">
								<span class="full_area0_p5"> <h:panelGroup
									...
									<h:commandLink styleClass="free_area0"
										...
										rendered="#{ViewItemFull.isLatestRelease and !ViewItemFull.isStateWithdrawn}" />
									<h:commandLink styleClass="free_area0 actual"
							...
							<ui:include src="revisions/ViewRevisions.jspf" />
