	...
	<f:view locale="#{InternationalizationHelper.userLocale}">
		...
		<f:loadBundle var="msg" basename="Messages"/>
			<html>
				...
				<body>
					<h:outputText id="pageDummy" value="#{viewItemPage.beanName}" style="height: 0px; width: 0px; visibility:hidden; position: absolute" />
					<div id="page_margins">
						<div id="page">
							<h:form id="form2">
								<div id="header">
								...
								<div id="main">
									...
									<div id="col3">
										<div class="content">
											<jsp:directive.include file="viewItem/viewItem.jspf"/>
										</div>
									</div>
								</div>
