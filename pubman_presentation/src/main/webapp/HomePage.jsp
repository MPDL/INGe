...
<h:head>
	...
	<link rel="sword" type="application/xml"
		title="Sword Servicedocument Location"
		href="${ApplicationBean.pubmanInstanceUrl}/pubman/faces/sword-app/servicedocument" />
						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<div class="subHeader">
								...
								<h:messages styleClass="singleMessage" errorClass="messageError"
									...
									rendered="#{HomePage.numberOfMessages == 1}" />
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea errorMessageArea"
									rendered="#{HomePage.hasErrorMessages and HomePage.numberOfMessages != 1}">
									<h2>
									...
									<h:messages errorClass="messageError" warnClass="messageWarn"
										...
										showSummary="true" rendered="#{HomePage.hasMessages}" />
								</h:panelGroup>
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea infoMessageArea"
									rendered="#{HomePage.hasMessages and !HomePage.hasErrorMessages and HomePage.numberOfMessages != 1}">
									<h2>
								...
								<h:outputText value="&#160;"
									rendered="#{!HomePage.hasErrorMessages}" />
					...
					<div class="full_area0">
						<div class="full_area0 infoPage">
							...
							<h:panelGroup styleClass="half_area0_p8 mainSection"
								rendered="#{!PubManSessionBean.loggedIn and InternationalizationHelper.homeContent!=null}">
								<h:outputText value="#{InternationalizationHelper.homeContent}"
									escape="false" />
							</h:panelGroup>
							...
							<h:panelGroup styleClass="half_area0_p8 mainSection"
								rendered="#{PubManSessionBean.loggedIn}">
							...
							<h:panelGroup styleClass="sideSectionArea">
								<h:panelGroup styleClass="free_area0_p8 sideSection">
									...
									<h:panelGroup
										rendered="#{ApplicationBean.pubmanBlogFeedUrl != ''}">
