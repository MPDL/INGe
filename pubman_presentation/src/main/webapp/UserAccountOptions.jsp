					...
					<div class="clear">
						...
						<h:panelGroup id="messages" styleClass="subHeader">
							<h:panelGroup layout="block"
								styleClass="half_area2_p6 messageArea errorMessageArea absoluteMessageArea small_marginLExcl"
								rendered="#{UserAccountOptions.hasErrorMessages}">
								...
								<h:messages errorClass="messageError" warnClass="messageWarn"
									...
									showSummary="true" rendered="#{UserAccountOptions.hasMessages}" />
							</h:panelGroup>
							<h:panelGroup layout="block"
								styleClass="half_area2_p6 messageArea infoMessageArea absoluteMessageArea small_marginLExcl"
								rendered="#{UserAccountOptions.hasMessages and !UserAccountOptions.hasErrorMessages}">
								<input type="button"
