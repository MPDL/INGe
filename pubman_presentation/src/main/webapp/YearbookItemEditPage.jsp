				...
				<div id="content" class="full_area0 clear">
					...
					<div class="clear">
						<div class="headerSection">
							...
							<div id="contentSkipLinkAnchor" class="clear headLine">
								...
								<h1>
									<h:outputText value="#{lbl.YearbookItemEditPage}" />
								</h1>
								<!-- Headline ends here -->
							</div>
						</div>
						<div class="small_marginLIncl subHeaderSection">
							...
							<div class="subHeader">
								...
								<h:messages styleClass="singleMessage" errorClass="messageError"
									...
									rendered="#{YearbookItemEditBean.numberOfMessages == 1}" />
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea errorMessageArea"
									rendered="#{YearbookItemEditBean.hasErrorMessages and YearbookItemEditBean.numberOfMessages != 1}">
									<h2>
								...
								<h:panelGroup layout="block"
									...
									rendered="#{YearbookItemEditBean.hasMessages and !YearbookItemEditBean.hasErrorMessages and YearbookItemEditBean.numberOfMessages != 1}">
									<h2>
									...
									<h:messages errorClass="messageError" warnClass="messageWarn"
										...
										layout="list" globalOnly="true" showDetail="false"
										showSummary="true"
										rendered="#{YearbookItemEditBean.hasMessages}" />
								</h:panelGroup>
					...
					<div class="full_area0">
						<div id="editItem" class="full_area0 fullItem">
							<ui:include src="yearbook/EditYearbookItem.jspf" />
						</div>

						<div class="full_area0 formButtonArea">
							<h:commandLink
								styleClass="free_area1_p8 cancelButton xLarge_marginLIncl"
								id="lnkCancel" value="Cancel"
								action="#{YearbookItemEditBean.cancel}"
								onclick="fullItemReloadAjax();" />
							<h:commandLink styleClass="free_area1_p8 activeButton"
								id="lnkSave" value="Save" action="#{YearbookItemEditBean.save}"
								onclick="fullItemReloadAjax();" />
						</div>
					</div>
					<!-- end: content section -->
