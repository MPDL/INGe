						...
						<div class="small_marginLIncl subHeaderSection">
							...
							<div class="subHeader">
								...
								<h:messages styleClass="singleMessage" errorClass="messageError"
									...
									rendered="#{WithdrawItem.numberOfMessages == 1}" />
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea errorMessageArea"
									rendered="#{WithdrawItem.hasErrorMessages and WithdrawItem.numberOfMessages > 1}">
									<h2>
										<h:outputText value="#{lbl.warning_lblMessageHeader}" />
									</h2>
									<h:messages id="txtWithdrawItemPageWarn"
										...
										showSummary="true" rendered="#{WithdrawItem.hasMessages}" />
								</h:panelGroup>
								<h:panelGroup layout="block"
									styleClass="half_area2_p6 messageArea infoMessageArea"
									rendered="#{WithdrawItem.hasMessages and !WithdrawItem.hasErrorMessages and WithdrawItem.numberOfMessages > 1}">
									<h2>
										<h:outputText value="#{lbl.info_lblMessageHeader}" />
									</h2>
									<h:messages id="txtWithdrawItemPageInfo"
										errorClass="messageError" warnClass="messageWarn"
										fatalClass="messageFatal" infoClass="messageStatus"
										layout="list" globalOnly="true" showDetail="false"
										showSummary="true" rendered="#{WithdrawItem.hasMessages}" />
					...
					<div class="full_area0">
						...
						<div class="full_area0 formButtonArea">
							...
							<h:commandLink
								...
								id="lnkCancel" value="#{lbl.WithdrawItem_lnkCancel}"
								action="#{WithdrawItem.cancel}" onclick="fullItemReloadAjax();" />
							<h:commandLink styleClass="free_area1_p8 activeButton"
								id="lnkSave" value="#{lbl.WithdrawItem_lnkWithdraw}"
								action="#{WithdrawItem.withdraw}"
