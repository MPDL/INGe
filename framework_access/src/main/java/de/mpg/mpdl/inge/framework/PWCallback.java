 ...
 * <p/>
 * Sets the eSciDoc user handle as the password if the technical username "eSciDocUser" is provided
 * when calling the webservice.<br>
 * This password can be changed by using the <code>setHandle</code> and reset by using the
