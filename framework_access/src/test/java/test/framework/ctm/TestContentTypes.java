 ...
 */
public class TestContentTypes extends TestBase
{
	...
	public void retrieveContentTypePubItem() throws Exception
	{
        ...
        String type = ServiceLocator.getContentTypeHandler(userHandle).retrieve(id);
     ...
     * Test method for {@link de.fiz.escidoc.ctm.ContentTypeHandlerLocal#retrieve(java.lang.String)}.
     */
    @Test (expected=ContentTypeNotFoundException.class)
