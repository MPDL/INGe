...
public class TestContext extends TestBase {
  ...
  /**
   * Test method for
   * {@link de.fiz.escidoc.om.ItemHandlerLocal#retrieveContexts(java.lang.String,java.lang.String)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.fiz.escidoc.om.ItemHandlerLocal#retrieveMembers(java.lang.String,java.lang.String)}.
   */
  /*
   * @Test public void retrieveMembers() throws Exception { String id = PUBMAN_COLLECTION_ID; String
   * filter = FILTER_ALL; long zeit = -System.currentTimeMillis(); String members =
   * ServiceLocator.getContextHandler(userHandle).retrieveMembers(id, filter); zeit +=
   * System.currentTimeMillis(); logger.info("retrieveMembers(" + id + "," + filter + ")->" + zeit +
   * "ms"); logger.debug("Members(" + id + ")=" + members); assertNotNull(members); }
   */
  /**
   * Test method for
   * {@link de.fiz.escidoc.om.ItemHandlerLocal#retrieveContexts(java.lang.String,java.lang.String)}.
   */
  /*
   * @Test public void retrieveMembersNotExisting() throws Exception { String id =
   * PUBMAN_COLLECTION_ID; String filter = FILTER_NONE; long zeit = -System.currentTimeMillis();
   * String members = ServiceLocator.getContextHandler(userHandle).retrieveMembers(id, filter); zeit
   * += System.currentTimeMillis(); logger.info("retrieveMembersNotExisting(" + id + "," + filter +
   * ")->" + zeit + "ms"); logger.debug("Members(" + id + ")=" + members); assertNotNull(members); }
   */
  /**
   * Test method for
   * {@link de.fiz.escidoc.om.ItemHandlerLocal#retrieveContexts(java.lang.String,java.lang.String)}.
  ...
  public void retrieveMembersContextNotFound() throws Exception {
    ...
    try {
      String members =
          ServiceLocator.getContextHandler(userHandle).retrieveMembers(ILLEGAL_CONTEXT_ID,
              filterMap);
      assertTrue(members, false);
    } finally {
      zeit += System.currentTimeMillis();
      logger.info("retrieveMembersContextNotFound(" + ILLEGAL_CONTEXT_ID + "," + filterMap + ")->"
          + zeit + "ms");
    }
  }
}
