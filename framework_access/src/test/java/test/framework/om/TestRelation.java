...
public class TestRelation extends TestItemBase {
  ...
  public void addRelationToContentItemNotExisting() throws Exception {
    ...
    String param =
        "<param last-modification-date=\"" + md + "\">" + "    <relation>" + "        <targetId>"
            + id + "</targetId>" + "        <predicate>" + PREDICATE_ISREVISIONOF + "</predicate>"
            + "    </relation>" + "</param>";
    logger.debug("Param=" + param);
    long zeit = -System.currentTimeMillis();
    try {
  ...
  public void removeRelationFromContentItemNotExisting() throws Exception {
    ...
    String param =
        "<param last-modification-date=\"" + sourceMd + "\">" + "    <relation>"
            + "        <targetId>" + sourceId + "</targetId>" + "        <predicate>"
            + PREDICATE_ISREVISIONOF + "</predicate>" + "    </relation>" + "</param>";
    logger.debug("Param=" + param);
    long zeit = -System.currentTimeMillis();
    try {
  ...
  public void removeRelationFromContentItemRelationNotExisting() throws Exception {
    ...
    try {
      ...
      zeit += System.currentTimeMillis();
      logger.info("removeRelationFromContentItemRelationNotExisting(" + sourceId + ")->" + zeit
          + "ms");
    }
  }
}
