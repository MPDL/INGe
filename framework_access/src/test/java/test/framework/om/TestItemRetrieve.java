...
public class TestItemRetrieve extends TestItemBase {
  ...
  public void retrievePendingContentItems() throws Exception {
    ...
    zeit += System.currentTimeMillis();
    logger.info("retrievePendingContentItems(" + filterMap.entrySet().toString() + ")->" + zeit
        + "ms");
    logger.debug("ContentItems =" + items);
    assertNotNull(items);
    assertTrue(countItems(items) > 0);
  ...
  public void retrievePendingContentItemsSortByDescending() throws Exception {
    ...
    String items = ServiceLocator.getItemHandler(userHandle).retrieveItems(filterMap);
    zeit += System.currentTimeMillis();
    logger.info("retrievePendingContentItemsSortByDescending(" + filterMap.entrySet().toString()
        + ")->" + zeit + "ms");
  ...
  public void retrievePendingContentItemsSortByAscending() throws Exception {
    ...
    String items = ServiceLocator.getItemHandler(userHandle).retrieveItems(filterMap);
    zeit += System.currentTimeMillis();
    logger.info("retrievePendingContentItemsSortByAscending(" + filterMap.entrySet().toString()
        + ")->" + zeit + "ms");
    logger.info("ContentItems =" + items);
    assertNotNull(items);
    assertTrue(countItems(items) > 0);
  ...
  public void retrieveOwnContentItems() throws Exception {
    filterMap.put(OPERATION, new String[] {SEARCH_RETRIEVE});
    filterMap.put(VERSION, new String[] {"1.1"});
    filterMap.put(QUERY, new String[] {"\"/properties/created-by/id\"=escidoc:3013" + " and "
  ...
  public void retrieveDefinedContentItems() throws Exception {
    ...
    String query =
        "\"/id\"=" + ids[0] + " or " + "\"/id\"=" + ids[1] + " or " + "\"/id\"=" + ids[2];
    filterMap.put(OPERATION, new String[] {SEARCH_RETRIEVE});
    filterMap.put(VERSION, new String[] {"1.1"});
  ...
  public void retrieveContentItemsOfNotExistingType() throws Exception {
    ...
    String items = ServiceLocator.getItemHandler(userHandle).retrieveItems(filterMap);
    zeit += System.currentTimeMillis();
    logger.info("retrieveContentItemsOfNotExistingType(" + filterMap.entrySet().toString() + ")->"
        + zeit + "ms");
    logger.debug("ContentItems" + items);
    assertNotNull(items);
    assertTrue(countItems(items) == 0);
  ...
  public void retrievePendingContentItemsUsingMaxRecords() throws Exception {
    ...
    String items = ServiceLocator.getItemHandler(userHandle).retrieveItems(filterMap);
    zeit += System.currentTimeMillis();
    logger.info("retrievePendingContentItemsUsingMaxRecords(" + filterMap.entrySet().toString()
        + ")->" + zeit + "ms");
    logger.debug("ContentItems =" + items);
    assertNotNull(items);
  ...
  public void retrievePendingContentItemRefs() throws Exception {
    /*
     * String filter =
     * "<param><filter name=\"http://escidoc.de/core/01/properties/public-status\">pending</filter></param>"
     * ; logger.debug("Filter=" + filter); long zeit = -System.currentTimeMillis(); String items =
     * ServiceLocator.getItemHandler(userHandle).retrieveItems(filter); zeit +=
     * System.currentTimeMillis(); logger.info("retrievePendingContentItemRefs(" + filter + ")->" +
     * zeit + "ms"); logger.debug("ContentItems(" + filter + ")=" + items); assertNotNull(items);
  ...
  public void retrieveContentItemRefsNotExisting() throws Exception {
     ...
     * ")->" + zeit + "ms"); logger.debug("ContentItems(" + filter + ")=" + items);
     * assertNotNull(items); assertTrue(countItemRefs(items) == 0);
     */
  }
}
