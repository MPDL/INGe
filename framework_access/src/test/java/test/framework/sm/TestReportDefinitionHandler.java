...
public class TestReportDefinitionHandler {
  ...
  /**
   * Test method for
   * {@link de.fiz.escidoc.sm.ReportDefinitionHandlerLocal#retrieveReportDefinitions(java.lang.String)}
   * .
   */
  @Test
  public void retrieveReportDefinitions() throws Exception {
    ...
    String definitions =
        ServiceLocator.getReportDefinitionHandler().retrieveReportDefinitions(null);
  ...
  /**
   * Test method for
   * {@link de.fiz.escidoc.sm.ReportDefinitionHandlerLocal#retrieve(java.lang.String)}.
   */
  @Test
