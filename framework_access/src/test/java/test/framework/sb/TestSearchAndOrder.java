...
public class TestSearchAndOrder extends TestBase {
  ...
  public void sortByType() throws Exception {
    ...
    searchRetrieveRequest
        .setSortKeys("sort.escidoc.publication.type sort.escidoc.publication.degree");
  ...
  public void sortByTitle() {
    ...
    searchRetrieveRequest.setVersion("1.1");
    searchRetrieveRequest
        .setQuery("escidoc.objecttype=\"item\" and escidoc.context.objid=\"escidoc:1002\"");
  ...
  private List<String> getTypes(SearchRetrieveResponseType searchResult) throws Exception {
