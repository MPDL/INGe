...
public class TestSimpleSearch extends TestItemBase {
  ...
  public void searchWithTwoBooleanOperatorsAndParenthesis() throws Exception {
    String query =
        "escidoc.metadata=Schmid or (escidoc.metadata=Metzger and escidoc.metadata=Apolonsko)";
    executeSearch(query, 1);
  }
  ...
  public void searchWithTwoBooleanOperatorsAndParenthesis2() throws Exception {
    String query =
        "(escidoc.metadata=Metzger and escidoc.metadata=Apolonsko) or escidoc.metadata=Schmid";
    executeSearch(query, 1);
  }
  ...
  public void searchWithNotOperatorAndParenthesis() throws Exception {
    String query =
        "(escidoc.metadata=Metzger and escidoc.metadata=Apolonski) not escidoc.metadata=Schmid";
  ...
  public void searchWithWildcardAsteriskAtStart() throws Exception {
    ...
    // ServiceLocator.getSearchHandler(null).searchRetrieveOperation(
    // searchRetrieveRequest);

    // assertNotNull(searchResult);
    // assertEquals("Wrong number of result records for query: " + query, 0,
  ...
  private void executeSearch(String query, int expectedRecords) throws Exception {
    ...
    // SearchRetrieveResponseType searchResult =
    // ServiceLocator.getSearchHandler(null).searchRetrieveOperation(searchRetrieveRequest);
    ...
    // {
    // assertEquals("Wrong number of result records for query: " + query, expectedRecords,
    // searchResult
