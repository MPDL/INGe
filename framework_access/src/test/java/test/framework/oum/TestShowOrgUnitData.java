...
public class TestShowOrgUnitData extends TestBase {
  ...
  private void showUnits(String units, String line) throws Exception {
    ...
    final String nodes[] =
        {"abbreviation", "name", "uri", "description", "postcode", "country", "region", "address",
  ...
  public void showOrganizationalUnits() throws Exception {
    ...
    /*
     * String units =
     * ServiceLocator.getOrganizationalUnitHandler().retrieveOrganizationalUnits(filter);
     * logger.debug("units=" + units); assertNotNull(units); logger.info(LINE);
