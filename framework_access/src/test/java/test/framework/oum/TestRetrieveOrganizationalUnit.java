...
public class TestRetrieveOrganizationalUnit extends TestBase {
  ...
  /**
   * Test method for
   * {@link de.escidoc.www.services.oum.OrganizationalUnitHandlerRemote#retrieveOrganizationalUnits(java.util.Map)}
   * .
   */
  @Test
  public void retrieveOrganizationalUnits() throws Exception {
    ...
    String unit =
        ServiceLocator.getOrganizationalUnitHandler().retrieveOrganizationalUnits(filterMap);
  ...
  /**
   * Test method for
   * {@link de.escidoc.www.services.oum.OrganizationalUnitHandlerRemote#retrieve(java.lang.String)}.
   */
  @Test
  ...
  public void retrieveOrganizationalUnitWithSysAdmin() throws Exception {
    ...
    long zeit = -System.currentTimeMillis();
    String unit =
        ServiceLocator.getOrganizationalUnitHandler(loginSystemAdministrator()).retrieve(id);
    zeit += System.currentTimeMillis();
  ...
  /**
   * Test method for
   * {@link de.escidoc.www.services.oum.OrganizationalUnitHandlerRemote#retrieveParents(java.lang.String)}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.escidoc.www.services.oum.OrganizationalUnitHandlerRemote#retrieveChildren(java.lang.String)}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.escidoc.www.services.oum.OrganizationalUnitHandler#retrievePathList(java.lang.String)}
   * .
   */
  @Test
