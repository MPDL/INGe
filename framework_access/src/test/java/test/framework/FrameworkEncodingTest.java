...
public class FrameworkEncodingTest {
  ...
  public void testHttpGetEncoding() throws HttpException, IOException, ServiceException,
    ...
    // if the size of the response body changes during conversion to UTF8, then it couldn't have
    // been UTF8 before.
    assertEquals("Response body contains non-UTF-8 characters!", responseBodyBytes.length,
        responseBodyUtf8Bytes.length);
  }
}
