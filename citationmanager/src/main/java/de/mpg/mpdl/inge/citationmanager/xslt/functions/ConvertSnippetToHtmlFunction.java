...
/**
 * s9api extension function: jfunc:convertSnippetToHtml(string) as xs:string Namespace URI:
 * https://pubman.mpdl.mpg.de/xslt-helper-functions
 */
public final class ConvertSnippetToHtmlFunction implements ExtensionFunction {

  private static final QName NAME = new QName("jfunc", "https://pubman.mpdl.mpg.de/xslt-helper-functions", "convertSnippetToHtml");
  ...
  public XdmValue call(XdmValue[] arguments) throws SaxonApiException {
    ...
    String result = XsltHelper.convertSnippetToHtml(s);
