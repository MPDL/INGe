 ...
 * the special layout format defined by the citation style. At present CitationStyle handler
 * provides only the following operations: explainStyles and getOutput. Further releases may add
 * some methods for management i.e. create/update/retrieve of particular citation style definitions.
 * 
...
public interface CitationStyleHandler {
  ...
  /**
   * This method provides XML formatted output of the citation styles (layout formats) with their
   * supported output file formats. The XML formatted output of the citation styles is created in
   * accordance with the explain_styles.xsd.
   */
  String explainStyles() throws IllegalArgumentException, IOException,
  ...
  /**
   * The method returns the list of the available citation styles
   * 
   * @throws StructuredExportManagerException
   */
  ...
  /**
   * The method returns the list of available output formats for citation style <code>cs</code>
   * 
   ...
   * @param itemList A XML containing the item list for which the output should be taken. Item list
   ...
   */
  byte[] getOutput(String itemList, ExportFormatVO exportFormat) throws IOException, JRException,
      CitationStyleManagerException;
