...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:cit="http://www.escidoc.de/citationstyle"
	...
	xmlns:functx="http://www.functx.com" xmlns:ei="http://www.escidoc.de/schemas/item/0.10"
	...
	xmlns:e="http://purl.org/escidoc/metadata/terms/0.1/" xmlns:prop="http://escidoc.de/core/01/properties/"
	xmlns:escidocComponents="http://www.escidoc.de/schemas/components/0.9"
	xmlns:source="http://purl.org/escidoc/metadata/profiles/0.1/source"
	xmlns:eterms="http://purl.org/escidoc/metadata/terms/0.1/" xmlns:event="http://purl.org/escidoc/metadata/profiles/0.1/event"
				...
				<xsl:variable name="citation">
					<xsl:for-each select="../../mdr:md-records/mdr:md-record"><!--### Global Default Variables ### -->
						...
						<xsl:variable name="l_issue">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/issue'" />
						</xsl:variable>
						...
						<xsl:variable name="l_conference-report">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/conference-report'" />
						</xsl:variable>
						...
						<xsl:variable name="l_paper">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/paper'" />
						</xsl:variable>
						<xsl:variable name="l_talk-at-event">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/talk-at-event'" />
						</xsl:variable>
						<xsl:variable name="l_courseware-lecture">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/courseware-lecture'" />
						</xsl:variable>
						...
						<xsl:variable name="l_manuscript">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/manuscript'" />
						</xsl:variable>
						...
						<xsl:variable name="l_case-note">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/case-note'" />
						</xsl:variable>
						<xsl:variable name="l_opinion">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/opinion'" />
						</xsl:variable>
						<xsl:variable name="l_case-study">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/case-study'" />
						</xsl:variable>
						<xsl:variable name="l_book-review">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/book-review'" />
						</xsl:variable>
						<xsl:variable name="l_contr-to-commentary">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/contribution-to-commentary'" />
						</xsl:variable>
						<xsl:variable name="l_contr-to-festschrift">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/contribution-to-festschrift'" />
						</xsl:variable>
						<xsl:variable name="l_contr-to-handbook">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/contribution-to-handbook'" />
						</xsl:variable>
						<xsl:variable name="l_contr-to-encyclopedia">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/contribution-to-encyclopedia'" />
						</xsl:variable>
						<xsl:variable name="l_newspaper-article">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/newspaper-article'" />
						</xsl:variable>
						...
						<xsl:variable name="l_festschrift">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/festschrift'" />
						</xsl:variable>
						...
						<xsl:variable name="l_editorial">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/publication-types/editorial'" />
						</xsl:variable>
						<xsl:variable name="l_patent">
							<xsl:value-of
								select="'http://purl.org/eprint/type/Patent'" />
						</xsl:variable>
						...
						<xsl:variable name="l_painter">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/creator-roles/painter'" />
						</xsl:variable>
						...
						<xsl:variable name="l_publisher">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/creator-roles/publisher'" />
						</xsl:variable>
						...
						<xsl:variable name="l_contributor">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/creator-roles/founder'" />
						</xsl:variable>
						<xsl:variable name="l_contributor">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/creator-roles/referee'" />
						</xsl:variable>
						<xsl:variable name="l_master">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/academic-degrees/master'" />
						</xsl:variable>
						<xsl:variable name="l_diploma">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/academic-degrees/diploma'" />
						</xsl:variable>
						<xsl:variable name="l_magister">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/academic-degrees/magister'" />
						</xsl:variable>
						<xsl:variable name="l_staatsexamen">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/academic-degrees/staatsexamen'" />
						</xsl:variable>
						<xsl:variable name="l_phd">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/academic-degrees/phd'" />
						</xsl:variable>
						<xsl:variable name="l_habilitation">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/academic-degrees/habilitation'" />
						</xsl:variable>
						<xsl:variable name="l_bachelor">
							<xsl:value-of
								select="'http://purl.org/escidoc/metadata/ves/academic-degrees/bachelor'" />
						</xsl:variable>
						...
						<xsl:variable name="sourceEditorsCount">
							<xsl:value-of
								select="count(pub:publication/source:source[1]/eterms:creator[@role=$l_editor])" />
						</xsl:variable>
						...
						<xsl:variable name="genre-exception" as="xs:boolean">
							<xsl:value-of
								select="$genre=( $l_poster, $l_talk-at-event, $l_courseware-lecture )" />
						</xsl:variable>
						<xsl:variable name="date">
							<xsl:value-of
								...
								else if (pub:publication/eterms:published-online and $genre=$l_patent)
									then func:get_year(pub:publication/eterms:published-online)
								else if (pub:publication/eterms:published-online and not($genre=$l_patent))
									then concat(func:get_year(pub:publication/eterms:published-online),' online') 
						...
						<xsl:variable name="urn">
							<xsl:value-of select="(pub:publication/dc:identifier[@xsi:type='eterms:URN'])[1]/text()"/>
						</xsl:variable>
						<xsl:variable name="doiLink"><!--AS LINK!-->
							<xsl:if test="($doi!='')">
						...
						<xsl:variable name="sourceSeriesEnumeration">
							<xsl:for-each select="pub:publication/source:source[@type='http://purl.org/escidoc/metadata/ves/publication-types/series']">
								<xsl:variable name="var" select="dc:title" />
								...
								<xsl:if test="eterms:volume and eterms:volume != ''">
									<xsl:text>&#160;;&#160;</xsl:text>
									<xsl:value-of select="eterms:volume" />
								</xsl:if>
								<xsl:if test="exists($var) and $var!=''">
									<xsl:text>)</xsl:text>
								</xsl:if>
								...
								<xsl:if test="eterms:place != '' or eterms:start-date != '' or eterms:end-date !='' ">
									...
									<xsl:call-template name="applyDelimiter">
										<xsl:with-param name="les">
											<le>
												<xsl:value-of select="eterms:place"/>
											</le>
											<le>
												<xsl:value-of select="fn:substring(eterms:start-date,1,4)"/>
											</le>
										</xsl:with-param>
						...
						<xsl:variable name="publisherData">
							<xsl:value-of select="pub:publication/eterms:publishing-info/eterms:place/text()" />
							<xsl:if test="pub:publication/eterms:publishing-info/eterms:place and pub:publication/eterms:publishing-info/dc:publisher">
								<xsl:text>&#160;:&#160;</xsl:text>
							</xsl:if>
							<xsl:value-of select="pub:publication/eterms:publishing-info/dc:publisher/text()" />
						</xsl:variable>
						<xsl:variable name="pageCount">
							<xsl:if test="pub:publication/eterms:total-number-of-pages!=''">
								<xsl:value-of select="pub:publication/eterms:total-number-of-pages"/>
								<xsl:text>&#160;p.</xsl:text>
							</xsl:if>
						</xsl:variable>
							...
							<xsl:variable name="var">
								<xsl:call-template name="applyDelimiter">
									<xsl:with-param name="les">
										<le>
											<xsl:variable name="var">
												<xsl:variable name="var" select="$ed-postfix" />
												<!--valid-if -->
												<xsl:variable name="var">
													<xsl:if test="$editorsCount=1"><!--i18n -->
														<xsl:variable name="var">
															<xsl:if test="exists($var) and $var!=''">
								...
								<xsl:call-template name="applyDelimiter">
									<xsl:with-param name="les">
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var" select="$source-ed-postfix" />
												<!--valid-if -->
												<xsl:variable name="var">
													<xsl:if test="$sourceEditorsCount=1"><!--i18n -->
														<xsl:variable name="var">
															<xsl:if test="exists($var) and $var!=''">
																<xsl:text>&lt;localized class="editor"&gt;</xsl:text>
																<xsl:copy-of select="$var" />
						...
						<xsl:variable name="year-for-thesis"><!--### Plain Layout Element ### -->
							<!--### @ref is available ### -->
							<xsl:variable name="var" select="$date-for-thesis" />
							<!-- start-with/ends-with -->
							<xsl:variable name="var">
								<xsl:if test="exists($var) and $var!=''">
									<xsl:text>(</xsl:text>
								...
								<xsl:call-template name="applyDelimiter">
									<xsl:with-param name="les">
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var" select="$start-date-or-date" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
																...
																<xsl:with-param name="les">
																	<le>
																		<xsl:variable name="var"><!--### Plain Layout Element 
																			...
																			<!--### @ref is available ### -->
																			<xsl:variable name="var"
																				select="func:get_year(pub:publication/dcterms:issued/text())" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
																	<le>
																		<xsl:variable name="var"><!--### Plain Layout Element 
																			...
																			<!--### @ref is available ### -->
																			<xsl:variable name="var"
																				select="func:get_month_name(pub:publication/dcterms:issued/text())" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
						...
						<xsl:variable name="year-and-month-authors-are-presented"><!--### Plain Layout Element ### -->
							<!--### @ref is available ### -->
							<xsl:variable name="var" select="$year-and-month-name" />
							<!--valid-if -->
							<xsl:variable name="var">
						...
						<xsl:variable name="title-with-dot"><!--### Plain Layout Element ### -->
							<!--### @ref is available ### -->
							<xsl:variable name="var"
								select="func:escapeMarkupTags(pub:publication/dc:title/text())" />
							<!-- start-with/ends-with -->
							<xsl:variable name="var">
								<xsl:if test="exists($var) and $var!=''">
									<xsl:text> </xsl:text>
						...
						<xsl:variable name="title-with-dot-italic"><!--### Plain Layout Element ### -->
							<!--### @ref is available ### -->
							<xsl:variable name="var" select="$title-italic" />
							<!-- start-with/ends-with -->
							<xsl:variable name="var">
								<xsl:if test="exists($var) and $var!=''">
									<xsl:text> </xsl:text>
									...
									<xsl:with-param name="les">
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var"
													select="pub:publication/source:source[1]/eterms:start-page/text()" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var"
													select="pub:publication/source:source[1]/eterms:end-page/text()" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
								...
								<xsl:call-template name="applyDelimiter">
									<xsl:with-param name="les">
										...
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var" select="$start-page-end-page" />
												<!-- start-with/ends-with -->
												<xsl:variable name="var">
									...
									<xsl:with-param name="les">
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var"
													select="pub:publication/source:source[1]/eterms:volume/text()" />
												<!--font-style -->
												<xsl:variable name="var">
													<xsl:if test="exists($var) and $var!=''">
														<xsl:copy-of select="$var" />
										...
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var"
													select="pub:publication/source:source[1]/eterms:issue/text()" />
												<!-- start-with/ends-with -->
												<xsl:variable name="var">
													<xsl:if test="exists($var) and $var!=''">
														<xsl:text>, </xsl:text>
									...
									<xsl:with-param name="les">
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var"
													select="pub:publication/eterms:publishing-info/eterms:place/text()" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var"
													select="pub:publication/eterms:publishing-info/dc:publisher/text()" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
															...
															<xsl:if test="$editorsCount=1">
																<xsl:variable name="var">
																	<xsl:call-template name="applyDelimiter">
																		<xsl:with-param name="les">
																			<xsl:for-each
																				select="pub:publication/eterms:creator[@role=$l_editor]">
																				<le position-delimiter=", ">
																					<xsl:choose>
																						<xsl:when test="person:person/dc:identifier[@xsi:type='eterms:CONE']!=''">
																							<xsl:text>&lt;a href="</xsl:text>
																							<xsl:value-of select="concat($instanceUrl,'/cone',person:person/dc:identifier[@xsi:type='eterms:CONE'])"/>
																							<xsl:text>" target="_blank"&gt;</xsl:text>
																							<xsl:call-template name="applyDelimiter">
																								<xsl:with-param name="les">
																									<le>
																										<xsl:variable name="var"><!--### Plain 
																												Layout Element ### -->
																											<!--### @ref is available ### -->
																											<xsl:variable name="var"
																												select="person:person/eterms:family-name/text()" />
																											<xsl:copy-of select="$var" />
																										</xsl:variable>
																										<xsl:copy-of select="$var" />
																									</le>
																									<le>
																										<xsl:variable name="var"><!--### Plain 
																											...
																											<!--### @ref is available ### -->
																											<xsl:variable name="var"
																												select="func:get_initials(person:person/eterms:given-name/text())" />
																											<xsl:copy-of select="$var" />
																										</xsl:variable>
																										<xsl:copy-of select="$var" />
																									</le>
																					...
																					<xsl:choose>
																						...
																						<xsl:otherwise>
																							<xsl:call-template name="applyDelimiter">
																								<xsl:with-param name="les">
																									<le>
																										<xsl:variable name="var">																											<xsl:variable name="var"
																												select="person:person/eterms:family-name/text()" />
																											<xsl:copy-of select="$var" />
																										</xsl:variable>
																										<xsl:copy-of select="$var" />
									...
									<xsl:variable name="var">
										<xsl:call-template name="applyDelimiter">
											<xsl:with-param name="les">
												<le>
													<xsl:variable name="var">
														<xsl:variable name="var" select="$editors-base" />
														<xsl:copy-of select="$var" />
													</xsl:variable>
													<xsl:copy-of select="$var" />
												</le>
												<le>
													<xsl:variable name="var">
														<xsl:variable name="var" select="$ed-postfix-i18n" />
														<!-- start-with/ends-with -->
														<xsl:variable name="var">
															<xsl:if test="exists($var) and $var!=''">
																<xsl:text> (</xsl:text>
						...
						<xsl:variable name="editors-book"><!--### Plain Layout Element ### -->
							...
							<xsl:variable name="var">
								<xsl:if
									test="$authorsCount&gt;0 and $editorsCount&gt;0 and $genre=$l_book">
									<xsl:variable name="var">
										<xsl:call-template name="applyDelimiter">
											<xsl:with-param name="les">
												<le>
															...
															<xsl:if test="$editorsCount&gt;0">
																<xsl:variable name="var">
																	<xsl:call-template name="applyDelimiter">
																		<xsl:with-param name="les">
																			<le>
																				<xsl:variable name="editors-Equal1"><!--### Repeatable Layout 
																						Element ### -->
																					<xsl:variable name="var" select="''" />
																					<!--valid-if -->
																					<xsl:variable name="var">
																			...
																			<le>
																				<xsl:variable name="editors-MoreThan1"><!--### Repeatable Layout 
																						Element ### -->
																					<xsl:variable name="var" select="''" />
																					<!--valid-if -->
																					<xsl:variable name="var">
													...
													<xsl:if test="$authorsCount&gt;0">
														<xsl:variable name="var">
															<xsl:call-template name="applyDelimiter">
																<xsl:with-param name="les">
																	<le>
																		<xsl:variable name="authors-Equal1"><!--### Repeatable Layout 
																				Element ### -->
																			<xsl:variable name="var" select="''" />
																			<!--valid-if -->
																			<xsl:variable name="var">
																	...
																	<le>
																		<xsl:variable name="authors-MoreThan1"><!--### Repeatable Layout 
																				Element ### -->
																			<xsl:variable name="var" select="''" />
																			<!--valid-if -->
																			<xsl:variable name="var">
																				<xsl:if test="$authorsCount&gt;1">
																					<xsl:variable name="var">
																						<xsl:call-template name="applyDelimiter">
																							<xsl:with-param name="les">
																								<xsl:for-each
																									select="pub:publication/eterms:creator[@role=$l_author]">
																									<le position-delimiter=", ">
																										<xsl:choose>
																		...
																		<xsl:copy-of select="$authors-MoreThan1" />
																	</le>
																</xsl:with-param>
																<xsl:with-param name="delimiter" select="' '" />
															</xsl:call-template>
																...
																<xsl:with-param name="les">
																	<le>
																		<xsl:variable name="var"><!--### Plain Layout Element 
																				### -->
																			<!--### @ref is available ### -->
																			<xsl:variable name="var" select="$editors" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
											...
											<xsl:with-param name="les">
															...
															<xsl:if test="$sourceEditorsCount=1">
																<xsl:variable name="var">
																	<xsl:call-template name="applyDelimiter">
																		<xsl:with-param name="les">
																			<xsl:for-each
																				select="pub:publication/source:source[1]/eterms:creator[@role=$l_editor]">
																				<le position-delimiter="">
																						<xsl:choose>
																							<xsl:when test="person:person/dc:identifier[@xsi:type='eterms:CONE']!=''">
																								<xsl:text>&lt;a href="</xsl:text>
												...
												<le>
													<xsl:variable name="var"><!--### Plain Layout Element 
															### -->
														<!--### @ref is available ### -->
														<xsl:variable name="var" select="$source-ed-postfix-i18n" />
														<!-- start-with/ends-with -->
														<xsl:variable name="var">
															<xsl:if test="exists($var) and $var!=''">
																<xsl:text> (</xsl:text>
								...
								<xsl:call-template name="applyDelimiter">
									<xsl:with-param name="les">
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var" select="$authors-or-editors" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var"
													select="$year-authors-or-editors-are-presented" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var" select="$title-with-dot" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var"
													select="$year-authors-or-editors-are-not-presented" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
						...
						<xsl:variable
							name="authors-or-editors-and-year-and-title-with-dot-italic"><!--### Plain Layout Element ### -->
							<!--### @ref is not available ### -->
							<xsl:variable name="var" select="''" />
							<xsl:variable name="var">
								<xsl:call-template name="applyDelimiter">
									<xsl:with-param name="les">
										...
										<le>
											<xsl:variable name="var"><!--### Plain Layout Element ### -->
												<!--### @ref is available ### -->
												<xsl:variable name="var" select="$title-with-dot-italic" />
												<xsl:copy-of select="$var" />
											</xsl:variable>
											<xsl:copy-of select="$var" />
										</le>
						...
						<xsl:choose>
											...
											<xsl:with-param name="les">
												<le>
													<xsl:variable name="var"><!--### Plain Layout Element 
															### -->
														<!--### @ref is available ### -->
														<xsl:variable name="var" select="$objid" />
														<xsl:copy-of select="$var" />
													</xsl:variable>
													<xsl:copy-of select="$var" />
												</le>
											...
											<xsl:with-param name="les">
												<le>
													<xsl:variable name="var"><!--### Plain Layout Element 
														...
														<!--### @ref is available ### -->
														<xsl:variable name="var"
															select="$authors-or-editors-and-year-and-title-with-dot" />
														<xsl:copy-of select="$var" />
													</xsl:variable>
													<xsl:copy-of select="$var" />
												</le>
							...
							<xsl:when test="$genre=$l_patent">
								<xsl:variable name="patent">
									<xsl:call-template name="applyDelimiter">
										<xsl:with-param name="les">
											...
											<le>
												<xsl:variable name="var">
													<xsl:variable name="var" select="$year-authors-or-editors-are-presented,1,4" />
													<xsl:copy-of select="$var" />
												</xsl:variable>
												<xsl:copy-of select="$var" />
											</le>
												...
												<xsl:call-template name="applyDelimiter">
													<xsl:with-param name="les">
														...
														<le>
															<!--Series-->
															<xsl:variable name="var">
																<xsl:value-of select="$sourceSeriesEnumeration"/>
															</xsl:variable>
															<xsl:copy-of select="$var" />
														</le>
														<le>
								...
								<xsl:if test="pub:publication/dc:identifier[@xsi:type='eterms:PATENT_NR']">
									...
									<xsl:value-of select="pub:publication/dc:identifier[@xsi:type='eterms:PATENT_NR']"/>
								</xsl:if>
								<xsl:if test="$doi">
									<xsl:value-of select="$doiLink" />
								</xsl:if>
														...
														<xsl:variable name="var">
															<xsl:call-template name="applyDelimiter">
																<xsl:with-param name="les">
																	<le>
																		<xsl:variable name="var">
																			<xsl:variable name="var" select="$source-title" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
																	<le>
																		<xsl:variable name="var">
																			<xsl:variable name="var" select="$volume-issue" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
														...
														<xsl:variable name="var">
															<xsl:call-template name="applyDelimiter">
																<xsl:with-param name="les">
																	<le>
																		<xsl:variable name="var">
																			<xsl:variable name="var" select="func:escapeMarkupTags(pub:publication/dc:title/text())" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
																	...
																	<le>
																		<xsl:value-of select="$publisherData" />
																	</le>
																	<le>
																		<!--Proceedings-->
										...
										<xsl:call-template name="applyDelimiter">
											<xsl:with-param name="les">
												...
												<le>
														...
														<xsl:variable name="var">
															<xsl:call-template name="applyDelimiter">
																<xsl:with-param name="les">
																	...
																	<le>
																		<xsl:variable name="var">
																			<xsl:variable name="var" select="$degree" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
																	<le>
																		<!--Alle Quellen außer Reihen-->
																		<xsl:variable name="var">
																			<xsl:for-each select="pub:publication/source:source[@type!='http://purl.org/escidoc/metadata/ves/publication-types/series']">
																				<xsl:variable name="var" select="func:escapeMarkupTags(dc:title/text())" />
																				<!--font-style -->
																				<xsl:variable name="var">
																					<xsl:if test="exists($var) and $var!=''">
																						<xsl:copy-of select="$var" />
													...
													<xsl:copy-of select="$title-degree-place-publisher" />
												</le>
											</xsl:with-param>
											<xsl:with-param name="delimiter" select="' '" />
										</xsl:call-template>
														...
														<xsl:variable name="var">
															<xsl:call-template name="applyDelimiter">
																<xsl:with-param name="les">
																	<le>
																		<xsl:variable name="var">
																			<xsl:variable name="var" select="$source-editors" />
																			<xsl:variable name="var">
																				<xsl:copy-of select="$var" />
																			</xsl:variable>
																			<xsl:copy-of select="$var" />
																	...
																	<le>
																		<!--Series-->
																		<xsl:variable name="var">
																			<xsl:value-of select="$sourceSeriesEnumeration"/>																	</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
																	<le>
																		<xsl:variable name="var">
																			<xsl:variable name="var"
																				select="pub:publication/event:event/dc:title" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
																	...
																	<le>
																		<xsl:variable name="var">
																			<xsl:variable name="var"
																				select="$source-edition-start-page-end-page" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
									...
									<xsl:variable name="var">
										<xsl:call-template name="applyDelimiter">
											<xsl:with-param name="les">
												...
												<le>
													<xsl:variable name="var">
														<xsl:variable name="var" select="$year-editors-are-presented" />
														<xsl:copy-of select="$var" />
													</xsl:variable>
													<xsl:copy-of select="$var" />
												</le>
										...
										<xsl:call-template name="applyDelimiter">
											<xsl:with-param name="les">
												<le>
													<xsl:variable name="var">
														<xsl:variable name="var"
															select="$authors-or-editors-and-year-and-title-with-dot-italic" />
														<xsl:copy-of select="$var" />
													</xsl:variable>
													<xsl:copy-of select="$var" />
												</le>
									...
									<xsl:variable name="var">
										<xsl:call-template name="applyDelimiter">
											<xsl:with-param name="les">
												...
												<le>
													<xsl:variable name="var">
														<xsl:variable name="var" select="$place-publisher" />
														<!-- start-with/ends-with -->
														<xsl:variable name="var">
															<xsl:copy-of select="$var" />
															<xsl:if test="exists($var) and $var!=''">
									...
									<xsl:variable name="var">
										<xsl:call-template name="applyDelimiter">
											<xsl:with-param name="les">
												...
												<le>
													<xsl:variable name="var">
														<xsl:variable name="var" select="$eventData" />
														<xsl:variable name="var">
															<xsl:if test="exists($var) and $var!=''">
															...
															<xsl:call-template name="applyDelimiter">
																<xsl:with-param name="les">
																	<le>
																		<xsl:variable name="var">
																			<xsl:variable name="var"
																				select="pub:publication/event:event/eterms:place/text()" />
																			<xsl:copy-of select="$var" />
																		</xsl:variable>
																		<xsl:copy-of select="$var" />
																	</le>
																				...
																				<xsl:call-template name="applyDelimiter">
																					<xsl:with-param name="les">
																						<le>
																							<xsl:variable name="var">
																								<xsl:variable name="var"
																									select="pub:publication/event:event/eterms:start-date/text()" />
																								<xsl:copy-of select="$var" />
																							</xsl:variable>
																							<xsl:copy-of select="$var" />
																						</le>
																						<le>
																							<xsl:variable name="var">
																								<xsl:variable name="var"
																									select="pub:publication/event:event/eterms:end-date/text()" />
																								<xsl:copy-of select="$var" />
																							</xsl:variable>
																							<xsl:copy-of select="$var" />
																						</le>
																...
																<xsl:with-param name="les">
																	...
																	<le>
																		<xsl:if test="count(pub:publication/source:source[@type!='http://purl.org/escidoc/metadata/ves/publication-types/series'])>0">
																			<xsl:variable name="var">
																				<xsl:for-each select="pub:publication/source:source[@type!='http://purl.org/escidoc/metadata/ves/publication-types/series']">
																					<xsl:variable name="var" select="func:escapeMarkupTags(dc:title)" />
																					<xsl:variable name="var">
																						<xsl:if test="exists($var) and $var!=''">
																							<xsl:copy-of select="$var" />
																						</xsl:if>
																	...
																	<le>
																		<xsl:value-of select="$year-authors-or-editors-are-not-presented" />
																	</le>
																	<le>
																		<xsl:value-of select="$publisherData"/>
																	</le>
									...
									<xsl:variable name="var">
										<xsl:call-template name="applyDelimiter">
											<xsl:with-param name="les">
												<le>
													<xsl:variable name="var">
														<xsl:variable name="var" select="fn:replace($authors-or-editors-and-year-and-title-with-dot,'.$','')" />
														<xsl:copy-of select="$var" />
													</xsl:variable>
													<xsl:copy-of select="$var" />
												</le>
												...
												<le>
													<!--Proceedngs, nur wenn Titel != Veranstaltungstitel (aus edoc migrierte Publikationen)-->
	...
	<xsl:template name="applyDelimiter">
		...
		<xsl:variable name="les_filled"
			select="$les/le[exists(text()) and text()!='']" />
	...
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:get_year">
		<xsl:param name="date" />
		<xsl:value-of select="substring($date,1,4)" />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:get_month">
		<xsl:param name="date" />
		<xsl:value-of select="substring($date,6,2)" />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:get_month_name">
		<xsl:param name="date" />
		...
		<xsl:value-of
			select="     $months/m[     matches(      tokenize($date, '-')[2], @n     )     ]   " />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:get_initials">
		<xsl:param name="str" />
	...
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:fname_initials">
		<xsl:param name="fname" />
		<xsl:param name="gname" />
		<xsl:param name="delim" />

		<xsl:value-of
			select="    if ( jfunc:isCJK(concat($fname, $gname) ) )     then string-join( ($fname, $gname), $delim )    else string-join( ($fname, func:get_initials($gname)), $delim )   " />

	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:initials_fname">
		<xsl:param name="gname" />
		<xsl:param name="fname" />
		<xsl:param name="delim" />

		<xsl:value-of
			select="    if ( jfunc:isCJK(concat($fname, $gname) ) )     then string-join( ($fname, $gname), $delim )    else string-join( (func:get_initials($gname), $fname), $delim )   " />

	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:escapeMarkupTags">
		<xsl:param name="str" />
		<xsl:value-of select="jfunc:escapeMarkupTags($str)" />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:cleanCitation">
		<xsl:param name="str" />
		<xsl:value-of
			select="     normalize-space (     functx:replace-multi (      $str,      ( '([.,?!:;])\s*(&lt;[/]span&gt;)\s*\1', '([.,?!:;])\s*\1', '\.&#34;\.', '\s+([.,?!:;])', '\s*(&lt;[/]?span&gt;)\s*([.,?!:;])', '([?!])+\.' ),      ( '$1$2',         '$1',    '.&#34;',  '$1',     '$1$2',         '$1' )     )     )    " />
		<!-- .".=>." ??? -->
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="functx:replace-multi" as="xs:string?">
	...
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="functx:if-absent" as="item()*">
		<xsl:param name="arg" as="item()*" />
		<xsl:param name="value" as="item()*" />

		<xsl:sequence
			select="       if (exists($arg))      then $arg      else $value   " />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:get_reverse_date">
		<xsl:param name="input_date" />
		<xsl:if test="$input_date[.!=''] ">
			<xsl:value-of
				select="concat(substring($input_date,9,2),'.',substring($input_date,6,2),'.',substring($input_date,1,4))" />
		</xsl:if>
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:getCitationStyleForJournal">
		<xsl:param name="idType" />
		<xsl:param name="idValue" />
		<xsl:value-of select="jfunc:getCitationStyleForJournal($idType,$idValue)" />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:substringAfterEdition">
		<xsl:param name="inputWithSpaceComma" />
		<xsl:value-of
			select="substring-before(substring-after($inputWithSpaceComma,', '), ' ')" />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:substringBeforeEdition">
		<xsl:param name="inputWithSpaceComma" />
		<xsl:value-of
			select="substring-before(substring-before($inputWithSpaceComma,', '), ' ')" />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:substringBeforeInstalment">
		<xsl:param name="inputWithInstalment" />
		<xsl:value-of
			select="      if (contains($inputWithInstalment, 'instl'))      then substring-before($inputWithInstalment, 'instl')        else if (contains($inputWithInstalment, 'Lf'))      then substring-before($inputWithInstalment, 'Lf')        else ''      " />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:substringBeforeSince">
		<xsl:param name="inputWithSince" />
		<xsl:value-of
			select="       if (contains($inputWithSince, 'since'))       then substring-before($inputWithSince, 'since')         else if (contains($inputWithSince, 'seit'))       then substring-before($inputWithSince, 'seit')         else ''       " />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:substringAfterSince">
		<xsl:param name="inputWithSince" />
		<xsl:value-of
			select="      if (contains($inputWithSince, 'since'))      then substring-after($inputWithSince, 'since')        else if (contains($inputWithSince, 'seit'))      then substring-after($inputWithSince, 'seit')        else ''      " />
	</xsl:function>
	<xsl:function xmlns="http://www.escidoc.de/citationstyle"
		xmlns:exslt="http://exslt.org/common" name="func:substringAfterReviewOf">
