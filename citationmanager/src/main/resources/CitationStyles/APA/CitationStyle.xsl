...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!--### @ref is available ###--><xsl:variable name="var"
                        ...
                        <xsl:variable name="editors-base-givenname-first"><!--### Plain Layout Element ###-->
	<!--### @ref is not available ###--><xsl:variable name="var" select="''"/>
                            <xsl:variable name="var">
                                <xsl:call-template name="applyDelimiter">
                                    <xsl:with-param name="les">
                                    ...
                                    <xsl:variable name="var">
                                        <xsl:call-template name="applyDelimiter">
                                            <xsl:with-param name="les">
                                                <le>
                                                    <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var" select="$editors-base-givenname-first"/>
                                                        <xsl:copy-of select="$var"/>
                                                    </xsl:variable>
                                                    <xsl:copy-of select="$var"/>
                                                </le>
	...
	<!--### @ref is available ###--><xsl:variable name="var"
			...
			--><xsl:variable name="var">
                                        ...
                                        <le>
                                            <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var" select="$source-doi"/>
                                                <!--
				start-with/ends-with
			--><xsl:variable name="var">
                                                    <xsl:if test="exists($var) and $var!=''">
	...
	<!--### @ref is available ###--><xsl:variable name="var" select="$authors-or-editors-and-year-and-title-with-dot"/>
                            ...
                            <xsl:when test="&#xA;&#x9;&#x9;&#x9;&#x9;$genre = ( $l_article, $l_paper, $l_case-note, $l_book-review, $l_case-study, $l_editorial, $l_newspaper-article, $l_data_publication, $l_pre_registration_paper, $l_registered_report, $l_preprint, $l_blog_post, $l_interview, $l_software, $l_review_article, $l_film, $l_magazine-article) &#xA;&#x9;&#x9;&#x9;&#x9;or ( $genre = ( $l_other, $l_paper, $l_conference-report, $l_conference-paper, $l_meeting-abstract, $l_data_publication, $l_pre_registration_paper, $l_registered_report, $l_preprint, $l_blog_post, $l_interview, $l_software, $l_review_article, $l_film) and $source-type = $l_journal )  &#xA;&#x9;&#x9;&#x9;">
	...
	<!--### @ref is available ###--><xsl:variable name="var" select="$title-italic"/>
                                                                    ...
                                                                    <le>
                                                                        <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                          select="func:escapeMarkupTags((pub:publication/dc:identifier[@xsi:type='eterms:REPORT_NR'])[1]/text())"/>
                                                                            <!--valid-if--><xsl:variable name="var">
