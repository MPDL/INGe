...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="jus_default_variable">
                            <xsl:value-of select="func:escapeMarkupTags('JUS specific default variable')"/>
                        </xsl:variable>
                        ...
                        <xsl:variable name="volume-prefix">
                            <xsl:value-of select="func:escapeMarkupTags('vol.')"/>
                        </xsl:variable>
                        <xsl:variable name="together-prefix">
                            <xsl:value-of select="func:escapeMarkupTags('together with')"/>
                        </xsl:variable>
                        ...
                        <xsl:variable name="since-prefix">
                            <xsl:value-of select="func:escapeMarkupTags('since')"/>
                        </xsl:variable>
                        <xsl:variable name="reviewOf-prefix">
                            <xsl:value-of select="func:escapeMarkupTags('Review of:')"/>
                        </xsl:variable>
                        <xsl:variable name="editor-postfix">
                            <xsl:value-of select="func:escapeMarkupTags('ed.')"/>
                        </xsl:variable>
                        <xsl:variable name="editors-postfix">
                            <xsl:value-of select="func:escapeMarkupTags('eds.')"/>
                        </xsl:variable>
                        ...
                        <xsl:variable name="pages-postfix">
                            <xsl:value-of select="func:escapeMarkupTags('pp.')"/>
                        </xsl:variable>
                        <xsl:variable name="instalment-postfix">
                            <xsl:value-of select="func:escapeMarkupTags('instl.')"/>
                        </xsl:variable>
                        <xsl:variable name="phd">
                            <xsl:value-of select="func:escapeMarkupTags('PhD Thesis')"/>
                        </xsl:variable>
                        <xsl:variable name="together-prefix">
                            <xsl:value-of select="func:escapeMarkupTags('together with')"/>
                        </xsl:variable>
	...
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                          select="func:escapeMarkupTags(pub:publication/e:creator[1]/person:person/e:family-name/text())"/>
                                                                    ...
                                                                    <le>
                                                                        <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                          select="func:escapeMarkupTags(pub:publication/e:creator[1]/person:person/e:given-name/text())"/>
                                                                            <xsl:copy-of select="$var"/>
                                                                        </xsl:variable>
                                                                        <xsl:copy-of select="$var"/>
                                                                    </le>
                                                                    <le>
                                                                        <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                          select="func:escapeMarkupTags(pub:publication/e:creator[1]/organization:organization/dc:title/text())"/>
                                                                            <xsl:copy-of select="$var"/>
                                                                        </xsl:variable>
                                                                        <xsl:copy-of select="$var"/>
                                                                    </le>
                                                            ...
                                                            <xsl:call-template name="applyDelimiter">
                                                                <xsl:with-param name="les">
                                                                    <le>
                                                                        <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                          select="func:escapeMarkupTags(pub:publication/e:creator[2]/person:person/e:given-name/text())"/>
                                                                            <xsl:copy-of select="$var"/>
                                                                        </xsl:variable>
                                                                        <xsl:copy-of select="$var"/>
                                                                    </le>
                                                                    <le>
                                                                        <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                          select="func:escapeMarkupTags(pub:publication/e:creator[2]/person:person/e:family-name/text())"/>
                                                                            <xsl:copy-of select="$var"/>
                                                                        </xsl:variable>
                                                                        <xsl:copy-of select="$var"/>
                                                                    </le>
                                                                    <le>
                                                                        <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                          select="func:escapeMarkupTags(pub:publication/e:creator[2]/organization:organization/dc:title/text())"/>
                                                                            <xsl:copy-of select="$var"/>
                                                                        </xsl:variable>
                                                                        <xsl:copy-of select="$var"/>
                                                                    </le>
                                                                    ...
                                                                    <xsl:call-template name="applyDelimiter">
                                                                        <xsl:with-param name="les">
                                                                            <le>
                                                                                <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                                  select="func:escapeMarkupTags(pub:publication/e:creator[3]/person:person/e:given-name/text())"/>
                                                                                    <xsl:copy-of select="$var"/>
                                                                                </xsl:variable>
                                                                                <xsl:copy-of select="$var"/>
                                                                            </le>
                                                                            <le>
                                                                                <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                                  select="func:escapeMarkupTags(pub:publication/e:creator[3]/person:person/e:family-name/text())"/>
                                                                                    <xsl:copy-of select="$var"/>
                                                                                </xsl:variable>
                                                                                <xsl:copy-of select="$var"/>
                                                                            </le>
                                                                            <le>
                                                                                <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var"
                                                                                                  select="func:escapeMarkupTags(pub:publication/e:creator[3]/organization:organization/dc:title/text())"/>
                                                                                    <xsl:copy-of select="$var"/>
                                                                                </xsl:variable>
                                                                                <xsl:copy-of select="$var"/>
                                                                            </le>
	...
	<!--### @ref is available ###--><xsl:variable name="var" select="func:escapeMarkupTags(pub:publication/dc:title/text())"/>
			...
			--><xsl:variable name="var">
                        ...
                        <xsl:variable name="title-date"><!--### Plain Layout Element ###-->
	<!--### @ref is not available ###--><xsl:variable name="var" select="''"/>
                            <xsl:variable name="var">
                                <xsl:call-template name="applyDelimiter">
                                    <xsl:with-param name="les">
	...
	<!--### @ref is available ###--><xsl:variable name="var" select="$first-creator"/>
                                                ...
                                                <le>
                                                    <xsl:variable name="var"><!--### Plain Layout Element ###-->
	<!--### @ref is available ###--><xsl:variable name="var" select="$title-date"/>
                                                        <xsl:copy-of select="$var"/>
                                                    </xsl:variable>
                                                    <xsl:copy-of select="$var"/>
                                                </le>
