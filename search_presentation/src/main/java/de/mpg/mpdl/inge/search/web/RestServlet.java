  ...
  protected final void doPost(final HttpServletRequest req, final HttpServletResponse resp)
    ...
    try {
      ...
      if (exportFormat.equals("")) {
        ...
        // txt
      } else if (!(CitationStyleExecuterService.isCitationStyle(exportFormat) || StructuredExportService
      ...
      // citation style
      {
        ...
        else if (CitationStyleExecuterService.getMimeType(exportFormat, outputFormat) == null) {
