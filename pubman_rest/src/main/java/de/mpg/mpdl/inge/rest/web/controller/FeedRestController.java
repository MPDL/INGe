...
public class FeedRestController {
  ...
  @RequestMapping(value = "/organization/{ouId}", method = RequestMethod.GET,
      produces = DEFAULT_PRODUCE_MIMETYPE)
  public String getRecentReleasesforOu(@PathVariable("ouId") String ouId) throws Exception {
  ...
  @RequestMapping(value = "/search", method = RequestMethod.GET,
      produces = DEFAULT_PRODUCE_MIMETYPE)
  public String getSearchAsFeed(@RequestParam("q") String query) throws Exception {
